...
/**
 * <p>
 * 表4-1  20xx年度监测县(市、区)中稻生育进度调查表（移栽稻）
 * </p>
 *
 * @author admin
 * @since 2021-07-02
...
@AllArgsConstructor
@NoArgsConstructor
    public class crop_01_01_table_04_01{
      /**
     * 序号
     */
      private int id;
...
@DateTimeFormat(pattern = "yyyy-MM-dd")
@JsonFormat(pattern = "yyyy-MM-dd", timezone = "GMT+8")
      private Date field_16_1;

      /**
     * 生育进程
     */
      private String field_16_2;

      /**
     * 生育进程
     */
      private String field_16_3;

      /**
     * 茎蘖数(万/亩)
     */
      private String field_16_4;
     ...
     */
      @DateTimeFormat(pattern = "yyyy-MM-dd")
      @JsonFormat(pattern = "yyyy-MM-dd", timezone = "GMT+8")
      private Date field_17_1;

      /**
     * 生育进程
     */
      private String field_17_2;

      /**
     * 叶龄(叶)
     */
      private String field_17_3;

      /**
     * 茎蘖数(万/亩)
     */
      private String field_17_4;

          ...
          <div class="tableStyle">
            ...
            <el-table :data="tableData.slice((currentPage-1)*pagesize,currentPage*pagesize)" border :header-cell-style="headerStyle"  :row-style="{height: '30px'}" :cell-style="{padding:'0',fontSize:'4px'}" row-key="id" stripe>
                ...
                <el-table-column align="center" label="化调剂1">
                  ...
                  <el-table-column align="center" prop="field_7_2" width="150%" label="化调剂名称" />
                  <el-table-column align="center" prop="field_7_3" width="120%" label="亩用量/kg" />
                  <el-table-column align="center" prop="field_7_4" width="120%" label="使用方法" />
                ...
                <el-table-column align="center" label="化调剂2">
                  ...
                  <el-table-column align="center" prop="field_8_2" width="150%" label="化调剂名称" />
                  <el-table-column align="center" prop="field_8_3" width="120%" label="亩用量/kg" />
                  <el-table-column align="center" prop="field_8_4" width="120%" label="使用方法" />
                ...
                <el-table-column align="center" label="化调剂3">
                  ...
                  <el-table-column align="center" prop="field_9_2" width="150%" label="化调剂名称" />
                  <el-table-column align="center" prop="field_9_3" width="120%" label="亩用量/kg" />
                  <el-table-column align="center" prop="field_9_4" width="120%" label="使用方法" />
...
export default {
  ...
  data() {
    return {         
      ...
      //表名
      tableLabel:'',
      tableName:'crop_01_02_table_06_05',
      //县的option
      countys:[],
      county: '',
      //地区类型option
  ...
  methods: {
    ...
    initData() {
      ...
      this.years=y;
      this.tableLabel= this.years+"年度水稻监测点化学调节剂使用记录表";
      //this.getHeaderList();
      this.getTableData();

        ...
        <div class="tableRange">
          ...
          <div class="tableStyle">
            ...
            <el-table :data="tableData.slice((currentPage-1)*pagesize,currentPage*pagesize)" border :header-cell-style="headerStyle"  :row-style="{height: '30px'}" :cell-style="{padding:'0',fontSize:'4px'}" row-key="id" stripe>
                ...
                <el-table-column align="center" fixed prop="field_2" width="110%" label="监测点代码" />
                <el-table-column align="center" fixed prop="field_3" width="100%" label="地区类型" />
                <el-table-column align="center" fixed prop="field_4" width="100%" label="稻作类型" />

                <el-table-column align="center" fixed prop="field_5" width="100%" label="品种名称" />
                ...
                <el-table-column align="center" label="灌浆速率测定1（扬花）">
                  ...
                  <el-table-column align="center" prop="field_7_2" width="130%" label="千粒重（克）" />
                </el-table-column>
                <el-table-column align="center" label="灌浆速率测定2（扬花+7天）">
                  <el-table-column align="center" prop="field_8_1" width="100%" label="日期" />
                  <el-table-column align="center" prop="field_8_2" width="120%" label="粒重（克）" />
                  <el-table-column align="center" prop="field_8_3" width="180%" label="灌浆速率（克/千粒•天）" />
                </el-table-column>
                <el-table-column align="center" label="灌浆速率测定3（扬花+14天）">
                  <el-table-column align="center" prop="field_9_1" width="100%" label="日期" />
                  <el-table-column align="center" prop="field_9_2" width="120%" label="粒重（克）" />
                  <el-table-column align="center" prop="field_9_3" width="180%" label="灌浆速率（克/千粒•天）" />
                </el-table-column>
                <el-table-column align="center" label="灌浆速率测定4（扬花+21天）">
                  <el-table-column align="center" prop="field_10_1" width="100%" label="日期" />
                  <el-table-column align="center" prop="field_10_2" width="120%" label="粒重（克）" />
                  <el-table-column align="center" prop="field_10_3" width="180%" label="灌浆速率（克/千粒•天）" />
                </el-table-column>
                <el-table-column align="center" label="灌浆速率测定5（扬花+28天）">
                  <el-table-column align="center" prop="field_11_1" width="100%" label="日期" />
                  <el-table-column align="center" prop="field_11_2" width="120%" label="粒重（克）" />
                  <el-table-column align="center" prop="field_11_3" width="180%" label="灌浆速率（克/千粒•天）" />
                </el-table-column>
                <el-table-column align="center" label="灌浆速率测定6（扬花+35天）">
                  <el-table-column align="center" prop="field_12_1" width="100%" label="日期" />
                  <el-table-column align="center" prop="field_12_2" width="120%" label="粒重（克）" />
                  <el-table-column align="center" prop="field_12_3" width="180%" label="灌浆速率（克/千粒•天）" />
                </el-table-column>
...
export default {
  ...
  methods: {
    ...
    initData() {
      ...
      this.jiancedian = this.$route.query.monitoring_code
       let date = new Date();
      let y = date.getFullYear();
      this.years=y;

      this.tableLabel= this.years+"年度水稻监测点灌浆速率调查表（早稻）";
    ...
    getTableData(){ 
       ...
       axios({
          ...
          // console.log("woshishaungjidao101"+totalTableData)

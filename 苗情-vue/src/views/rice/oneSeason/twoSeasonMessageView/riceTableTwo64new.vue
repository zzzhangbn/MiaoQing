          ...
          <div class="tableStyle">
            ...
            <el-table :data="tableData.slice((currentPage-1)*pagesize,currentPage*pagesize)" border :header-cell-style="headerStyle"  :row-style="{height: '30px'}" :cell-style="{padding:'0',fontSize:'4px'}" row-key="id" stripe>
                ...
                <el-table-column align="center" label="基肥施肥（以折纯计kg/亩）1">
                  ...
                  <el-table-column align="center" prop="field_7_2" width="100%" label="N" />
                  <el-table-column align="center" prop="field_7_3" width="100%" label="P" />
                  <el-table-column align="center" prop="field_7_4" width="100%" label="K" />
                  <el-table-column align="center" prop="field_7_5" width="120%" label="方法" />
                 ...
                 <el-table-column align="center" label="分蘖肥施肥（以折纯计kg/亩）2">
                  ...
                  <el-table-column align="center" prop="field_8_2" width="100%" label="N" />
                  <el-table-column align="center" prop="field_8_3" width="100%" label="P" />
                  <el-table-column align="center" prop="field_8_4" width="100%" label="K" />
                  <el-table-column align="center" prop="field_8_5" width="120%" label="方法" />
                 ...
                 <el-table-column align="center" label="孕穗肥施肥（以折纯计kg/亩）3">
                  ...
                  <el-table-column align="center" prop="field_9_2" width="100%" label="N" />
                  <el-table-column align="center" prop="field_9_3" width="100%" label="P" />
                  <el-table-column align="center" prop="field_9_4" width="100%" label="K" />
                  <el-table-column align="center" prop="field_9_5" width="120%" label="方法" />
                 ...
                 <el-table-column align="center" label="孕穗肥施肥（以折纯计kg/亩）4">
                  ...
                  <el-table-column align="center" prop="field_10_2" width="100%" label="N" />
                  <el-table-column align="center" prop="field_10_3" width="100%" label="P" />
                  <el-table-column align="center" prop="field_10_4" width="100%" label="K" />
                  <el-table-column align="center" prop="field_10_5" width="120%" label="方法" />
                 ...
                 <el-table-column align="center" label="抽穗叶面肥施肥（以折纯计kg/亩）5">
                  ...
                  <el-table-column align="center" prop="field_11_2" width="100%" label="N" />
                  <el-table-column align="center" prop="field_11_3" width="100%" label="P" />
                  <el-table-column align="center" prop="field_11_4" width="100%" label="K" />
                  <el-table-column align="center" prop="field_11_5" width="120%" label="方法" />
...
export default {
  ...
  data() {
    return {         
      ...
      //表名
      tableLabel:'',
      tableName:'crop_01_02_table_06_04',
      //县的option
      countys:[],
      county: '',
      //地区类型option
  ...
  methods: {
    ...
    initData() {
      ...
      this.years=y;
      this.tableLabel= this.years+"年度水稻监测点施肥管理记录表";
      //this.getHeaderList();
      this.getTableData();

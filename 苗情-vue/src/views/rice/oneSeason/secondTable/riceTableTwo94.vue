        ...
        <div class="tableRange">
          ...
          <div class="tableStyle">
            ...
            <el-table :data="tableData.slice((currentPage-1)*pagesize,currentPage*pagesize)" border :header-cell-style="headerStyle" :cell-style="{padding:'0',fontSize:'4px'}" :row-style="{height: '30px'}"  row-key="id" stripe>
                ...
                <el-table-column align="center" prop="field_2" width="100%" label="地区类型" />
                ...
                <el-table-column align="center" prop="field_5" width="140%" label="低温冷害" />
                <el-table-column align="center" prop="field_6" width="160%" label="低温冷害发生时间" />
                <el-table-column align="center" prop="field_7" width="170%" label="全县种植面积（万亩）" />
                <el-table-column align="center" prop="field_8" width="170%" label="冷害总面积（万亩）" />
                <el-table-column align="center" label="冷害级别（万亩）" >
                  <el-table-column align="center" prop="field_9_1" width="100%" label="1级" />
                  <el-table-column align="center" prop="field_9_2" width="100%" label="2级" />
                  <el-table-column align="center" prop="field_9_3" width="100%" label="3级" />
                  <el-table-column align="center" prop="field_9_4" width="100%" label="4级" />
                  <el-table-column align="center" prop="field_9_5" width="100%" label="5级" />
                </el-table-column>
                <el-table-column align="center" prop="field_10" width="140%" label="主要品种名称" />
                <el-table-column align="center" prop="field_11" width="100%" label="占比（%）" />
                <el-table-column align="center" prop="field_12" width="180%" label="其中：成灾面积（万亩）" />
                <el-table-column align="center" prop="field_13" width="180%" label="其中：绝收面积（万亩）" />
                <el-table-column align="center" prop="field_14" width="150%" label="产量损失（%）" />
...
export default {
  ...
  methods: {
    ...
    initData() {
      ...
      this.tableLabel= this.years+"年度监测县(市、区)水稻低温冷害表";

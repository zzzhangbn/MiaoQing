        ...
        <div class="tableRange">
          ...
          <div class="tableStyle">
            ...
            <el-table :data="tableData.slice((currentPage-1)*pagesize,currentPage*pagesize)" border :header-cell-style="headerStyle"  :row-style="{height: '30px'}" :cell-style="{padding:'0',fontSize:'4px'}" row-key="id" stripe>
                ...
                <el-table-column align="center" prop="field_2" width="100%" label="早稻总面积（万亩）" fixed/>
                  <el-table-column align="center" label="早稻6月20日前已抽穗扬花">
                  <el-table-column align="center" prop="field_3_1" width="120%" label="面积(万亩）" />
                  <el-table-column align="center" prop="field_3_2" width="130%" label="亩有效穗（万）" />
                  <el-table-column align="center" prop="field_3_3" width="130%" label="穗总粒数（个）" />
                  <el-table-column align="center" prop="field_3_4" width="120%" label="结实率（％）" />
                  <el-table-column align="center" prop="field_3_5" width="120%" label="千粒重（g）" />
                ...
                <el-table-column align="center" label="早稻6月20日~30日抽穗扬花">
                  <el-table-column align="center" prop="field_4_1" width="120%" label="面积(万亩）" />
                  <el-table-column align="center" prop="field_4_2" width="130%" label="亩有效穗（万）" />
                  <el-table-column align="center" prop="field_4_3" width="130%" label="穗总粒数（个）" />
                 ...
                 <el-table-column align="center" prop="field_5" width="120%" label="晚稻总面积（万亩）" />
                 <el-table-column align="center" label="晚稻9月10日前已抽穗扬花">
                  <el-table-column align="center" prop="field_6_1" width="120%" label="面积(万亩）" />
                  <el-table-column align="center" prop="field_6_2" width="130%" label="亩有效穗（万）" />
                  <el-table-column align="center" prop="field_6_3" width="130%" label="穗总粒数（个）" />
                  ...
                  <el-table-column align="center" prop="field_6_6" width="150%" label="八五折理论产量（kg/亩）" />
                </el-table-column>
                 <el-table-column align="center" label="晚稻9月10日以后抽穗扬花">
                  ...
                  <el-table-column align="center" prop="field_7_3" width="130%" label="穗总粒数（个）" />
                  ...
                  <el-table-column align="center" prop="field_7_6" width="150%" label="八五折理论产量（kg/亩）" />
                </el-table-column>
...
export default {
  ...
  methods: {
    ...
    initData() {
      ...
      this.tableLabel= this.years+"年度监测县(市、区)水稻双季稻苗情监测预测产表";
      //this.getHeaderList();
      this.getTableData();

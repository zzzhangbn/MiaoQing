        ...
        <div class="tableRange">
            ...
            <el-row>
              <el-col :span="12">
                <template>
                  ...
                  <el-select v-model="category" clearable  style="width:150px; margin-left: 20px;" placeholder="品系类型">
                    <el-option
                  ...
                  <!-- <el-select v-model="plantWay" clearable  style="width:150px; margin-left: 20px;" placeholder="栽培方式">
                    <el-option
          ...
          <div class="tableStyle">
            ...
            <el-table :data="tableData.slice((currentPage-1)*pagesize,currentPage*pagesize)" border :header-cell-style="headerStyle" :cell-style="{padding:'0',fontSize:'4px'}" :row-style="{height: '30px'}" row-key="id" stripe>
                ...
                <el-table-column align="center" prop="field_5" width="100%" label="品系类型" />
                <el-table-column align="center" prop="field_6" width="100%" label="品种名称" />
                <el-table-column align="center" prop="field_7" width="100%" label="栽培方式" />
                <el-table-column align="center" label="移栽期">
                  <el-table-column align="center" prop="field_8_1" width="100%" label="日期" />
                  <el-table-column align="center" prop="field_8_2" width="100%" label="叶龄（叶）" />
                  <el-table-column align="center" prop="field_8_3" width="130%" label="基本苗（万/亩）" />
                  <el-table-column align="center" prop="field_8_4" width="120%" label="亩穴数（万）" />
                </el-table-column>
                <el-table-column align="center" label="进程1（移栽后7天）">
                  ...
                  <el-table-column align="center" prop="field_9_3" width="100%" label="叶龄（叶）" />
                  <el-table-column align="center" prop="field_9_4" width="130%" label="茎蘖数（万/亩）" />
                </el-table-column>
                <el-table-column align="center" label="进程2（移栽后12天）">
                  ...
                  <el-table-column align="center" prop="field_10_3" width="100%" label="叶龄（叶）" />
                  <el-table-column align="center" prop="field_10_4" width="130%" label="茎蘖数（万/亩）" />
                </el-table-column>
                <el-table-column align="center" label="进程3（移栽后17天）">
                  ...
                  <el-table-column align="center" prop="field_11_3" width="100%" label="叶龄（叶）" />
                  <el-table-column align="center" prop="field_11_4" width="130%" label="茎蘖数（万/亩）" />
                </el-table-column>
                <el-table-column align="center" label="进程4（移栽后22天）">
                  ...
                  <el-table-column align="center" prop="field_12_3" width="100%" label="叶龄（叶）" />
                  <el-table-column align="center" prop="field_12_4" width="130%" label="茎蘖数（万/亩）" />
                </el-table-column>
                <el-table-column align="center" label="进程5（移栽后27天）">
                  ...
                  <el-table-column align="center" prop="field_13_3" width="100%" label="叶龄（叶）" />
                  <el-table-column align="center" prop="field_13_4" width="130%" label="茎蘖数（万/亩）" />
                </el-table-column>
                <el-table-column align="center" label="进程6（移栽后37天）">
                  ...
                  <el-table-column align="center" prop="field_14_3" width="100%" label="叶龄（叶）" />
                  <el-table-column align="center" prop="field_14_4" width="130%" label="茎蘖数（万/亩）" />
                </el-table-column>
                <el-table-column align="center" label="进程7（移栽后47天）">
                  ...
                  <el-table-column align="center" prop="field_15_3" width="100%" label="叶龄（叶）" />
                  <el-table-column align="center" prop="field_15_4" width="130%" label="茎蘖数（万/亩）" />
                </el-table-column>      
...
export default {
  ...
  data() {
    return {          
      ...
      //表名
      tableLabel:'',
      tableName:'crop_01_02_table_04_01',
      //县的option
      countys:[],
      county: '',
      //地区类型option
  ...
  methods: {
    ...
    initData() {
      ...
      this.tableLabel= this.years+"年度监测县(市、区)双季稻生育进度调查表（移栽稻）";
      //this.getHeaderList();
      this.getTableData();

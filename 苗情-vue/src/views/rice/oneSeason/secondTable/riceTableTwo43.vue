        ...
        <div class="tableRange">
          ...
          <div class="tableStyle">
            ...
            <el-table :data="tableData.slice((currentPage-1)*pagesize,currentPage*pagesize)" border :header-cell-style="headerStyle" :cell-style="{padding:'0',fontSize:'4px'}" :row-style="{height: '30px'}"  row-key="id" stripe>
                ...
                <el-table-column align="center" prop="field_8" width="140%" label="目标产量(kg/亩)" />
                <el-table-column align="center" prop="field_9" width="130%" label="基本苗（万/亩）" />
                <el-table-column align="center" label="拔节期（第一节间定长后）">
                  <el-table-column align="center" prop="field_10_1" width="100%" label="测定日期" />
                  <el-table-column align="center" prop="field_10_2" width="100%" label="株高（cm）" />
                  <el-table-column align="center" prop="field_10_3" width="150%" label="总茎蘖数（万/亩）" />
                  <el-table-column align="center" prop="field_10_4" width="150%" label="平均单茎绿叶数" />
                  <el-table-column align="center" prop="field_10_5" width="140%" label="倒4与倒3叶色比" />
                  <el-table-column align="center" prop="field_10_6" width="130%" label="1叶分蘖个数" />
                  <el-table-column align="center" prop="field_10_7" width="150%" label="2叶及以上分蘖个数" />
                  <el-table-column align="center" prop="field_10_8" width="150%" label="3叶及以上分蘖个数" />
                </el-table-column>
                <el-table-column align="center" label="孕穗期（幼穗分化1-2期）">
                  <el-table-column align="center" prop="field_11_1" width="100%" label="测定日期" />
                  <el-table-column align="center" prop="field_11_2" width="100%" label="株高（cm）" />
                  <el-table-column align="center" prop="field_11_3" width="150%" label="总茎蘖数（万/亩）" />
                  <el-table-column align="center" prop="field_11_4" width="150%" label="平均单茎绿叶数" />
                  <el-table-column align="center" prop="field_11_5" width="140%" label="倒4与倒3叶色比" />
                </el-table-column>
                <el-table-column align="center" label="孕穗期（幼穗分化3-4期）">
                  <el-table-column align="center" prop="field_12_1" width="100%" label="测定日期" />
                  <el-table-column align="center" prop="field_12_2" width="100%" label="株高（cm）" />
                  <el-table-column align="center" prop="field_12_3" width="150%" label="总茎蘖数（万/亩）" />
                  <el-table-column align="center" prop="field_12_4" width="150%" label="平均单茎绿叶数" />
                  <el-table-column align="center" prop="field_12_5" width="140%" label="倒4与倒3叶色比" />
                </el-table-column>
...
export default {
  ...
  data() {
    return {       
      ...
      //表名
      tableLabel:'',
      tableName:'crop_01_02_table_04_03',
      //县的option
      countys:[],
      county: '',
      //地区类型option
  ...
  methods: {
    ...
    initData() {
      ...
      this.tableLabel= this.years+"年度水稻监测点茎蘖数叶面积构成表";
      //this.getHeaderList();
      this.getTableData();

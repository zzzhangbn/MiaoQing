          ...
          <div class="tableRange">
            ...
            <div class="tableStyle">
              ...
              <el-table :data="tableData.slice((currentPage-1)*pagesize,currentPage*pagesize)" border :header-cell-style="headerStyle" :row-style="{height: '30px'}" :cell-style="{padding:'0',fontSize:'4px'}" row-key="id" stripe>
                  ...
                  <el-table-column align="center" fixed prop="field_1" width="105%" :index="countMethod" label="县（市、区）" />
                  ...
                  <!-- <el-table-column align="center" fixed prop="field_4" label="稻作类型" /> -->
...
export default {
  ...
  data() {
    return {          
      ...
      //表名
      tableLabel:'',
      tableName:'crop_01_02_table_01_01',
      //县的option
      countys:[],
      county: '',
      //地区类型option
  ...
  methods: {
    ...
    this.currentyear = myDate.getFullYear();
      ...
      this.tableLabel= this.years+"年度监测县(市、区)水稻生产栽插概况调查表";

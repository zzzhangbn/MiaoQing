        ...
        <div class="tableRange">
          ...
          <div class="tableStyle">
            ...
            <el-table :data="tableData.slice((currentPage-1)*pagesize,currentPage*pagesize)" border :header-cell-style="headerStyle"  :row-style="{height: '30px'}" :cell-style="{padding:'0',fontSize:'4px'}" row-key="id" stripe>
                ...
                <el-table-column align="center" fixed prop="field_4" width="100%" label="品系类型" />
                <el-table-column align="center" label="受灾统计表（万亩）">
                  <el-table-column align="center" prop="field_5_1" width="100%" label="填报日期" />
                  <el-table-column align="center" prop="field_5_2" width="180%" label="生育阶段与灾害症状" />
                  <el-table-column align="center" prop="field_5_3" width="100%" label="受灾面积" />
                  <el-table-column align="center" prop="field_5_4" width="150%" label="其中：成灾面积" />
                  <el-table-column align="center" prop="field_5_5" width="150%" label="其中：绝收面积" />
                  <el-table-column align="center" prop="field_5_6" width="150%" label="需补改种面积" />
                  <el-table-column align="center" prop="field_5_7" width="150%" label="已补改种面积" />
                </el-table-column>
                <el-table-column align="center" label="受灾统计表（万亩）">
                  <el-table-column align="center" prop="field_6_1" width="100%" label="填报日期" />
                  <el-table-column align="center" prop="field_6_2" width="160%" label="生育进程、阶段" />
                  <el-table-column align="center" prop="field_6_3" width="100%" label="受灾面积" />
                  <el-table-column align="center" prop="field_6_4" width="150%" label="其中：成灾面积" />
                  <el-table-column align="center" prop="field_6_5" width="150%" label="其中：绝收面积" />
                  <el-table-column align="center" prop="field_6_6" width="150%" label="需补改种面积" />
                  <el-table-column align="center" prop="field_6_7" width="150%" label="已补改种面积" />
                </el-table-column>
                <el-table-column align="center" label="受灾统计表（万亩）">
                  <el-table-column align="center" prop="field_7_1" width="100%" label="填报日期" />
                  <el-table-column align="center" prop="field_7_2" width="160%" label="生育进程、阶段" />
                  <el-table-column align="center" prop="field_7_3" width="100%" label="受灾面积" />
                  <el-table-column align="center" prop="field_7_4" width="150%" label="其中：成灾面积" />
                  <el-table-column align="center" prop="field_7_5" width="150%" label="其中：绝收面积" />
                  <el-table-column align="center" prop="field_7_6" width="150%" label="需补改种面积" />
                  <el-table-column align="center" prop="field_7_7" width="150%" label="已补改种面积" />
                </el-table-column>       

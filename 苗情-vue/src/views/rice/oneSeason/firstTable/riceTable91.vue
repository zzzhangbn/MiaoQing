              ...
              <el-table :data="tableData.slice((currentPage-1)*pagesize,currentPage*pagesize)" border :header-cell-style="headerStyle" :row-class-name="tableRowClassName" :row-style="{height: '30px'}" :cell-style="{padding:'0',fontSize:'4px'}" row-key="id" stripe>
                <!-- <el-table-column :label="tableLabel" align="center"> -->
                  ...
                  <el-table-column align="center" label="1月份">
                    <el-table-column align="center" prop="field_2_1" width="110%" label="平均温度（℃）" />
                    <el-table-column align="center" prop="field_2_2" width="110%" label="有效积温（℃）" />
                    <el-table-column align="center" prop="field_2_3" width="110%" label="光照时数（h）" />
                    <el-table-column align="center" prop="field_2_4" width="110%" label="降雨量（mm）" />
                  </el-table-column>
                  <el-table-column align="center" label="2月份">
                    <el-table-column align="center" prop="field_3_1" width="110%" label="平均温度（℃）" />
                    <el-table-column align="center" prop="field_3_2" width="110%" label="有效积温（℃）" />
                    <el-table-column align="center" prop="field_3_3" width="110%" label="光照时数（h）" />
                    <el-table-column align="center" prop="field_3_4" width="110%" label="降雨量（mm）" />
                  </el-table-column>
                  <el-table-column align="center" label="3月份">
                    <el-table-column align="center" prop="field_4_1" width="110%" label="平均温度（℃）" />
                    <el-table-column align="center" prop="field_4_2" width="110%" label="有效积温（℃）" />
                    <el-table-column align="center" prop="field_4_3" width="110%" label="光照时数（h）" />
                    <el-table-column align="center" prop="field_4_4" width="110%" label="降雨量（mm）" />
                  </el-table-column>
                  <el-table-column align="center" label="4月份">
                    <el-table-column align="center" prop="field_5_1" width="110%" label="平均温度（℃）" />
                    <el-table-column align="center" prop="field_5_2" width="110%" label="有效积温（℃）" />
                    <el-table-column align="center" prop="field_5_3" width="110%" label="光照时数（h）" />
                    <el-table-column align="center" prop="field_5_4" width="110%" label="降雨量（mm）" />
                  </el-table-column>
                  <el-table-column align="center" label="5月份">
                    <el-table-column align="center" prop="field_6_1" width="110%" label="平均温度（℃）" />
                    <el-table-column align="center" prop="field_6_2" width="110%" label="有效积温（℃）" />
                    <el-table-column align="center" prop="field_6_3" width="110%" label="光照时数（h）" />
                    <el-table-column align="center" prop="field_6_4" width="110%" label="降雨量（mm）" />
                  </el-table-column>
                  <el-table-column align="center" label="6月份">
                    <el-table-column align="center" prop="field_7_1" width="110%" label="平均温度（℃）" />
                    <el-table-column align="center" prop="field_7_2" width="110%" label="有效积温（℃）" />
                    <el-table-column align="center" prop="field_7_3" width="110%" label="光照时数（h）" />
                    <el-table-column align="center" prop="field_7_4" width="110%" label="降雨量（mm）" />
                  </el-table-column>
                  <el-table-column align="center" label="7月份">
                    <el-table-column align="center" prop="field_8_1" width="110%" label="平均温度（℃）" />
                    <el-table-column align="center" prop="field_8_2" width="110%" label="有效积温（℃）" />
                    <el-table-column align="center" prop="field_8_3" width="110%" label="光照时数（h）" />
                    <el-table-column align="center" prop="field_8_4" width="110%" label="降雨量（mm）" />
                  </el-table-column>
                  <el-table-column align="center" label="8月份">
                    <el-table-column align="center" prop="field_9_1" width="110%" label="平均温度（℃）" />
                    <el-table-column align="center" prop="field_9_2" width="110%" label="有效积温（℃）" />
                    <el-table-column align="center" prop="field_9_3" width="110%" label="光照时数（h）" />
                    <el-table-column align="center" prop="field_9_4" width="110%" label="降雨量（mm）" />
                  </el-table-column>
                  <el-table-column align="center" label="9月份">
                    <el-table-column align="center" prop="field_10_1" width="110%" label="平均温度（℃）" />
                    <el-table-column align="center" prop="field_10_2" width="110%" label="有效积温（℃）" />
                    <el-table-column align="center" prop="field_10_3" width="110%" label="光照时数（h）" />
                    <el-table-column align="center" prop="field_10_4" width="110%" label="降雨量（mm）" />
                  </el-table-column>
                  <el-table-column align="center" label="10月份">
                    <el-table-column align="center" prop="field_11_1" width="110%" label="平均温度（℃）" />
                    <el-table-column align="center" prop="field_11_2" width="110%" label="有效积温（℃）" />
                    <el-table-column align="center" prop="field_11_3" width="110%" label="光照时数（h）" />
                    <el-table-column align="center" prop="field_11_4" width="110%" label="降雨量（mm）" />
                  </el-table-column>
                  <el-table-column align="center" label="11月份">
                    <el-table-column align="center" prop="field_12_1" width="110%" label="平均温度（℃）" />
                    <el-table-column align="center" prop="field_12_2" width="110%" label="有效积温（℃）" />
                    <el-table-column align="center" prop="field_12_3" width="110%" label="光照时数（h）" />
                    <el-table-column align="center" prop="field_12_4" width="110%" label="降雨量（mm）" />
                  </el-table-column>
                  <el-table-column align="center" label="12月份">
                    <el-table-column align="center" prop="field_13_1" width="110%" label="平均温度（℃）" />
                    <el-table-column align="center" prop="field_13_2" width="110%" label="有效积温（℃）" />
                    <el-table-column align="center" prop="field_13_3" width="110%" label="光照时数（h）" />
                    <el-table-column align="center" prop="field_13_4" width="110%" label="降雨量（mm）" />
                  </el-table-column>
                <!-- </el-table-column> -->
              </el-table>

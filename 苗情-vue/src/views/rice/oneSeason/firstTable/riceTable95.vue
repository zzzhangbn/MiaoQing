          ...
          <div class="tableStyle">
            ...
            <el-table :data="tableData.slice((currentPage-1)*pagesize,currentPage*pagesize)" border :header-cell-style="headerStyle" :row-class-name="tableRowClassName" :row-style="{height: '30px'}" :cell-style="{padding:'0',fontSize:'4px'}" row-key="id" stripe>
              <!-- <el-table-column :label="tableLabel" align="center"> -->
                ...
                <el-table-column align="center" prop="field_1" width="105%" label="县（市、区）" />
                ...
                <el-table-column align="center" prop="field_5" width="100%" label="高温热害" />
                <el-table-column align="center" prop="field_6" width="100%" label="高温热害发生时间" />
                <el-table-column align="center" prop="field_7" width="100%" label="全县种植面积（万亩）" />
                <el-table-column align="center" prop="field_8" width="100%" label="热害总面积（万亩）" />
                ...
                <el-table-column align="center" prop="field_10" width="100%" label="主要品种名称" />
                <el-table-column align="center" prop="field_11" width="100%" label="占比（%）" />
                <el-table-column align="center" prop="field_12" width="100%" label="其中：成灾面积（万亩）" />
                <el-table-column align="center" prop="field_13" width="100%" label="其中：绝收面积（万亩）" />
                <el-table-column align="center" prop="field_14" width="100%" label="产量损失（%）" />
...
export default {
  ...
  data() {
    return {       
      ...
      //表名
      tableLabel:'',
      tableName:'crop_01_01_table_09_05',
      //县的option
      countys:[],
      county: '',
      //地区类型option

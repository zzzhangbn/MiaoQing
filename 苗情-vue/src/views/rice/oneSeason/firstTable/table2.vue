         ...
         // _this.tableData=res.data;
          ...
          if(totalTableData.length != 0){
            ...
            totalTableData.push({"field_1":'合计',"field_2":num1,
                                "field_3_1":'合计',"field_3_2":sums1[0],"field_3_3":sums1[1],"field_3_4":sums1[2],"field_3_5":sums1[3],"field_3_6":sums1[4],
                                "field_4_1":'合计',"field_4_2":sums1[5],"field_4_3":sums1[6],"field_4_4":sums1[7],"field_4_5":sums1[8],"field_4_6":sums1[9],
                                "field_5":num14,
                                "field_6_1":'合计',"field_6_2":sums1[10],"field_6_3":sums1[11],"field_6_4":sums1[12],"field_6_5":sums1[13],"field_6_6":sums1[14],
                                "field_7_1":'合计',"field_7_2":sums1[15],"field_7_3":sums1[16],"field_7_4":sums1[17],"field_7_5":sums1[18],"field_7_6":sums1[19],
                                "in_use":'--'})
       ...
       axios({
         ...
         // _this.tableData=res.data;
          ...
          if(totalTableData.length != 0){
            ...
            //辅助数组
            totalTableData.push({"field_1":'合计',"field_2":'--',"field_3":num1,
                                "field_4_1":'--',"field_4_2_1":'合计',"field_4_2_2":sums1[0],"field_5_1":'--',"field_5_2_1":'合计',"field_5_2_2":sums1[1],
                                "field_6_1":'--',"field_6_2_1":'合计',"field_6_2_2":sums1[2],
                                "field_7_1":'合计',"field_7_2":mean[1],"field_7_3":mean[2],"field_7_4":mean[3],"field_7_5":mean[4],"field_7_6":mean[5],
                                "in_use":'--'})
       ...
       axios({
         ...
         // _this.tableData=res.data;
          ...
          if(totalTableData.length != 0){
            ...
            totalTableData.push({"field_1":'合计',"field_2":'--',"field_3":num1,
                                "field_4_1":'--',"field_4_2_1":'合计',"field_4_2_2":sums1[0],"field_5_1":'--',"field_5_2_1":'合计',"field_5_2_2":sums1[1],
                                "field_6_1":'--',"field_6_2_1":'合计',"field_6_2_2":sums1[2],"field_7_1":'--',"field_7_2_1":'合计',"field_7_2_2":sums1[3],
                                "field_8_1":'合计',"field_8_2":mean[1],"field_8_3":mean[2],"field_8_4":mean[3],"field_8_5":mean[4],"field_8_6":mean[5],
                                "in_use":'--'})
         ...
         // _this.tableData=res.data;
          ...
          if(totalTableData.length != 0){
            ...
            for(var i=0; i<totalTableData.length; i++){
              ...
              num35 = _this.add(num35*1+totalTableData[i].fiel_9_5*1);

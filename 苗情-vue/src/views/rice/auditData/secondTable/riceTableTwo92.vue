              ...
              <div style="height:100px;margin-bottom:10px">
                <el-table :data="tableData" border :header-cell-style="headerStyle" :row-style="{height: '30px'}" :cell-style="{padding:'0',fontSize:'8px'}" row-key="id" stripe >
                    <el-table-column align="center" label="晚稻-抽穗期前15天">
                      <el-table-column align="center" prop="field_4_1"  label="日平均气温（℃）" />
                      <el-table-column align="center" prop="field_4_2"  label="日最高气温（℃）" />
                      <el-table-column align="center" prop="field_4_3"  label="降雨量（mm）" />
                      <el-table-column align="center" prop="field_4_4"  label="日照时数（h）" />
                      <el-table-column align="center" prop="field_4_5"  label="晴好天气天数（天）" />
                      <el-table-column align="center" prop="field_4_6"  label="阴雨天气天数（天）" />
                    </el-table-column>
                </el-table>
              </div>
            </el-row>
              ...
              <div style="height:100px;margin-bottom:10px">
                <el-table :data="tableData" border :header-cell-style="headerStyle" :row-style="{height: '30px'}" :cell-style="{padding:'0',fontSize:'8px'}" row-key="id" stripe >
                    <el-table-column align="center" label="晚稻-抽穗期后15天">
                      <el-table-column align="center" prop="field_5_1"  label="日平均气温（℃）" />
                      <el-table-column align="center" prop="field_5_2"  label="日最高气温（℃）" />
                      <el-table-column align="center" prop="field_5_3"  label="降雨量（mm）" />
                      <el-table-column align="center" prop="field_5_4"  label="日照时数（h）" />
                      <el-table-column align="center" prop="field_5_5"  label="晴好天气天数（天）" />
                      <el-table-column align="center" prop="field_5_6"  label="阴雨天气天数（天）" />
                    </el-table-column>
                </el-table>
              </div>
            </el-row>

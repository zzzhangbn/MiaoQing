  ...
  <div class="demo-image__placeholder">
    ...
    <div id="containner_div" style="width: 100%;height: 70%;">
      ...
      <table id="sum_tab" style="width: 100%;overflow-x: auto;border: 1px solid lightgray;text-align: center;line-height: 40px;" border="1" cellspacing="0">
        <tr style="background-color: #6E8B3D;color:white;">
          <td colspan="12">2021年度水稻监测点灌浆速率调查表（早稻）</td>
        </tr>
        <tr style="background-color: #CDBE70;color: green;">
          <td style="width: 8%;">县（市、区）</td>
          <td style="width: 8%;">监测点代码</td>
          <td style="width: 8%;">地区类型</td>
          <td style="width: 8%;">稻作类型</td>
          <td style="width: 8%;">品种名称</td>
          <td style="width: 8%;">栽植方式</td>
          <td style="width: 8%;">灌浆速率测定1</td>
          <td style="width: 8%;">灌浆速率测定2</td>
          <td style="width: 8%;">灌浆速率测定3</td>
          <td style="width: 8%;">灌浆速率测定4</td>
          <td style="width: 8%;">灌浆速率测定5</td>
          <td style="width: 8%;">灌浆速率测定6</td>
    ...
    <el-dialog :title="tableFlag" :visible.sync="detialDialogVisible" width="60%" :before-close="handleClose">
      <table style="width: 90%;border: 1px solid lightgray;line-height: 40px;" border="1" cellspacing="0">
        ...
        <template v-if="tableFlag == '灌浆速率测定2'">
          <tr style="text-align: center;font-size: 20px;line-height: 40px;color: gray;background-color: #DDDDDD;">
            <td style="width: 20%">日期</td>
            <td style="width: 20%">千粒重(克)</td>
            <td style="width: 20%">灌浆速率（克/千粒•天）</td>
          </tr>
          <tr>
            <td><el-date-picker
                    value-format=“yyyy-MM-dd”
        ...
        <template v-if="tableFlag == '灌浆速率测定3'">
          <tr style="text-align: center;font-size: 20px;line-height: 40px;color: gray;background-color: #DDDDDD;">
            <td style="width: 20%">日期</td>
            <td style="width: 20%">千粒重(克)</td>
            <td style="width: 20%">灌浆速率（克/千粒•天）</td>
        ...
        <template v-if="tableFlag == '灌浆速率测定4'">
          <tr style="text-align: center;font-size: 20px;line-height: 40px;color: gray;background-color: #DDDDDD;">
            <td style="width: 20%">日期</td>
            <td style="width: 20%">千粒重(克)</td>
            <td style="width: 20%">灌浆速率（克/千粒•天）</td>
        ...
        <template v-if="tableFlag == '灌浆速率测定5'">
          <tr style="text-align: center;font-size: 20px;line-height: 40px;color: gray;background-color: #DDDDDD;">
            <td style="width: 20%">日期</td>
            <td style="width: 20%">千粒重(克)</td>
            <td style="width: 20%">灌浆速率（克/千粒•天）</td>
        ...
        <template v-if="tableFlag == '灌浆速率测定6'">
          <tr style="text-align: center;font-size: 20px;line-height: 40px;color: gray;background-color: #DDDDDD;">
            <td style="width: 20%">日期</td>
            <td style="width: 20%">千粒重(克)</td>
            <td style="width: 20%">灌浆速率（克/千粒•天）</td>
      ...
      getFormList(flag){
        ...
        for(var i = 0 ;i < this.data.length ; ++i){
          ...
          if (this.data[i].field_12_1 != null){
            this.data[i].field_12_1 = this.data[i].field_12_1.replace('“','').replace('”','')
          }
        ...
        // this.data.field_10_1 = this.data.field_10_1.replace('“','').replace('”','')
        // this.data.field_11_1 = this.data.field_11_1.replace('“','').replace('”','')

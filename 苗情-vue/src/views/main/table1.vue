      ...
      <el-table :data="data"  :header-cell-style="headerStyle" >
                <!-- <el-table-column :label="tableLabel" align="center"> -->
                  ...
                  <el-table-column align="center"  label="栽植方式（万亩）">
                    <el-table-column align="center" label="人工移栽">
                      <el-table-column align="center" prop="field_4_2_1" label="面积（万亩）" >
                        <input style="background-color: #fff;border-radius: 4px;border: 1px solid #dcdfe6;width: 100%;box-sizing: border-box;color: #606266;text-align: center;font-size: inherit;height: 40px;line-height: 40px;" 
                          ...
                          :disabled="copyData[fieldRowIndex].field_5_1_1 !=='' && copyData[fieldRowIndex].field_5_1_1 !== null&& column_id == ''"></input>
                      </el-table-column>
                    ...
                    <el-table-column align="center" label="机械插秧">
                      <el-table-column align="center" prop="" label="面积（万亩）" >
                        ...
                        :disabled="copyData[fieldRowIndex].field_5_2_1 !=='' && copyData[fieldRowIndex].field_5_2_1 !== null && column_id == ''"></input>
                      </el-table-column>
                      <el-table-column align="center" prop="" label="（占比）自动计算" >
                        <input style="background-color: #f5f7fa;border-radius: 4px;border: 1px solid #dcdfe6;width: 100%;box-sizing: border-box;color: #606266;text-align: center;font-size: inherit;height: 40px;line-height: 40px;"
                        placeholder="自动计算"
                    ...
                    <el-table-column align="center" label="盘育抛栽">
                      <el-table-column align="center"  label="面积（万亩）" >
                        ...
                        :disabled="copyData[fieldRowIndex].field_5_3_1 !=='' && copyData[fieldRowIndex].field_5_3_1 !== null && column_id == ''"></input>
                      </el-table-column>
                      <el-table-column align="center" label="（占比）自动计算" >
                        <input style="background-color: #f5f7fa;border-radius: 4px;border: 1px solid #dcdfe6;width: 100%;box-sizing: border-box;color: #606266;text-align: center;font-size: inherit;height: 40px;line-height: 40px;" 
                        placeholder="自动计算"
                        disabled v-model="data[fieldRowIndex].field_5_3_2"></input>
                      </el-table-column>
                    </el-table-column>
                    <el-table-column align="center" label="无盘旱育抛栽">
                      <el-table-column align="center"  label="面积（万亩）" >
                        ...
                        :disabled="copyData[fieldRowIndex].field_5_4_1 !=='' && copyData[fieldRowIndex].field_5_4_1 !== null && column_id == ''"></input>
                      </el-table-column>
                      <el-table-column align="center" prop="field_4_4_2" label="（占比）自动计算" >
                        <input style="background-color: #f5f7fa;border-radius: 4px;border: 1px solid #dcdfe6;width: 100%;box-sizing: border-box;color: #606266;text-align: center;font-size: inherit;height: 40px;line-height: 40px;" 
                        placeholder="自动计算"
                        disabled v-model="data[fieldRowIndex].field_5_4_2"></input>
                      </el-table-column>
                    </el-table-column>
                    ...
                    <el-table-column align="center" label="撒直播(旱)">
                      <el-table-column align="center" prop="field_4_4_1" label="面积（万亩）" >
                        ...
                        :disabled="copyData[fieldRowIndex].field_5_5_1 !=='' && copyData[fieldRowIndex].field_5_5_1 !== null && column_id == ''"></input>
                      </el-table-column>
                      <el-table-column align="center" prop="field_4_4_2" label="（占比）自动计算" >
                        <input style="background-color: #f5f7fa;border-radius: 4px;border: 1px solid #dcdfe6;width: 100%;box-sizing: border-box;color: #606266;text-align: center;font-size: inherit;height: 40px;line-height: 40px;" 
                         placeholder="自动计算"
                         disabled v-model="data[fieldRowIndex].field_5_5_2"></input>
                      </el-table-column>
                    </el-table-column>
                    <el-table-column align="center" label="撒直播(水)">
                      <el-table-column align="center" prop="field_4_4_1" label="面积（万亩）" >
                       ...
                       :disabled="copyData[fieldRowIndex].field_5_6_1 !=='' && copyData[fieldRowIndex].field_5_6_1 !== null && column_id == ''"></input>
                      </el-table-column>
                      <el-table-column align="center" prop="field_4_4_2" label="（占比）自动计算" >
                        <input style="background-color: #f5f7fa;border-radius: 4px;border: 1px solid #dcdfe6;width: 100%;box-sizing: border-box;color: #606266;text-align: center;font-size: inherit;height: 40px;line-height: 40px;" 
                        placeholder="自动计算"
                        disabled v-model="data[fieldRowIndex].field_5_6_2"></input>
                      </el-table-column>
                    </el-table-column>
                    <el-table-column align="center" label="机条播(旱)">
                      <el-table-column align="center" prop="field_4_4_1" label="面积（万亩）" >
                        ...
                        :disabled="copyData[fieldRowIndex].field_5_7_1 !=='' && copyData[fieldRowIndex].field_5_7_1 !== null && column_id == ''"></input>
                      </el-table-column>
                      <el-table-column align="center" prop="field_4_4_2" label="（占比）自动计算" >
                        <input style="background-color: #f5f7fa;border-radius: 4px;border: 1px solid #dcdfe6;width: 100%;box-sizing: border-box;color: #606266;text-align: center;font-size: inherit;height: 40px;line-height: 40px;" 
                        placeholder="自动计算"
                        disabled v-model="data[fieldRowIndex].field_5_7_2"></input>
                      </el-table-column>
                    </el-table-column>
                    <el-table-column align="center" label="机条播(水)">
                      <el-table-column align="center" prop="field_4_4_1" label="面积（万亩）" >
                        ...
                        :disabled="copyData[fieldRowIndex].field_5_8_1 !=='' && copyData[fieldRowIndex].field_5_8_1 !== null && column_id == ''"></input>
                      </el-table-column>
                      <el-table-column align="center" prop="field_4_4_2" label="（占比）自动计算" >
                        <input style="background-color: #f5f7fa;border-radius: 4px;border: 1px solid #dcdfe6;width: 100%;box-sizing: border-box;color: #606266;text-align: center;font-size: inherit;height: 40px;line-height: 40px;" 
                        placeholder="自动计算"
                        disabled v-model="data[fieldRowIndex].field_5_8_2"></input>
                      </el-table-column>
                    </el-table-column>
                  ...
                  <el-table-column  align="center"  label="前茬口类型（万亩）">
                    ...
                    <el-table-column align="center" label="水稻">
                      <el-table-column align="center" prop="field_5_2_1" label="面积（万亩）" >
                        ...
                        :disabled="copyData[fieldRowIndex].field_6_1_1 !=='' && copyData[fieldRowIndex].field_6_1_1 !== null && column_id == ''"
                        class="secondFieldDetail" v-model="data[fieldRowIndex].field_6_1_1"  @blur.prevent="checkFirstFieldInput($event)"></input>
                      </el-table-column>
                      <el-table-column align="center" prop="field_5_2_2" label="（占比）自动计算" >
                        <input  style="background-color: #f5f7fa;border-radius: 4px;border: 1px solid #dcdfe6;width: 100%;box-sizing: border-box;color: #606266;text-align: center;font-size: inherit;height: 40px;line-height: 40px;" 
                        placeholder="自动计算"
                        disabled v-model="data[fieldRowIndex].field_6_1_2"></input>
                      </el-table-column>
                    </el-table-column>
                    <el-table-column align="center" label="小麦">
                      <el-table-column align="center" prop="field_5_3_1" label="面积（万亩）" >
                        ...
                        :disabled="copyData[fieldRowIndex].field_6_2_1 !=='' && copyData[fieldRowIndex].field_6_2_1 !== null && column_id == ''"></input>
                      </el-table-column>
                      <el-table-column align="center" prop="field_5_3_2" label="（占比）自动计算" >
                        <input style="background-color: #f5f7fa;border-radius: 4px;border: 1px solid #dcdfe6;width: 100%;box-sizing: border-box;color: #606266;text-align: center;font-size: inherit;height: 40px;line-height: 40px;" 
                        placeholder="自动计算"
                        disabled v-model="data[fieldRowIndex].field_6_2_2"></input>
                      </el-table-column>
                    </el-table-column>
                    <el-table-column align="center" label="油菜">
                      <el-table-column align="center" prop="field_5_4_1" label="面积（万亩）" >
                        ...
                        :disabled="copyData[fieldRowIndex].field_6_3_1 !=='' && copyData[fieldRowIndex].field_6_3_1 !== null && column_id == ''"></input>
                      </el-table-column>
                      <el-table-column align="center" prop="field_5_4_2" label="（占比）自动计算" >
                        <input style="background-color: #f5f7fa;border-radius: 4px;border: 1px solid #dcdfe6;width: 100%;box-sizing: border-box;color: #606266;text-align: center;font-size: inherit;height: 40px;line-height: 40px;" 
                        placeholder="自动计算"
                        disabled v-model="data[fieldRowIndex].field_6_3_2"></input>
                      </el-table-column>
                    </el-table-column>
                    <el-table-column align="center" label="空闲田">
                      <el-table-column align="center" prop="field_5_4_1" label="面积（万亩）" >
                       ...
                       :disabled="copyData[fieldRowIndex].field_6_4_1 !=='' && copyData[fieldRowIndex].field_6_4_1 !== null && column_id == ''"></input>
                      </el-table-column>
                      <el-table-column align="center" prop="field_5_4_2" label="（占比）自动计算" >
                        <input style="background-color: #f5f7fa;border-radius: 4px;border: 1px solid #dcdfe6;width: 100%;box-sizing: border-box;color: #606266;text-align: center;font-size: inherit;height: 40px;line-height: 40px;" 
                        placeholder="自动计算"
                        disabled v-model="data[fieldRowIndex].field_6_4_2"></input>
                      </el-table-column>
                    </el-table-column>
                    <el-table-column align="center" label="绿肥">
                      <el-table-column align="center" prop="field_5_4_1" label="面积（万亩）" >
                        ...
                        :disabled="copyData[fieldRowIndex].field_6_5_1 !=='' && copyData[fieldRowIndex].field_6_5_1 !== null && column_id == ''"></input>
                      </el-table-column>
                      <el-table-column align="center" prop="field_5_4_2" label="（占比）自动计算" >
                        <input style="background-color: #f5f7fa;border-radius: 4px;border: 1px solid #dcdfe6;width: 100%;box-sizing: border-box;color: #606266;text-align: center;font-size: inherit;height: 40px;line-height: 40px;" 
                         placeholder="自动计算"
                         disabled v-model="data[fieldRowIndex].field_6_5_2"></input>
                      </el-table-column>
                    </el-table-column>
                    <el-table-column align="center" label="蔬菜等经作">
                      <el-table-column align="center" prop="field_5_4_1" label="面积（万亩）" >
                        ...
                        :disabled="copyData[fieldRowIndex].field_6_6_1 !=='' && copyData[fieldRowIndex].field_6_6_1 !== null && column_id == ''"></input>
                      </el-table-column>
                      <el-table-column align="center" prop="field_5_4_2" label="（占比）自动计算" >
                        <input style="background-color: #f5f7fa;border-radius: 4px;border: 1px solid #dcdfe6;width: 100%;box-sizing: border-box;color: #606266;text-align: center;font-size: inherit;height: 40px;line-height: 40px;" 
                        placeholder="自动计算"
                        disabled v-model="data[fieldRowIndex].field_6_6_2"></input>
                      </el-table-column>
                    </el-table-column>
                    <el-table-column align="center" label="其它">
                      <el-table-column align="center" prop="field_5_4_1" label="面积（万亩）" >
                        ...
                        :disabled="copyData[fieldRowIndex].field_6_7_1 !=='' && copyData[fieldRowIndex].field_6_7_1 !== null && column_id == ''"></input>
                      </el-table-column>
                      <el-table-column align="center" prop="field_5_4_2" label="（占比）自动计算" >
                        <input style="background-color: #f5f7fa;border-radius: 4px;border: 1px solid #dcdfe6;width: 100%;box-sizing: border-box;color: #606266;text-align: center;font-size: inherit;height: 40px;line-height: 40px;" 
                        placeholder="自动计算"
                        disabled v-model="data[fieldRowIndex].field_6_7_2"></input>
                      </el-table-column>
                    </el-table-column>
                    <el-table-column align="center" label="小计">
                      <el-table-column align="center" prop="field_5_4_1" label="面积（万亩）" >
                  ...
                  <el-table-column align="center"  fixed="right" width="120px" label="操作">
                    <el-button style="display: inline-block; float: right;margin-top: 1%;margin-right: 1.4%;margin-bottom: 1%;">暂存</el-button>
      ...
      methods:{
        ...
        onBlur(x1,x2){
          if(x1 == 'field_5_8_1'){
            ...
            &&this.add(Number(this.data[this.fieldRowIndex].field_5_1_1)+Number(this.data[this.fieldRowIndex].field_5_2_1)+Number(this.data[this.fieldRowIndex].field_5_3_1)+Number(this.data[this.fieldRowIndex].field_5_4_1)+Number(this.data[this.fieldRowIndex].field_5_5_1)+Number(this.data[this.fieldRowIndex].field_5_6_1)+Number(this.data[this.fieldRowIndex].field_5_7_1)+Number(this.data[this.fieldRowIndex].field_5_8_1)) !=Number(this.data[this.fieldRowIndex].field_2)){
            ...
            &&this.add(Number(this.data[this.fieldRowIndex].field_5_1_1)+Number(this.data[this.fieldRowIndex].field_5_2_1)+Number(this.data[this.fieldRowIndex].field_5_3_1)+Number(this.data[this.fieldRowIndex].field_5_4_1)+Number(this.data[this.fieldRowIndex].field_5_5_1)+Number(this.data[this.fieldRowIndex].field_5_6_1)+Number(this.data[this.fieldRowIndex].field_5_7_1)+Number(this.data[this.fieldRowIndex].field_5_8_1)) ==Number(this.data[this.fieldRowIndex].field_2)){
              this.data[this.fieldRowIndex].field_5_9_1 = this.add(Number(this.data[this.fieldRowIndex].field_5_1_1)+Number(this.data[this.fieldRowIndex].field_5_2_1)+Number(this.data[this.fieldRowIndex].field_5_3_1)+Number(this.data[this.fieldRowIndex].field_5_4_1)+Number(this.data[this.fieldRowIndex].field_5_5_1)+Number(this.data[this.fieldRowIndex].field_5_6_1)+Number(this.data[this.fieldRowIndex].field_5_7_1)+Number(this.data[this.fieldRowIndex].field_5_8_1));
            }else{
          ...
          if(x1 == 'field_6_7_1'){
            if(this.data[this.fieldRowIndex].field_6_1_1!=null && this.data[this.fieldRowIndex].field_6_2_1!=null && this.data[this.fieldRowIndex].field_6_3_1!=null && this.data[this.fieldRowIndex].field_6_4_1!=null && this.data[this.fieldRowIndex].field_6_5_1!=null && this.data[this.fieldRowIndex].field_6_6_1!=null && this.data[this.fieldRowIndex].field_6_7_1!=null && Number(this.data[this.fieldRowIndex].field_6_1_1)+Number(this.data[this.fieldRowIndex].field_6_2_1)+Number(this.data[this.fieldRowIndex].field_6_3_1)+Number(this.data[this.fieldRowIndex].field_6_4_1)+Number(this.data[this.fieldRowIndex].field_6_5_1)+Number(this.data[this.fieldRowIndex].field_6_6_1)+Number(this.data[this.fieldRowIndex].field_6_7_1)!=Number(this.data[this.fieldRowIndex].field_2)){
              ...
              this.data[this.fieldRowIndex].field_6_8_1 = this.add(Number(this.data[this.fieldRowIndex].field_6_1_1)+Number(this.data[this.fieldRowIndex].field_6_2_1)+Number(this.data[this.fieldRowIndex].field_6_3_1)+Number(this.data[this.fieldRowIndex].field_6_4_1)+Number(this.data[this.fieldRowIndex].field_6_5_1)+Number(this.data[this.fieldRowIndex].field_6_6_1)+Number(this.data[this.fieldRowIndex].field_6_7_1));
            }else{
          ...
          axios({
            ...
            getFormList(flag){
              this.$confirm("是否上报？").then(_=>{
                  ...
                  for(var i = 0 ; i < this.data.length ; ++i){
                    if((this.data[i].field_5_9_2 != '100.00%' && this.data[i].field_5_9_2 != '0.00%') || (this.data[i].field_6_8_2 != '100.00%' && this.data[i].field_6_8_2 != '0.00%')){
            ...
            saveInputData(list){
              axios({
                url:'/getSituationInputDataTable1',
                method:'post',
                params:{
                  data:list
                },

  ...
  <div class="demo-image__placeholder">
    ...
    <div id="containner_div" style="width: 100%;height: 70%;">
      ...
      <table id="sum_tab" style="width: 100%;overflow-x: auto;border: 1px solid lightgray;text-align: center;line-height: 40px;" border="1" cellspacing="0">
        ...
        <tr style="background-color: #CDBE70;color: green;">
          ...
          <td style="width: 10%;">基肥施肥（以折纯计kg/亩）1</td>
          <td style="width: 10%;">分蘖肥施肥（以折纯计kg/亩）2</td>
          <td style="width: 10%;">孕穗肥施肥（以折纯计kg/亩）3</td>
          <td style="width: 10%;">孕穗肥施肥（以折纯计kg/亩）4</td>
          <td style="width: 10%;">抽穗叶面肥施肥（以折纯计kg/亩）4</td>
        </tr>
    ...
    <el-dialog :title="tableFlag" :visible.sync="detialDialogVisible" width="80%" :before-close="handleClose" >
      <table style="width: 90%;border: 1px solid lightgray;line-height: 40px;" border="1" cellspacing="0">
        <template v-if="tableFlag == '基肥施肥（以折纯计kg/亩）1'">
        ...
        <template v-if="tableFlag == '分蘖肥施肥（以折纯计kg/亩）2'">
          <tr style="text-align: center;font-size: 20px;line-height: 40px;color: gray;background-color: #DDDDDD;">
            <td style="width: 10%">时间</td>
            <td style="width: 10%">N</td>
            <td style="width: 10%">P</td>
        ...
        <template v-if="tableFlag == '孕穗肥施肥（以折纯计kg/亩）3'">
          <tr style="text-align: center;font-size: 20px;line-height: 40px;color: gray;background-color: #DDDDDD;">
            <td style="width: 10%">时间</td>
            <td style="width: 10%">N</td>
            <td style="width: 10%">P</td>
        ...
        <template v-if="tableFlag == '孕穗肥施肥（以折纯计kg/亩）4'">
          <tr style="text-align: center;font-size: 20px;line-height: 40px;color: gray;background-color: #DDDDDD;">
            <td style="width: 10%">时间</td>
            <td style="width: 10%">N</td>
            <td style="width: 10%">P</td>
        ...
        <template v-if="tableFlag == '抽穗叶面肥施肥（以折纯计kg/亩）4'">
          <tr style="text-align: center;font-size: 20px;line-height: 40px;color: gray;background-color: #DDDDDD;">
            <td style="width: 10%">时间</td>
            <td style="width: 10%">N</td>
            <td style="width: 10%">P</td>
        ...
        this.$confirm("是否上报？").then(_=>{
          ...
          for(var i = 0 ;i < this.data.length ; ++i){
            ...
            if (this.data[i].field_10_1 != null){
              this.data.field_10_1 = this.data[i].field_10_1.replace('“','').replace('”','')
            }

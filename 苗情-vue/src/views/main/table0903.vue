            ...
            <table  id="sum_tab"  style="width: 100%;overflow-x: auto;border: 1px solid lightgray;text-align: center;line-height: 40px;" border="1" cellspacing="0">
                ...
                <template v-for="(item,index) in data">
                    <tr>
                        ...
                        <td>
                            <template v-if="data[index].field_2 != null && data[index].field_2 != '' && column_id == ''">
                                <el-input v-model="data[index].field_2" readonly></el-input>
                                
                            </template> 
                            <template v-if="data[index].field_2 == null || data[index].field_2 == '' || column_id != '' ">
                                <el-select v-model="data[index].field_2" placeholder="请选择" @focus="getSelectContent1">
                                        <el-option
                        ...
                        <!-- <td>
                            <el-select v-model="data[index].field_2" placeholder="请选择" @focus="getSelectContent2">
                                <el-option
                        ...
                        <!-- <td>
                            <el-select v-model="data[index].field_2" placeholder="请选择" @focus="getSelectContent3">
                                <el-option

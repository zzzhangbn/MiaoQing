                    ...
                    <el-form :inline="true"  label-width="180px">
                        <el-form-item label="日期" >
                            <el-date-picker
                                    ...
                                    :disabled="totalData.length-index-1 < tab1001CurrentStep "
                                    placeholder="选择日期"
        ...
        methods: {
            ...
            getFormList(e){
                this.$confirm("是否上报？").then(_ => {
                    ...
                    if (this.tab1001DataList.field_12_1 != null) {
                        this.tab1001DataList.field_12_1 = this.tab1001DataList.field_12_1.toString().replace('“', '').replace('”', '');
                    }

        ...
        <el-table :data="data" :header-cell-style="headerStyle">
            ...
            <el-table-column align="center"  width="105%" label="受灾统计表1（万亩）">
                <el-table-column align="center"  label="填报日期" >
                    <template slot-scope="scope">
                        <el-date-picker
                                    ...
                                    v-model="data[fieldRowIndex=scope.$index].field_5_1"
                                    type="date"
                ...
                <el-table-column align="center"  label="生育阶段与灾害症状" >
                    <template slot-scope="scope">
                        <input style="background-color: #fff;border-radius: 4px;border: 1px solid #dcdfe6;width: 100%;box-sizing: border-box;color: #606266;outline: 0;padding: 0 15px;font-size: inherit;height: 40px;line-height: 40px;" class="secondFieldDetail" v-model="data[fieldRowIndex=scope.$index].field_5_2"  />
                    </template>
                </el-table-column>
                <el-table-column align="center"  label="受灾面积" >
                    <template slot-scope="scope">
                        <input style="background-color: #fff;border-radius: 4px;border: 1px solid #dcdfe6;width: 100%;box-sizing: border-box;color: #606266;outline: 0;padding: 0 15px;font-size: inherit;height: 40px;line-height: 40px;" class="secondFieldDetail" v-model="data[fieldRowIndex=scope.$index].field_5_3" @blur.prevent="checkFirstFieldInput($event)" />
                    </template>
                </el-table-column>
                <el-table-column align="center"  label="其中：成灾面积" >
                    <template slot-scope="scope">
                        <input style="background-color: #fff;border-radius: 4px;border: 1px solid #dcdfe6;width: 100%;box-sizing: border-box;color: #606266;outline: 0;padding: 0 15px;font-size: inherit;height: 40px;line-height: 40px;" class="secondFieldDetail" v-model="data[fieldRowIndex=scope.$index].field_5_4" @blur.prevent="checkFirstFieldInput($event)" />
                    </template>
                </el-table-column>
                <el-table-column align="center"  label="其中：绝收面积" >
                    <template slot-scope="scope">
                        <input style="background-color: #fff;border-radius: 4px;border: 1px solid #dcdfe6;width: 100%;box-sizing: border-box;color: #606266;outline: 0;padding: 0 15px;font-size: inherit;height: 40px;line-height: 40px;" class="secondFieldDetail" v-model="data[fieldRowIndex=scope.$index].field_5_5" @blur.prevent="checkFirstFieldInput($event)" />
                    </template>
                </el-table-column>
                <el-table-column align="center"  label="需补改种面积" >
                    <template slot-scope="scope">
                        <input style="background-color: #fff;border-radius: 4px;border: 1px solid #dcdfe6;width: 100%;box-sizing: border-box;color: #606266;outline: 0;padding: 0 15px;font-size: inherit;height: 40px;line-height: 40px;" class="secondFieldDetail" v-model="data[fieldRowIndex=scope.$index].field_5_6" @blur.prevent="checkFirstFieldInput($event)" />
                    </template>
                </el-table-column>
                <el-table-column align="center"  label="已补改种面积" >
                    <template slot-scope="scope">
                        <input style="background-color: #fff;border-radius: 4px;border: 1px solid #dcdfe6;width: 100%;box-sizing: border-box;color: #606266;outline: 0;padding: 0 15px;font-size: inherit;height: 40px;line-height: 40px;" class="secondFieldDetail" v-model="data[fieldRowIndex=scope.$index].field_5_7" @blur.prevent="checkFirstFieldInput($event)" />
                    </template>
                </el-table-column>
            </el-table-column>
            <el-table-column align="center"  width="105%" label="受灾统计表2（万亩）">
                <el-table-column align="center"  label="填报日期" > 
                    <template slot-scope="scope">
                        <el-date-picker
                                    value-format=“yyyy-MM-dd”
                                    v-model="data[fieldRowIndex=scope.$index].field_6_1"
                                    type="date"
                                    placeholder="选择日期" style="width: 100%">
                        </el-date-picker>       
                    </template>
                ...
                <el-table-column align="center"  label="生育阶段与灾害症状" >
                    <template slot-scope="scope">
                        <input style="background-color: #fff;border-radius: 4px;border: 1px solid #dcdfe6;width: 100%;box-sizing: border-box;color: #606266;outline: 0;padding: 0 15px;font-size: inherit;height: 40px;line-height: 40px;" class="secondFieldDetail" v-model="data[fieldRowIndex=scope.$index].field_6_2" @blur.prevent="checkFirstFieldInput($event)" />
                    </template>
                </el-table-column>
                <el-table-column align="center"  label="受灾面积" >
                    <template slot-scope="scope">
                        <input style="background-color: #fff;border-radius: 4px;border: 1px solid #dcdfe6;width: 100%;box-sizing: border-box;color: #606266;outline: 0;padding: 0 15px;font-size: inherit;height: 40px;line-height: 40px;" class="secondFieldDetail" v-model="data[fieldRowIndex=scope.$index].field_6_3" @blur.prevent="checkFirstFieldInput($event)" />
                    </template>
                </el-table-column>
                <el-table-column align="center"  label="其中：成灾面积" >
                    <template slot-scope="scope">
                        <input style="background-color: #fff;border-radius: 4px;border: 1px solid #dcdfe6;width: 100%;box-sizing: border-box;color: #606266;outline: 0;padding: 0 15px;font-size: inherit;height: 40px;line-height: 40px;" class="secondFieldDetail" v-model="data[fieldRowIndex=scope.$index].field_6_4" @blur.prevent="checkFirstFieldInput($event)" />
                    </template>
                </el-table-column>
                <el-table-column align="center"  label="其中：绝收面积" >
                    <template slot-scope="scope">
                        <input style="background-color: #fff;border-radius: 4px;border: 1px solid #dcdfe6;width: 100%;box-sizing: border-box;color: #606266;outline: 0;padding: 0 15px;font-size: inherit;height: 40px;line-height: 40px;" class="secondFieldDetail" v-model="data[fieldRowIndex=scope.$index].field_6_5" @blur.prevent="checkFirstFieldInput($event)" />
                    </template>
                </el-table-column>
                <el-table-column align="center"  label="需补改种面积" >
                    <template slot-scope="scope">
                        <input style="background-color: #fff;border-radius: 4px;border: 1px solid #dcdfe6;width: 100%;box-sizing: border-box;color: #606266;outline: 0;padding: 0 15px;font-size: inherit;height: 40px;line-height: 40px;" class="secondFieldDetail" v-model="data[fieldRowIndex=scope.$index].field_6_6" @blur.prevent="checkFirstFieldInput($event)" /> 
                    </template>
                </el-table-column>
                <el-table-column align="center"  label="已补改种面积" >
                    <template slot-scope="scope">
                        <input style="background-color: #fff;border-radius: 4px;border: 1px solid #dcdfe6;width: 100%;box-sizing: border-box;color: #606266;outline: 0;padding: 0 15px;font-size: inherit;height: 40px;line-height: 40px;" class="secondFieldDetail" v-model="data[fieldRowIndex=scope.$index].field_6_7" @blur.prevent="checkFirstFieldInput($event)" />
                    </template>
                </el-table-column>
            </el-table-column>
            <el-table-column align="center"  width="105%" label="受灾统计表3（万亩）">
                <el-table-column align="center"  label="填报日期" > 
                    <template slot-scope="scope">
                        <el-date-picker
                                value-format=“yyyy-MM-dd”
                                v-model="data[fieldRowIndex=scope.$index].field_7_1"
                                type="date"
                                placeholder="选择日期" style="width: 100%">
                        </el-date-picker> 
                    </template>
                ...
                <el-table-column align="center"  label="生育阶段与灾害症状" >
                    <template slot-scope="scope">
                        <input style="background-color: #fff;border-radius: 4px;border: 1px solid #dcdfe6;width: 100%;box-sizing: border-box;color: #606266;outline: 0;padding: 0 15px;font-size: inherit;height: 40px;line-height: 40px;" class="secondFieldDetail" v-model="data[fieldRowIndex=scope.$index].field_7_2" @blur.prevent="checkFirstFieldInput($event)" />
                    </template>
                </el-table-column>
                <el-table-column align="center"  label="受灾面积" >
                    <template slot-scope="scope">
                ...
                <el-table-column align="center"  label="其中：成灾面积" >
                    <template slot-scope="scope">
                        <input style="background-color: #fff;border-radius: 4px;border: 1px solid #dcdfe6;width: 100%;box-sizing: border-box;color: #606266;outline: 0;padding: 0 15px;font-size: inherit;height: 40px;line-height: 40px;" class="secondFieldDetail" v-model="data[fieldRowIndex=scope.$index].field_7_4" @blur.prevent="checkFirstFieldInput($event)" /> 
                    </template>
                </el-table-column>
                <el-table-column align="center"  label="其中：绝收面积" >
                    <template slot-scope="scope">
                        <input style="background-color: #fff;border-radius: 4px;border: 1px solid #dcdfe6;width: 100%;box-sizing: border-box;color: #606266;outline: 0;padding: 0 15px;font-size: inherit;height: 40px;line-height: 40px;" class="secondFieldDetail" v-model="data[fieldRowIndex=scope.$index].field_7_5" @blur.prevent="checkFirstFieldInput($event)" />
                    </template>
                </el-table-column>
                <el-table-column align="center"  label="需补改种面积" >
                    <template slot-scope="scope">
                        <input style="background-color: #fff;border-radius: 4px;border: 1px solid #dcdfe6;width: 100%;box-sizing: border-box;color: #606266;outline: 0;padding: 0 15px;font-size: inherit;height: 40px;line-height: 40px;" class="secondFieldDetail" v-model="data[fieldRowIndex=scope.$index].field_7_6" @blur.prevent="checkFirstFieldInput($event)" />  
                    </template>
                </el-table-column>
                <el-table-column align="center"  label="已补改种面积" >
                    <template slot-scope="scope">
                        <input style="background-color: #fff;border-radius: 4px;border: 1px solid #dcdfe6;width: 100%;box-sizing: border-box;color: #606266;outline: 0;padding: 0 15px;font-size: inherit;height: 40px;line-height: 40px;" class="secondFieldDetail" v-model="data[fieldRowIndex=scope.$index].field_7_7" @blur.prevent="checkFirstFieldInput($event)" /> 
                    </template>
                </el-table-column>
            </el-table-column>
    ...
    getTemporaryFormList(fieldRowIndex) {
      this.$confirm("是否暂存？")
        .then((_) => {
          ...
          if (this.data[fieldRowIndex].field_5_1 != null) {
            this.data[fieldRowIndex].field_5_1 = this.data[fieldRowIndex].field_5_1
              .toString()
              .replace("“", "")
              .replace("”", "");
          }
          if (this.data[fieldRowIndex].field_6_1 != null) {
            this.data[fieldRowIndex].field_6_1 = this.data[fieldRowIndex].field_6_1
              .toString()
              .replace("“", "")
              .replace("”", "");
          }
          if (this.data[fieldRowIndex].field_7_1 != null) {
            this.data[fieldRowIndex].field_7_1 = this.data[fieldRowIndex].field_7_1
              .toString()
              .replace("“", "")
              .replace("”", "");
          }

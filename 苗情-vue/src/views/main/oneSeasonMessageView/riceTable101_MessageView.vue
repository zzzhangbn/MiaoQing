            ...
            <div class="tableStyle">
              ...
              <el-table :data="tableData.slice((currentPage-1)*pagesize,currentPage*pagesize)" border :header-cell-style="headerStyle" :row-class-name="tableRowClassName" :row-style="{height: '30px'}" :cell-style="{padding:'0',fontSize:'4px'}" row-key="id" stripe>
                <!-- <el-table-column :label="tableLabel" align="center"> -->
                  ...
                  <el-table-column align="center" prop="field_5" width="130%" label="栽植方式" />
                  ...
                  <el-table-column align="center" label="灌浆速率测定2（扬花+7天）">
                    ...
                    <el-table-column align="center" prop="field_7_2" width="100%" label="粒重（克）" />
                  ...
                  <el-table-column align="center" label="灌浆速率测定3（扬花+14天）">
                    ...
                    <el-table-column align="center" prop="field_8_2" width="100%" label="粒重（克）" />
                  ...
                  <el-table-column align="center" label="灌浆速率测定4（扬花+21天）">
                    ...
                    <el-table-column align="center" prop="field_9_2" width="100%" label="粒重（克）" />
                  ...
                  <el-table-column align="center" label="灌浆速率测定5（扬花+28天）">
                    ...
                    <el-table-column align="center" prop="field_10_2" width="100%" label="粒重（克）" />
                  ...
                  <el-table-column align="center" label="灌浆速率测定6（扬花+35天）">
                    ...
                    <el-table-column align="center" prop="field_11_2" width="100%" label="粒重（克）" />
...
export default {
  ...
  data() {
    return {         
      ...
      //表名
      tableLabel:'',
      tableName:'crop_01_01_table_10_01',
      //县的option
      countys:[],
      county: '',
      //地区类型option
  ...
  methods: {
    ...
    this.currentyear = myDate.getFullYear();
      ...
      this.tableLabel= this.years+"年度水稻监测点灌浆速率调查表";
      this.getTableData();

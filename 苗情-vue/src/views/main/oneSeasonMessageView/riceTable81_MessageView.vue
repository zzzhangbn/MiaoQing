            ...
            <div class="tableStyle">
              ...
              <el-table :data="tableData.slice((currentPage-1)*pagesize,currentPage*pagesize)" border :header-cell-style="headerStyle"  :row-style="{height: '30px'}" :cell-style="{padding:'0',fontSize:'4px'}" row-key="id" stripe>
                <!-- <el-table-column :label="tableLabel" align="center"> -->
                  ...
                  <el-table-column align="center" prop="field_6" width="120%" label="代表面积（万亩）" />
                  <el-table-column align="center" prop="field_7"  label="栽植方式" />
                  <el-table-column align="center" prop="field_8" width="120%" label="水稻亩产值（元）" />
                  <el-table-column align="center" prop="field_9" width="180%" label="其中主产品产值（公斤/元）" />
                  <el-table-column align="center" prop="field_10" width="160%" label="副产品产值（公斤/元）" />
                  ...
                  <el-table-column align="center" label="物质费用">
                    <el-table-column align="center" prop="field_12_1" width="110%" label="种子（元/亩）" />
                    <el-table-column align="center" label="化肥">
                      <el-table-column align="center" prop="field_12_2_1" width="110%" label="种类" />
                      <el-table-column align="center" prop="field_12_2_2" width="120%" label="施用量（kg/亩）" />
                      <el-table-column align="center" prop="field_12_2_3" width="110%" label="价格（元/kg）" />
                      <el-table-column align="center" prop="field_12_2_4" width="110%" label="小计（元/亩）" />
                    </el-table-column>
                      ...
                      <el-table-column align="center" prop="field_12_6" width="130%" label="机械耕作（元/亩）" />
                      <el-table-column align="center" prop="field_12_7" width="170%" label="机械插秧/直播（元/亩）" />
                      <el-table-column align="center" prop="field_12_8" width="130%" label="机械收获（元/亩）" />
                      <el-table-column align="center" prop="field_12_9" width="110%" label="其他（元/亩）" />
                      <el-table-column align="center" prop="field_12_10" width="110%" label="小计（元/亩）" />
                  </el-table-column>
                  <el-table-column align="center" prop="field_13" width="110%" label="地租（元/亩）" />
                  <el-table-column align="center" prop="field_14" width="130%" label="其他费用（元/亩）" />
                  <el-table-column align="center" prop="field_15" width="125%" label="亩总成本（元）" />
                  <el-table-column align="center" prop="field_16" width="120%" label="亩收益（元）" />
...
export default {
  ...
  methods: {
    ...
    this.currentyear = myDate.getFullYear();
      ...
      this.tableLabel= this.years+"年度监测县(市、区)水稻生产成本效益统计表";

<template>
    <div style="margin-left: 1%;">
        ...
        <div style="width: 89%;border: #C4C4C4 1.3px solid;margin-top: 30px;">
         ...
         <div style="width: 170px;height: 1.3px;background-color: #C1FFC1;margin-top: -0px;margin-left: 4%;"></div>
          ...
          <div style="margin-left: 1%;margin-top: 15px;margin-bottom: 1%;"><i class="el-icon-s-flag" style="color: #8B2323;"></i><span style="color:#5C5C5C;margin-left: 10px;font-size: 17px;">年度监测县(市、区)水稻苗情评价动态列表(早稻-直播)</span></div>
  ...
  export default{
      ...
      return {
        currentStep:0,//当前进程数
        maxStep:0,//最大进程数
        tab3CurrentStep:0,//表3   3-4当前进程，最大是9
        ...
        handleStep(index){
            ...
            if(index <= this.maxStep){
                ...
                if(this.currentStep <= this.tab3CurrentStep){
                    var gap3 = 5 + index;//表3-4 的进程绑定 OK

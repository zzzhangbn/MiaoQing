            ...
            <div class="tableStyle">
              ...
              <el-table :data="tableData.slice((currentPage-1)*pagesize,currentPage*pagesize)" border :header-cell-style="headerStyle" :row-class-name="tableRowClassName" :row-style="{height: '30px'}" :cell-style="{padding:'0',fontSize:'4px'}" row-key="id" stripe>
                <!-- <el-table-column :label="tableLabel" align="center"> -->
                  ...
                  <el-table-column align="center" label="收获进度4（11月30）">
                  ...
                  <el-table-column align="center" label="单季稻实测产">
                    <el-table-column align="center" prop="field_8_1"  label="面积(万亩）" width="120%"/>
                    <el-table-column align="center" prop="field_8_2"  label="亩有效穗（万）" width="120%"/>
                    <el-table-column align="center" prop="field_8_3"  label="穗总粒数（个）" width="120%"/>
                    <el-table-column align="center" prop="field_8_4"  label="结实率（％）" width="120%"/>
                    <el-table-column align="center" prop="field_8_5"  label="千粒重（g）" width="120%"/>
                    <el-table-column align="center" prop="field_8_6"  label="产量（kg/亩）" width="120%"/>
                  </el-table-column>
                <!-- </el-table-column> -->
              </el-table>

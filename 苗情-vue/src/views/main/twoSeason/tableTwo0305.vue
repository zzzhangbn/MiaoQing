       ...
       <router-link :to="{name:'/tableTwoMain',params: {activeNum: 2}}">
        ...
        <div id="containner_div" style="width: 100%;height: 70%;">
            <table style="width: 100%;border: 1px solid lightgray;text-align: center;line-height: 40px;" border="1" cellspacing="0">
                <tr >
                    <td colspan="59" style="background-color: #6E8B3D;color: #FFFFFF;">年度监测县(市、区)水稻苗情评价动态列表（晚稻）-（移栽）</td>
                </tr>
            ...
            <table style="width: 100%;border: 1px solid lightgray;text-align: center;line-height: 40px;" border="1" cellspacing="0">
                <template v-for="(item,index) in data">
                    ...
                    <tr>
                        <template v-if="data[index].field_4_1 == '' || data[index].field_4_1 == null ||data[index].field_4_2_1 =='' || data[index].field_4_2_1 == null 
                        || data[index].field_4_2_2 == '' || data[index].field_4_2_2 == null || data[index].field_4_3_1 == '' || data[index].field_4_3_1 == null || data[index].field_4_3_2 == null || data[index].field_4_3_2 == ''
                        || data[index].field_4_4_1 == '' || data[index].field_4_4_1 == null || data[index].field_4_4_2 == null || data[index].field_4_4_2 == ''">
                        ...
                        <template v-if="data[index].field_5_1 == null || data[index].field_5_1 == '' || data[index].field_5_2_1 == '' || data[index].field_5_2_1 == null || data[index].field_5_2_2 == null || data[index].field_5_2_2 == ''
                        || data[index].field_5_3_1 == null || data[index].field_5_3_1 == '' || data[index].field_5_3_2 == '' || data[index].field_5_3_2 == null || data[index].field_5_4_1 == null || data[index].field_5_4_1 == ''
                        || data[index].field_5_4_2 == null || data[index].field_5_4_1 == ''">
                    ...
                    <template v-if="fold5 == true">
                        ...
                        <tr> 
                            <td>
                                <el-date-picker
                                    v-model="data[index].field_8_1" :disabled="copyData[index].field_7_1 !=='' && copyData[index].field_7_1 !== null && column_id == ''"
                                    type="date"
                                    placeholder="选择日期">
                                    </el-date-picker>
                            </td>
        ...
        methods:{
            ...
            getUserAllData0302(people,column_id){
                ...
                axios({
                    ...
                    return this.$message.error("获取表3-5内容失败！");
                });
            },
            //生成保存函数
            saveInputData(list){
              axios({
                url:'/getSituationInputDataTableTwo0305',
                method:'post',
                params:{
                  data:list
                }
            ...
            //     axios({
            //         url:'/getMonitorCardContentIntoTwo0305',
            //         method:'post',
            //         params:{
            //             people:people
            //         }

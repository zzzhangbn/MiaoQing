                    ...
                    <tr>
                        ...
                        <td style="width: 20%">
                            <template v-if=" data[fieldRowIndex].field_7_2!='' && data[fieldRowIndex].field_7_3!='' && data[fieldRowIndex].field_7_4!='' && data[fieldRowIndex].field_7_5!='' ">
                                <span class="span">{{Number(data[fieldRowIndex].field_7_2) * Number(data[fieldRowIndex].field_7_3) * Number(data[fieldRowIndex].field_7_4) * Number(data[fieldRowIndex].field_7_5) * 0.000001}}</span>
                            </template>
                            <template v-if=" data[fieldRowIndex].field_7_2=='' || data[fieldRowIndex].field_7_3=='' || data[fieldRowIndex].field_7_4=='' || data[fieldRowIndex].field_7_5=='' ">
                                <span style="text-align: center;display:block;">暂无</span>
                            </template>

<template>
    <div class="totalRange">
      <!-- <el-tabs v-model="activeName"> -->
        <!-- <el-tab-pane label="移栽稻进程1-2" name="1"> -->
            ...
            <div class="tableStyle">
              ...
              <el-table :data="tableData.slice((currentPage-1)*pagesize,currentPage*pagesize)" border :header-cell-style="headerStyle" :row-class-name="tableRowClassName" :row-style="{height: '30px'}" :cell-style="{padding:'0',fontSize:'4px'}" row-key="id" stripe>
                <!-- <el-table-column :label="tableLabel" align="center"> -->
                  ...
                  <el-table-column align="center" prop="field_3"  label="全县总面积（万亩）" />
                  <el-table-column align="center" label="进程1（移栽后7天）">
                    <el-table-column align="center" prop="field_4_1"  label="日期" :formatter="dateFormat"/>
                  ...
                  <el-table-column align="center" label="进程6（移栽后32天）">
                  ...
                  <el-table-column align="center" label="进程7（移栽后42天）">
...
export default {
  ...
  data() {
    return {       
      ...
      tableData: [],
      //表名
      tableLabel:'监测县(市、区)水稻苗情评价动态列表（晚稻）-（移栽）',
      tableName:'crop_01_02_table_03_05',
      //分页
      pagesize:15,  //每页的数据条数

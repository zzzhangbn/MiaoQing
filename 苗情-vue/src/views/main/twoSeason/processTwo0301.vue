<template>
    <div style="margin-left: 1%;">
        <div style="width: 98%;height: 50px;">
            <span style="font-size: 20px;color: rgb(0, 102, 102);margin-right: 48%;">年度监测县(市、区)水稻播栽进度调查表（早稻）</span>
        </div>
                    ...
                    <!-- <template v-if="index != 3"> -->
                        <el-form :inline="true"  label-width="180px">
                            <template v-if="tableList.length-index-1 == 0">
                                <el-form-item label="全县总面积(万亩)">
                                    <el-input v-model="tab1DataList.field_4" 
                                    :disabled="copyData.field_4 != null && copyData.field_4 !=''" style="width: 207px;" @blur="changeAllArea" placeholder="请输入数字（小数点后四位）"   oninput="value=value.replace(/[^\d.]/g, '').replace(/\.{2,}/g, '.').replace('.', '$#$').
                                ...
                                <el-form-item label="稻作类型">
                                    ...
                                    <template v-if="copyData.field_3 != null && copyData.field_3 != '' && column_id == ''">
                                        <el-input v-model="tab1DataList.field_3" readonly></el-input>
                                      </template> 
                                      <template v-if="copyData.field_3 == null || copyData.field_3 == '' || column_id != '' ">
                                          <el-select v-model="tab1DataList.field_3" placeholder="请选择" @focus="brandKeyChange1">
                                                <el-option
                                ...
                                <el-form-item label="播种日期-育秧">
                                    <el-date-picker
                                        v-model="tab1DataList.field_5_1"
                                        align="right"
                                        :disabled="copyData.field_5_1 != null && copyData.field_5_1 !=''"
                                ...
                                <el-form-item label="播种日期-直播">
                                    <el-date-picker
                                        v-model="tab1DataList.field_5_2"
                                        align="right" 
                                        :disabled="copyData.field_5_2 != null && copyData.field_5_2 !=''"
                                        type="date" style="width: 207px;" 
                                        placeholder="选择日期">
                                    </el-date-picker>
                                </el-form-item>
                                <el-form-item label="秧田面积（万亩）">
                                    <el-input v-model="tab1DataList.field_6" style="width: 207px;"
                                    :disabled="copyData.field_6 != null && copyData.field_6 !=''" placeholder="请输入数字（小数点后四位）"   oninput="value=value.replace(/[^\d.]/g, '').replace(/\.{2,}/g, '.').replace('.', '$#$').
                                    replace(/\./g, '').replace('$#$', '.').replace(/^(\-)*(\d+)\.(\d\d\d\d).*$/, '$1$2.$3').replace(/^\./g, '')"></el-input>
                                </el-form-item>
                                <el-form-item width="260" label="其中（秧田面积）集中育秧">
                                    ...
                                    @blur.prevent="checkFirstFieldInput($event,'field_7_1','field_7_2','1')" placeholder="请输入数字（小数点后四位）"   oninput="value=value.replace(/[^\d.]/g, '').replace(/\.{2,}/g, '.').replace('.', '$#$').
                                    replace(/\./g, '').replace('$#$', '.').replace(/^(\-)*(\d+)\.(\d\d\d\d).*$/, '$1$2.$3').replace(/^\./g, '')"></el-input>
                                </el-form-item>
                                ...
                                <el-form-item label="折合大田面积（万亩）">
                                    ...
                                    @blur.prevent="checkFirstFieldInput($event,'field_8_1','field_8_2','0')" placeholder="请输入数字（小数点后四位）"   oninput="value=value.replace(/[^\d.]/g, '').replace(/\.{2,}/g, '.').replace('.', '$#$').
                                    replace(/\./g, '').replace('$#$', '.').replace(/^(\-)*(\d+)\.(\d\d\d\d).*$/, '$1$2.$3').replace(/^\./g, '')"></el-input>
                                </el-form-item>
                                ...
                                <el-form-item label="其中（折合大田面积）集中育秧">
                                    <el-input v-model="tab1DataList.field_9_1" 
                                    :disabled="copyData.field_9_1 != null && copyData.field_9_1 !=''" style="width: 207px;"
                                    @blur.prevent="checkFirstFieldInput($event,'field_9_1','field_9_2','0')" placeholder="请输入数字（小数点后四位）"   oninput="value=value.replace(/[^\d.]/g, '').replace(/\.{2,}/g, '.').replace('.', '$#$').
                                    replace(/\./g, '').replace('$#$', '.').replace(/^(\-)*(\d+)\.(\d\d\d\d).*$/, '$1$2.$3').replace(/^\./g, '')"></el-input>
                                </el-form-item>
                                <el-form-item  label="其中（折合大田面积）集中育秧/总面积">
                                    <el-input v-model="tab1DataList.field_9_2" disabled style="width: 207px;"></el-input>
                                </el-form-item>
                            </template>
                        <template v-if="tableList.length-index-1 < 4 && tableList.length-index-1 > 0">
                            ...
                            <el-form-item label="育秧已播种面积（万亩）">
                                    ...
                                    :disabled="copyData[item.field21] != null && copyData[item.field21] !=''" placeholder="请输入数字（小数点后四位）"   oninput="value=value.replace(/[^\d.]/g, '').replace(/\.{2,}/g, '.').replace('.', '$#$').
                                    replace(/\./g, '').replace('$#$', '.').replace(/^(\-)*(\d+)\.(\d\d\d\d).*$/, '$1$2.$3').replace(/^\./g, '')"></el-input>
                            ...
                            <el-form-item label="已栽插面积（万亩）">
                                    ...
                                    :disabled="copyData[item.field3] != null && copyData[item.field3] !=''" placeholder="请输入数字（小数点后四位）"   oninput="value=value.replace(/[^\d.]/g, '').replace(/\.{2,}/g, '.').replace('.', '$#$').
                                    replace(/\./g, '').replace('$#$', '.').replace(/^(\-)*(\d+)\.(\d\d\d\d).*$/, '$1$2.$3').replace(/^\./g, '')"></el-input>
                        ...
                        <template v-if="tableList.length-index-1 == 4">
                            <el-form-item label="日期" >
                                <el-date-picker
                                    v-model="tab1DataList.field_13_1"
                                    align="right" 
                                    :picker-options="pickerOptions"
                                    :disabled="copyData.field_13_1 != null && copyData.field_13_1 !=''"
                                    type="date" style="width: 207px;"
                                    placeholder="选择日期">
                                </el-date-picker>
                            </el-form-item>
                            <el-form-item label="已栽插面积（万亩）">
                                <el-input style="width: 207px;" v-model="tab1DataList.field_13_2" @blur.prevent="getSumArea('field_13_2','field_13_3','field_13_4','field_13_5')" 
                                :disabled="copyData.field_13_2 != null && copyData.field_13_2 !=''" placeholder="请输入数字（小数点后四位）"   oninput="value=value.replace(/[^\d.]/g, '').replace(/\.{2,}/g, '.').replace('.', '$#$').
                                replace(/\./g, '').replace('$#$', '.').replace(/^(\-)*(\d+)\.(\d\d\d\d).*$/, '$1$2.$3').replace(/^\./g, '')"></el-input>
                            </el-form-item>
                            <el-form-item label="直播已播种面积（万亩）">
                                    <el-input style="width: 207px;" v-model="tab1DataList.field_13_3" @blur.prevent="getSumArea('field_13_2','field_13_3','field_13_4','field_13_5')" 
                                    :disabled="copyData.field_13_3 != null && copyData.field_13_3 !=''" placeholder="请输入数字（小数点后四位）"   oninput="value=value.replace(/[^\d.]/g, '').replace(/\.{2,}/g, '.').replace('.', '$#$').
                                    replace(/\./g, '').replace('$#$', '.').replace(/^(\-)*(\d+)\.(\d\d\d\d).*$/, '$1$2.$3').replace(/^\./g, '')"></el-input>
                            </el-form-item>
                            <el-form-item label="移栽+直播">
                                <el-input style="width: 207px;" v-model="tab1DataList.field_13_4" disabled></el-input>
                            </el-form-item>
                            <el-form-item label="（移栽+直播）/总面积">
                                <el-input style="width: 207px;" v-model="tab1DataList.field_13_5" disabled></el-input>
                            </el-form-item>
                        </template>    
                        </el-form>
                    <!-- </template> -->
  ...
  export default{
    inject: ['reload'],
      ...
      pickerOptions: {
          ...
          daoZuoTypeData:[],//稻作类型
        // 步骤标题
      stepTitle: ['进度准备','播栽期进度1（3月20日）', '播栽期进度2（3月31日）', '播栽期进度3（4月15日）', '播栽期进度4（4月25日）'],
      };
    },
    methods: {
        //改变全县总面积
        changeAllArea(){
            this.tab1DataList.field_6 = '' 
            this.tab1DataList.field_7_1 = '' 
            this.tab1DataList.field_7_2 = ''
            this.tab1DataList.field_8_1 = '' 
            this.tab1DataList.field_8_2 = ''
            this.tab1DataList.field_9_1 = ''
            this.tab1DataList.field_9_2 = ''
        },
        //获取稻作类型数据
        ...
        checkFirstFieldInput(e,field1,field2,flag){
          ...
          if(!isNaN(strValue)){ 
              if(this.tab1DataList[field1] != null && this.tab1DataList[field1] != ''){
                  if(flag == '0'){//计算总面积占比
                    this.tab1DataList[field2] =(Math.round((this.tab1DataList[field1]/this.tab1DataList.field_4) * 100*100)/100).toFixed(2) +'%';
                  }
                  if(flag == '1'){//计算秧田面积
                    this.tab1DataList[field2] =(Math.round((this.tab1DataList[field1]/this.tab1DataList.field_6) * 100*100)/100).toFixed(2)+'%';
                  }
              }
        }else{
...
　　        var date = this.getNowTime();
            ...
            var start = 9+this.tab1CurrentStep;
            ...
            if(this.tab1CurrentStep == 0){
                if(this.tab1DataList.field_4!='' && this.tab1DataList.field_4!=null && this.tab1DataList.field_5_1 != null && this.tab1DataList.field_5_1 != '' 
                && this.tab1DataList.field_5_2 != ''&& this.tab1DataList.field_5_2 != null && this.tab1DataList.field_6 != '' && this.tab1DataList.field_6 != null 
                && this.tab1DataList.field_7_1 != '' && this.tab1DataList.field_7_1 != null && this.tab1DataList.field_7_2 != '' && this.tab1DataList.field_7_2 != null&&this.tab1DataList.field_8_1 != ''
                &&this.tab1DataList.field_8_1 != null && this.tab1DataList.field_8_2 != ''&& this.tab1DataList.field_8_2 != null
                && this.tab1DataList.field_9_1 != ''&& this.tab1DataList.field_9_1 != null && this.tab1DataList.field_9_2 != ''&& this.tab1DataList.field_9_2 != null){
                    this.saveInputData(Mstr);
                }else{
                    console.log(this.tab1DataList);
                    console.log(str+"::::"+str1+"::::"+str2+"::::"+str3+"::::"+str4+"::::"+str5+"::::"+str6);
        ...
        saveInputData(list){
            axios({
            url:'/getSituationInputDataTableTwo5',
            method:'post',
            params:{
                data:list
            }
        ...
        getSumArea(field1,field2,field3,field4){
            ...
            if(!isNaN(strValue1)&& !isNaN(strValue2)){
                this.tab1DataList[field3] = parseFloat(this.add(Number(this.tab1DataList[field1])+Number(this.tab1DataList[field2])));
                this.tab1DataList[field4] = (Math.round((this.tab1DataList[field3]/this.tab1DataList.field_4) * 100*100)/100).toFixed(2) +'%';
                if(this.tab1DataList[field3] == 0){
                    this.tab1DataList[field3] = "0.00"
                }
            }else{
                this.tab1DataList[field1] = "";
                this.tab1DataList[field2] = "";
        ...
        axios({
            ...
            res=>{
                ...
                if(res.data.length > 0){
                    ...
                    if(this.tab1DataList.field_4 != null && this.tab1DataList.field_4 != ''){
                    ...
                    if(this.tab1DataList.field_13_1 != null && this.tab1DataList.field_13_1 != ""){

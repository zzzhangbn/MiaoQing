        ...
        <div class ="table-s" id="containner_div" style="width: 100%;height: 70%;">
            ...
            <table  id="sum_tab"  style="width: 100%;overflow-x: auto;border: 1px solid lightgray;text-align: center;line-height: 40px;" border="1" cellspacing="0">
                <tr style="background-color: #6E8B3D;color:white;">
                    <td colspan="14">监测县(市、区)水稻单季稻测产表</td>
                </tr>
        ...
        <el-dialog :title="tableFlag" :visible.sync="detialDialogVisible" width="50%" :before-close="handleClose">
            <table style="width: 90%;border: 1px solid lightgray;line-height: 40px;" border="1" cellspacing="0">
                <template v-if="tableFlag == '全县面上平均水平'">
                    ...
                    <tr>
                        <td style="width: 17%;">
                            <input style="background-color: #fff;border-radius: 4px;border: 1px solid #dcdfe6;width: 100%;box-sizing: border-box;color: #606266;outline: 0;padding: 0 15px;font-size: inherit;height: 40px;line-height: 40px;" class="secondFieldDetail" v-model="data.field_3_1" @blur.prevent="checkFirstFieldInput($event)" />
                        </td>
                        <td style="width: 17%;">
                            <input style="background-color: #fff;border-radius: 4px;border: 1px solid #dcdfe6;width: 100%;box-sizing: border-box;color: #606266;outline: 0;padding: 0 15px;font-size: inherit;height: 40px;line-height: 40px;" class="secondFieldDetail" v-model="data.field_3_2" @blur.prevent="checkFirstFieldInput($event)" />
                        </td>
                        <td style="width: 17%;">
                            <input style="background-color: #fff;border-radius: 4px;border: 1px solid #dcdfe6;width: 100%;box-sizing: border-box;color: #606266;outline: 0;padding: 0 15px;font-size: inherit;height: 40px;line-height: 40px;" class="secondFieldDetail" v-model="data.field_3_3" @blur.prevent="checkFirstFieldInput($event)" />
                        </td>
                        <td style="width: 17%;">
                            <input style="background-color: #fff;border-radius: 4px;border: 1px solid #dcdfe6;width: 100%;box-sizing: border-box;color: #606266;outline: 0;padding: 0 15px;font-size: inherit;height: 40px;line-height: 40px;" class="secondFieldDetail" v-model="data.field_3_4" @blur.prevent="checkFirstFieldInput($event)" />
                        </td>
                        <td style="width: 17%;">
                            <input style="background-color: #fff;border-radius: 4px;border: 1px solid #dcdfe6;width: 100%;box-sizing: border-box;color: #606266;outline: 0;padding: 0 15px;font-size: inherit;height: 40px;line-height: 40px;" class="secondFieldDetail" v-model="data.field_3_5" @blur.prevent="checkFirstFieldInput($event)" />
                        </td>
                        <td style="width: 15%">
                            <template v-if=" data.field_3_2!='' && data.field_3_3!='' && data.field_3_4!='' && data.field_3_5!=''
                             && data.field_3_2!=null && data.field_3_3!=null && data.field_3_4!=null && data.field_3_5!=null">
                                <span class="span">{{(Number(data.field_3_2) * Number(data.field_3_3) * Number(data.field_3_4) * Number(data.field_3_5) /1000000).toFixed(4)}}</span>
                            </template>
                            <template v-if=" data.field_3_2=='' || data.field_3_3=='' || data.field_3_4=='' || data.field_3_5==''
                              || data.field_3_2==null || data.field_3_3==null || data.field_3_4==null || data.field_3_5==null">
                        ...
                        <td style="width: 15%">
                            <template v-if=" data.field_4_2!='' && data.field_4_3!='' && data.field_4_4!='' && data.field_4_5!=''
                             && data.field_4_2!=null && data.field_4_3!=null && data.field_4_4!=null && data.field_4_5!=null">
                                <span class="span">{{Number(data.field_4_2) * Number(data.field_4_3) * Number(data.field_4_4) * Number(data.field_4_5)  /1000000}}</span>
                            </template>
                            <template v-if=" data.field_4_2=='' || data.field_4_3=='' || data.field_4_4=='' || data.field_4_5==''
                             || data.field_4_2==null || data.field_4_3==null || data.field_4_4==null || data.field_4_5==null">
                                <span style="text-align: center;display:block;">暂无</span>
                        ...
                        <td style="width: 15%">
                            <template v-if=" data.field_5_2!='' && data.field_5_3!='' && data.field_5_4!='' && data.field_5_5!='' &&
                             data.field_5_2!=null && data.field_5_3!=null && data.field_5_4!=null && data.field_5_5!=null">
                                <span class="span">{{Number(data.field_5_2) * Number(data.field_5_3) * Number(data.field_5_4) * Number(data.field_5_5)  /1000000}}</span>
                            </template>
                            <template v-if=" data.field_5_2=='' || data.field_5_3=='' || data.field_5_4=='' || data.field_5_5=='' ||
                                data.field_5_2==null || data.field_5_3==null || data.field_5_4==null || data.field_5_5==null">
                                <span style="text-align: center;display:block;">暂无</span>
                        ...
                        <td style="width: 15%">
                            <template v-if=" data.field_6_2!='' && data.field_6_3!='' && data.field_6_4!='' && data.field_6_5!='' &&
                             data.field_6_2!=null && data.field_6_3!=null && data.field_6_4!=null && data.field_6_5!=null">
                                <span class="span">{{Number(data.field_6_2) * Number(data.field_6_3) * Number(data.field_6_4) * Number(data.field_6_5)  /1000000}}</span>
                            </template>
                            <template v-if=" data.field_6_2=='' || data.field_6_3=='' || data.field_6_4=='' || data.field_6_5=='' ||
                             data.field_6_2==null || data.field_6_3==null || data.field_6_4==null || data.field_6_5==null">
                                <span style="text-align: center;display:block;">暂无</span>
                        ...
                        <td style="width: 15%">
                            <template v-if=" data.field_7_2!='' && data.field_7_3!='' && data.field_7_4!='' && data.field_7_5!='' &&
                             data.field_7_2!=null && data.field_7_3!=null && data.field_7_4!=null && data.field_7_5!=null">
                                <span class="span">{{Number(data.field_7_2) * Number(data.field_7_3) * Number(data.field_7_4) * Number(data.field_7_5)  /1000000}}</span>
                            </template>
                            <template v-if=" data.field_7_2=='' || data.field_7_3=='' || data.field_7_4=='' || data.field_7_5=='' ||
                             data.field_7_2==null || data.field_7_3==null || data.field_7_4==null || data.field_7_5==null">
                                <span style="text-align: center;display:block;">暂无</span>
                        ...
                        <td style="width: 15%">
                            <template v-if=" data.field_8_2!='' && data.field_8_3!='' && data.field_8_4!='' && data.field_8_5!='' &&
                             data.field_8_2!=null && data.field_8_3!=null && data.field_8_4!=null && data.field_8_5!=null ">
                                <span class="span">{{Number(data.field_8_2) * Number(data.field_8_3) * Number(data.field_8_4) * Number(data.field_8_5)  /1000000}}</span>
                            </template>
                            <template v-if=" data.field_8_2=='' || data.field_8_3=='' || data.field_8_4=='' || data.field_8_5==''||
                             data.field_8_2==null || data.field_8_3==null || data.field_8_4==null || data.field_8_5==null">
                                <span style="text-align: center;display:block;">暂无</span>
                        ...
                        <td style="width: 15%">
                            <template v-if=" data.field_9_2!='' && data.field_9_3!='' && data.field_9_4!='' && data.field_9_5!='' &&
                              data.field_9_2!=null && data.field_9_3!=null && data.field_9_4!=null && data.field_9_5!=null">
                                <span class="span">{{Number(data.field_9_2) * Number(data.field_9_3) * Number(data.field_9_4) * Number(data.field_9_5)  /1000000}}</span>
                            </template>
                            <template v-if=" data.field_9_2=='' || data.field_9_3=='' || data.field_9_4=='' || data.field_9_5==''||
                             data.field_9_2==null || data.field_9_3==null || data.field_9_4==null || data.field_9_5==null">
                                <span style="text-align: center;display:block;">暂无</span>
        ...
        methods:{
            ...
            cancelOp(){
                ...
                if(this.tableFlag == '全县面上平均水平'){
                    ...
                    //console.log(this.data.field_3_6);
                    //console.log(spans);
                    if(this.data.field_3_6 == null){
                        this.data.field_3_6 = spans[0].innerHTML;
                    }
                    //console.log(this.data.field_3_6);
                }

                ...
                <template v-for="(item,index) in data">
                    <tr>
                        ...
                        <td style="width: 7.8%;">
                            ...
                            <!-- <el-select v-model="data[index].field_4" placeholder="请选择" @focus="brandKeyChange1" :disabled="data[index].field_4 != '' && data[index].field_4 != null">
                                <el-option
                        ...
                        <td style="width: 7.8%;">
                            ...
                            <!-- <el-select v-model="data[index].field_5" placeholder="请选择" @focus="brandKeyChange2" :disabled="data[index].field_5 != '' && data[index].field_5 != null">
                                <el-option
                        ...
                        <td style="width: 7.8%;">
                            ...
                            <!-- <el-select v-model="data[index].field_7" placeholder="请选择" @focus="brandKeyChange3" :disabled="data[index].field_7 != '' && data[index].field_7 != null">
                                <el-option
                    ...
                    <template v-for="(item,index) in data">
                        <tr>
                            ...
                            <td style="width: 5%;">
                                ...
                                :disabled="copyData[index].field_10 != '' && copyData[index].field_10 != null && column_id == '' || copyData[index].field_7 == '撒直播（水）' && column_id == '' || copyData[index].field_7 == '撒直播（旱）'"
                                type="date"
                                placeholder="选择日期">
                                </el-date-picker>
                            </td>
                            ...
                            <td style="width: 5%;">
                                <!-- <el-date-picker
                                v-model="data[index].field_18" :disabled="data[index].field_18 != '' && data[index].field_18 != null && column_id == ''"
                                type="date"
                                placeholder="选择日期">
                                </el-date-picker> -->

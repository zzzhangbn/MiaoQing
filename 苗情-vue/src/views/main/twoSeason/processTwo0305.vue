<template>
    <div style="margin-left: 1%;">
        <div style="width: 98%;height: 50px;">
            <span style="font-size: 20px;color: rgb(0, 102, 102);margin-right: 48%;">年度监测县(市、区)水稻苗情评价动态列表（晚稻）-（移栽稻）</span>
      ...
      getTab2CurrentStep(people){
        axios({
            ...
            res=>{
                ...
                if(this.tab2DataList.field_10_4_1 != null && this.tab2DataList.field_10_4_1 != ""){

    ...
    <div class="demo-image__placeholder">
        ...
        <div class ="table-s" id="containner_div" style="width: 100%;height: 70%;">
            ...
            <table  id="sum_tab"  style="width: 100%;overflow-x: auto;border: 1px solid lightgray;text-align: center;line-height: 40px;" border="1" cellspacing="0">
                <tr style="background-color: #6E8B3D;color:white;">
                    <td colspan="14" style="background-color: #6E8B3D;color: #FFFFFF;">水稻监测点洪涝灾害表</td>
                </tr>
                <tr style="background-color: #CDBE70;color: green;">
                    <td style="width: 8%;" >县（市、区）</td>
                    <td style="width: 8%;">监测田块</td>
                    <td style="width: 8%;">地区类型</td>
                    <td style="width: 8%;">品种名称</td>
                    <td style="width: 8%;">栽植方式</td>
                    <td style="width: 8%;">淹水日期</td>
                    <td style="width: 8%;">退水日期</td>
                    <td style="width: 8%;">生育阶段</td>
                    <td style="width: 8%;">面积（亩）</td>
                    <td style="width: 8%;">淹水高度（露叶尖、没顶）</td>
                    <td style="width: 8%;">淹水天数</td>
                    <td style="width: 8%;">程度</td>
                </tr>
        ...
        <el-dialog :title="tableFlag" :visible.sync="detialDialogVisible" width="80%" :before-close="handleClose" >
            <table style="width: 90%;border: 1px solid lightgray;line-height: 40px;" border="1" cellspacing="0">
                <template v-if="tableFlag == '淹水天数'">
                    <tr style="background-color: #CDBE70;color: green;">
                        <td style="width: 25%">其中露叶尖</td>
                        <td style="width: 25%">其中没顶</td>
                    </tr>
                    <tr>
        ...
        <el-button @click="cancelOp">确定</el-button>
        ...
        methods:{
            ...
            getFormList(flag){
                ...
                for(var i = 0 ;i < this.data.length ; ++i){
                    ...
                    if(this.data[i].field_6 != null){
                        this.data[i].field_6 = this.data[i].field_6.replace('“','').replace('”','')
                    }
                    if(this.data[i].field_7 != null){
                        this.data[i].field_7 = this.data[i].field_7.replace('“','').replace('”','')
                    }

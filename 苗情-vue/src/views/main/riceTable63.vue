<template>
    ...
    <div class="totalRange">
      <el-tabs v-model="activeName">
        <!-- <el-tab-pane label="病虫害防治1-2" name="1"> -->
              ...
              <el-table :data="tableData.slice((currentPage-1)*pagesize,currentPage*pagesize)" border :header-cell-style="headerStyle" :row-class-name="tableRowClassName" :row-style="{height: '30px'}" :cell-style="{padding:'0',fontSize:'4px'}" row-key="id" stripe>
                <!-- <el-table-column :label="tableLabel" align="center"> -->
                  ...
                  <el-table-column align="center" label="病虫害防治1">
                    <el-table-column align="center" prop="field_7_1"  label="病虫害种类" />
                    <el-table-column align="center" prop="field_7_2"  label="使用时间" />
                    <el-table-column align="center" prop="field_7_3"  label="用药种类" />
                    <el-table-column align="center" prop="field_7_4"  label="用药量(ml/亩)" />
                  ...
                  <el-table-column align="center" label="病虫害防治2">
                    <el-table-column align="center" prop="field_8_1"  label="病虫害种类" />
                    <el-table-column align="center" prop="field_8_2"  label="使用时间" />
                    <el-table-column align="center" prop="field_8_3"  label="用药种类" />
                    <el-table-column align="center" prop="field_8_4"  label="用药量(ml/亩)" />
                  ...
                  <el-table-column align="center" label="病虫害防治3">
                    <el-table-column align="center" prop="field_9_1"  label="病虫害种类" />
                    <el-table-column align="center" prop="field_9_2"  label="使用时间" />
                    <el-table-column align="center" prop="field_9_3"  label="用药种类" />
                    <el-table-column align="center" prop="field_9_4"  label="用药量(ml/亩)" />
                  ...
                  <el-table-column align="center" label="病虫害防治4">
                    <el-table-column align="center" prop="field_10_1"  label="病虫害种类" />
                    <el-table-column align="center" prop="field_10_2"  label="使用时间" />
                    <el-table-column align="center" prop="field_10_3"  label="用药种类" />
                    <el-table-column align="center" prop="field_10_4"  label="用药量(ml/亩)" />
                  ...
                  <el-table-column align="center" label="病虫害防治5">
                    <el-table-column align="center" prop="field_11_1"  label="病虫害种类" />
                    <el-table-column align="center" prop="field_11_2"  label="使用时间" />
                    <el-table-column align="center" prop="field_11_3"  label="用药种类" />
                    <el-table-column align="center" prop="field_11_4"  label="用药量(ml/亩)" />
        ...
        <!-- </el-tab-pane> -->
        <!-- <el-tab-pane label="病虫害防治3-4" name="2"> -->
          
        <!-- </el-tab-pane> -->

        <!-- <el-tab-pane label="病虫害防治5" name="3"> -->
...
export default {
  ...
  data() {
    return {         
      ...
      tableData: [],
      //表名
      tableLabel:'水稻监测点病虫害防治记录表',
      tableName:'crop_01_01_table_06_03',
      //暂存退回记录
      rowRecord:[],
      //分页
      pagesize:15,  //每页的数据条数
  ...
  if(this.startYear != '' && this.endYear != ''){
    ...
    handleClick(tab,event){
      ...
      // }
      // this.getTableData(people,this.point,this.startYear,this.endYear);
    }, 
    //表头跨列隐藏
      ...
      axios({
        ...
        params:{
          ...
          //console.log(this.temSeries);
              ...
              this.option.xAxis =  {
              type: 'category',
              data: ['病虫害防治1', '病虫害防治2', '病虫害防治3','病虫害防治4','病虫害防治5'],
              axisLabel:{interval:0}};
              this.option.yAxis = {type: 'value',name:'用药量(ml/亩)'};

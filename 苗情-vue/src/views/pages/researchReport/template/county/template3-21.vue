      ...
      <div class="content" ref="content">
        ...
        <div>
          ...
          <p style="font-size: 20px;line-height: 30px;">
            &nbsp;&nbsp;全县（市、区）一季稻面积<input v-model="inputValues[0]" type="text" ref="input1" style="width:40px;border: none;border-bottom: 1px solid #000;font-size: 20px;outline: none;">万亩，
          ...
          <p style="font-size: 20px;line-height: 30px;">
            &nbsp;&nbsp;8月上旬抽穗扬花的中籼稻，全县（市、区）约 <u>{{reportData.data_4.area}}</u> 万亩，占 <u>{{reportData.data_4.percent}} </u>%，据初步调查，结实率 <u>{{reportData.data_4.jsl}}</u> %。
  ...
  methods:{
    getData(){
      ...
      axios({
        url:'/template1',
        method:'get',
        params:{templateName:'一季稻抽穗期苗情-2',country:area}
      }).then(res=>{

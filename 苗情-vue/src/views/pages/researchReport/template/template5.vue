    ...
    <el-card style="margin:20px 0 0 0;cursor:pointer;">
      <div class="content" ref="content">
        ...
        <div>
          ...
          <h3>2．平均单产水平</h3>
          <p>
            &nbsp;&nbsp;根据30个监测县监测点测产，平均亩有效穗 <u>{{reportData.data_2[0]}}</u>万，
            ...
            按面积加权，平均亩产<u>{{reportData.data_2[4]}}</u>公斤/亩，与去年同期 <u>{{reportData.data_3[5]}}</u>公斤/亩基本持平。
          </p>
        </div>
        <div>
          <h2>二、生长形势分析</h2>

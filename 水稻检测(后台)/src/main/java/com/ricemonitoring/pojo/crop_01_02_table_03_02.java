...
@AllArgsConstructor
@NoArgsConstructor
    public class crop_01_02_table_03_02{
     ...
     */
      ...
      /**
     * 播栽期进度1（7月15日）-育秧已播种面积（万亩）-数据1
     */
      private String field_10_2_1;

      /**
     * 播栽期进度1（7月15日）-育秧已播种面积（万亩）-占比
     */
      private String field_10_2_2;

      /**
     * 播栽期进度1（7月15日）-已栽插面积（万亩）
     */
      private String field_10_3;

      /**
     * 播栽期进度1（7月15日）-直播已播种面积（万亩）
     */
     ...
     */
      ...
      /**
     * 播栽期进度2（7月25日）-育秧已播种面积（万亩）-数据1
     */
      private String field_11_2_1;

      /**
     * 播栽期进度2（7月25日）-育秧已播种面积（万亩）-占比
     */
      private String field_11_2_2;

      /**
     * 播栽期进度2（7月25日）-已栽插面积（万亩）
     */
      private String field_11_3;

      /**
     * 播栽期进度2（7月25日）-直播已播种面积（万亩）
     */
     ...
     */
      ...
      /**
     * 播栽期进度3（8月5日）-育秧已播种面积（万亩）-数据1
     */
      private String field_12_2_1;

      /**
     * 播栽期进度3（8月5日）-育秧已播种面积（万亩）-占比
     */
      private String field_12_2_2;

      /**
     * 播栽期进度3（8月5日）-已栽插面积（万亩）
     */
      private String field_12_3;

      /**
     * 播栽期进度3（8月5日）-直播已播种面积（万亩）
     */

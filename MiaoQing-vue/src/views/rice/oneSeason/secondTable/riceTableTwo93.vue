        ...
        <div class="tableRange">
          ...
          <div class="tableStyle">
            ...
            <el-table :data="tableData.slice((currentPage-1)*pagesize,currentPage*pagesize)" border :header-cell-style="headerStyle"  :row-style="{height: '30px'}" :cell-style="{padding:'0',fontSize:'4px'}" row-key="id" stripe>
                ...
                <el-table-column align="center" prop="field_5" width="170%" label="全县种植面积（万亩）" />
                <el-table-column align="center" prop="field_6" width="170%" label="倒伏时间" />
                <el-table-column align="center" prop="field_7" width="150%" label="倒伏面积（万亩）" />
                <el-table-column align="center" prop="field_8" width="100%" label="占比（%）" />
                <el-table-column align="center" prop="field_9" width="180%" label="其中：成灾面积（万亩）" />
                <el-table-column align="center" prop="field_10" width="180%" label="其中：绝收面积（万亩）" />
                <el-table-column align="center" prop="field_11" width="140%" label="产量损失（%）" />
                <el-table-column align="center" prop="field_12" width="150%" label="倒伏程度（级别）" />
                <el-table-column align="center" prop="field_13" width="100%" label="主要品种" />    
...
export default {
  ...
  methods: {
    ...
    initData() {
      ...
      this.tableLabel= this.years+"年度监测县(市、区)水稻倒伏灾害表";

          ...
          <div class="tableStyle">
            ...
            <el-table :data="tableData.slice((currentPage-1)*pagesize,currentPage*pagesize)" border :header-cell-style="headerStyle"  :row-style="{height: '30px'}" :cell-style="{padding:'0',fontSize:'4px'}" row-key="id" stripe>
                ...
                <el-table-column align="center" label="进程1（大田直播后20天）">
                  ...
                  <el-table-column align="center" prop="field_8_3" width="130%" label="叶龄（叶）" />
                  <el-table-column align="center" prop="field_8_4" width="130%" label="基本苗（万/亩）" />
                </el-table-column>
                <el-table-column align="center" label="进程2（大田直播后25天）">
                ...
                <el-table-column align="center" label="进程3（大田直播后30天）">
                ...
                <el-table-column align="center" label="进程4（大田直播后35天）">
                ...
                <el-table-column align="center" label="进程5（大田直播后40天）">
                ...
                <el-table-column align="center" label="进程6（大田直播后50天）">
                ...
                <el-table-column align="center" label="进程7（大田直播后60天）">
...
export default {
  ...
  data() {
    return {           
      ...
      //表名
      tableLabel:'',
      tableName:'crop_01_02_table_04_02',
      //县的option
      countys:[],
      county: '',
      //地区类型option
  ...
  methods: {
    ...
    initData() {
      ...
      this.tableLabel= this.years+"年度监测县(市、区)双季稻生育进度调查表（直播稻）";
      //this.getHeaderList();
      this.getTableData();

          ...
          <div class="tableRange">
            ...
            <div class="tableStyle">
              ...
              <el-table :data="tableData.slice((currentPage-1)*pagesize,currentPage*pagesize)" border :header-cell-style="headerStyle"  :row-style="{height: '30px'}" :cell-style="{padding:'0',fontSize:'4px'}" row-key="id" stripe>
                ...
                <el-table-column align="center" prop="field_4" width="140%" label="全县总面积（万亩）" fixed/>
                ...
                <el-table-column align="center" label="播种期进度4">
                  ...
                  <el-table-column align="center" prop="field_13_4" width="100%" label="小计" />
                  <el-table-column align="center" prop="field_13_5" width="100%" label="占比" />
                </el-table-column> 
...
export default {
  ...
  methods: {
    ...
    this.currentyear = myDate.getFullYear();
      ...
      this.tableLabel= this.years+"年度监测县(市、区)水稻播栽进度调查表（早稻）";
      //this.getHeaderList();
      this.getTableData();

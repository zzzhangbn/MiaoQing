        ...
        <div class="tableRange">
          ...
          <div class="tableStyle">
            ...
            <el-table :data="tableData.slice((currentPage-1)*pagesize,currentPage*pagesize)" border :header-cell-style="headerStyle" :cell-style="{padding:'0',fontSize:'4px'}" :row-style="{height: '30px'}"  row-key="id" stripe>
                ...
                <el-table-column align="center" prop="field_5" width="140%" label="高温热害" />
                <el-table-column align="center" prop="field_6" width="160%" label="高温热害发生时间" />
                <el-table-column align="center" prop="field_7" width="170%" label="全县种植面积（万亩）" />
                <el-table-column align="center" prop="field_8" width="170%" label="热害总面积（万亩）" />
...
export default {
  ...
  data() {
    return {           
      ...
      //表名
      tableLabel:'',
      tableName:'crop_01_02_table_09_05',
      //县的option
      countys:[],
      county: '',
      //地区类型option
  ...
  methods: {
    ...
    initData() {
      ...
      this.tableLabel= this.years+"年度监测县(市、区)水稻高温热害表";

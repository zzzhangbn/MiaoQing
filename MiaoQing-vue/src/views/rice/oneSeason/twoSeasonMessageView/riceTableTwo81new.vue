        ...
        <div class="tableRange">
          ...
          <div class="tableStyle">
            ...
            <el-table :data="tableData.slice((currentPage-1)*pagesize,currentPage*pagesize)" border :header-cell-style="headerStyle"  :row-style="{height: '30px'}" :cell-style="{padding:'0',fontSize:'4px'}" row-key="id" stripe>
                ...
                <el-table-column align="center" fixed prop="field_4" width="100%" label="品种类型" />
                <el-table-column align="center" fixed prop="field_5" width="110%" label="监测田块" />
...
export default {
  ...
  methods: {
    ...
    initData() {
      ...
      this.years=y;
      this.tableLabel= this.years+"年度监测县(市、区)水稻生产成本效益统计表（早稻）";

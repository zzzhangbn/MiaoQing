            ...
            <div class="tableStyle">
              ...
              <el-table :data="tableData.slice((currentPage-1)*pagesize,currentPage*pagesize)" border :header-cell-style="headerStyle" :row-class-name="tableRowClassName" :row-style="{height: '30px'}" :cell-style="{padding:'0',fontSize:'4px'}" row-key="id" stripe>
                <!-- <el-table-column :label="tableLabel" align="center"> -->
                  ...
                  <el-table-column align="center" prop="field_4" width="100%" label="品系类型" />
                  <el-table-column align="center" label="受灾统计1（万亩）">
                    <el-table-column align="center" prop="field_5_1" width="100%" label="填报日期" />
                    <el-table-column align="center" prop="field_5_2" width="160%" label="生育阶段与灾害症状" />
                    <el-table-column align="center" prop="field_5_3" width="100%" label="受灾面积" />
                    <el-table-column align="center" prop="field_5_4" width="120%" label="其中：成灾面积" />
                    <el-table-column align="center" prop="field_5_5" width="120%" label="其中：绝收面积" />
                    <el-table-column align="center" prop="field_5_6" width="120%" label="需补改种面积" />
                    <el-table-column align="center" prop="field_5_7" width="120%" label="已补改种面积" />
                  </el-table-column>
                  <el-table-column align="center" label="受灾统计2（万亩）">
                    <el-table-column align="center" prop="field_6_1" width="100%" label="填报日期" />
                    <el-table-column align="center" prop="field_6_2" width="130%" label="生育进程、阶段" />
                    <el-table-column align="center" prop="field_6_3" width="100%" label="受灾面积" />
                    <el-table-column align="center" prop="field_6_4" width="130%" label="其中：成灾面积" />
                    <el-table-column align="center" prop="field_6_5" width="130%" label="其中：绝收面积" />
                    <el-table-column align="center" prop="field_6_6" width="130%" label="需补改种面积" />
                    <el-table-column align="center" prop="field_6_7" width="130%" label="已补改种面积" />
                  </el-table-column>
                  <el-table-column align="center" label="受灾统计3（万亩）">
                    <el-table-column align="center" prop="field_7_1" width="100%" label="填报日期" />
                    <el-table-column align="center" prop="field_7_2" width="130%" label="生育进程、阶段" />
                    <el-table-column align="center" prop="field_7_3" width="100%" label="受灾面积" />
                    <el-table-column align="center" prop="field_7_4" width="130%" label="其中：成灾面积" />
                    <el-table-column align="center" prop="field_7_5" width="130%" label="其中：绝收面积" />
                    <el-table-column align="center" prop="field_7_6" width="130%" label="需补改种面积" />
                    <el-table-column align="center" prop="field_7_7" width="130%" label="已补改种面积" />
                  </el-table-column>
...
export default {
  ...
  methods: {
    ...
    this.currentyear = myDate.getFullYear();
      ...
      this.tableLabel= this.years+"年度监测县(市、区)水稻涝害调查表";
      this.getTableData();
    ...
    headerStyle({row,column,rowIndex,columnIndex}){
     // //console.log('row:',row,'column:', column, 'rowIndex:',rowIndex, 'columnIndex:',columnIndex );
        ...
        if(rowIndex==1 || rowIndex==0){
            return{height:'0',padding:'2px',fontSize:'5px',background:'#6E8B3D',color:'#FFFFFF'};
        };
    },
    //表头颜色

          ...
          <div class="tableStyle">
            ...
            <el-table :data="tableData.slice((currentPage-1)*pagesize,currentPage*pagesize)" border :header-cell-style="headerStyle" :row-class-name="tableRowClassName" :row-style="{height: '30px'}" :cell-style="{padding:'0',fontSize:'4px'}" row-key="id" stripe>
              <!-- <el-table-column :label="tableLabel" align="center"> -->
                ...
                <el-table-column align="center" prop="field_7" width="140%" label="倒伏面积（万亩）" />
                ...
                <el-table-column align="center" prop="field_11" width="120%" label="产量损失（%）" />
                <el-table-column align="center" prop="field_12" width="135%" label="倒伏程度（级别）" />
                <el-table-column align="center" prop="field_13" width="150%" label="主要品种" />
...
export default {
  ...
  data() {
    return {         
      ...
      //表名
      tableLabel:'',
      tableName:'crop_01_01_table_09_03',
      //县的option
      countys:[],
      county: '',
      //地区类型option
  ...
  methods: {
    ...
    headerStyle({row,column,rowIndex,columnIndex}){
     // //console.log('row:',row,'column:', column, 'rowIndex:',rowIndex, 'columnIndex:',columnIndex );
        ...
        if(rowIndex==0){
            return{height:'0',padding:'2px',fontSize:'8px',background:'#6E8B3D',color:'#FFFFFF'};
        };
    },
    //表头颜色

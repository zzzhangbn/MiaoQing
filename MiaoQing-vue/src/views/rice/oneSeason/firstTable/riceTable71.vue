            ...
            <div class="tableStyle">
              ...
              <el-table :data="tableData.slice((currentPage-1)*pagesize,currentPage*pagesize)" border :header-cell-style="headerStyle" :row-class-name="tableRowClassName"  :row-style="{height: '30px'}" :cell-style="{padding:'0',fontSize:'4px'}" row-key="id" stripe>
                <!-- <el-table-column :label="tableLabel" align="center"> -->
                  ...
                  <el-table-column align="center" prop="field_3" width="100%" label="总面积(万亩)" fixed/>
                  <el-table-column align="center" label="7月31日前抽穗扬花的中稻">
                    <el-table-column align="center" prop="field_4_1" width="105%" label="面积（万亩）" />
                    <el-table-column align="center" prop="field_4_2" width="110%" label="亩有效穗（万）" />
                    <el-table-column align="center" prop="field_4_3" width="110%" label="穗总粒数（个）" />
                    <el-table-column align="center" prop="field_4_4" width="105%" label="结实率（％）" />
                    <el-table-column align="center" prop="field_4_5" width="105%" label="千粒重（g）" />
                    <el-table-column align="center" prop="field_4_6" width="130%" label="八五折理论产量（kg/亩）" />
                  </el-table-column>
                  <el-table-column align="center" label="8月1-10日抽穗扬花的中稻">
                    <el-table-column align="center" prop="field_5_1" width="105%" label="面积(万亩）" />
                    <el-table-column align="center" prop="field_5_2" width="110%" label="亩有效穗（万）" />
                    <el-table-column align="center" prop="field_5_3" width="110%" label="穗总粒数（个）" />
                    <el-table-column align="center" prop="field_5_4" width="105%" label="结实率（％）" />
                    <el-table-column align="center" prop="field_5_5" width="105%" label="千粒重（g）" />
                    <el-table-column align="center" prop="field_5_6" width="130%" label="八五折理论产量（kg/亩）" />
                  </el-table-column>
                  <el-table-column align="center" label="8月11-15日抽穗扬花的中稻">
                    <el-table-column align="center" prop="field_6_1" width="105%" label="面积(万亩）" />
                    <el-table-column align="center" prop="field_6_2" width="110%" label="亩有效穗（万）" />
                    <el-table-column align="center" prop="field_6_3" width="110%" label="穗总粒数（个）" />
                    <el-table-column align="center" prop="field_6_4" width="105%" label="结实率（％）" />
                    <el-table-column align="center" prop="field_6_5" width="105%" label="千粒重（g）" />
                    <el-table-column align="center" prop="field_6_6" width="130%" label="八五折理论产量（kg/亩）" />
                  </el-table-column>
                  <el-table-column align="center" label="在8月16日-20日抽穗扬花的中稻">
                    <el-table-column align="center" prop="field_7_1" width="105%" label="面积(万亩）" />
                    <el-table-column align="center" prop="field_7_2" width="110%" label="亩有效穗（万）" />
                    <el-table-column align="center" prop="field_7_3" width="110%" label="穗总粒数（个）" />
                    <el-table-column align="center" prop="field_7_4" width="105%" label="结实率（％）" />
                    <el-table-column align="center" prop="field_7_5" width="105%" label="千粒重（g）" />
                    <el-table-column align="center" prop="field_7_6" width="130%" label="八五折理论产量（kg/亩）" />
                  </el-table-column>
                  <el-table-column align="center" label="在8月21-31日抽穗扬花的中稻">
                    <el-table-column align="center" prop="field_8_1" width="105%" label="面积(万亩）" />
                    <el-table-column align="center" prop="field_8_2" width="110%" label="亩有效穗（万）" />
                    <el-table-column align="center" prop="field_8_3" width="110%" label="穗总粒数（个）" />
                    <el-table-column align="center" prop="field_8_4" width="105%" label="结实率（％）" />
                    <el-table-column align="center" prop="field_8_5" width="105%" label="千粒重（g）" />
                    <el-table-column align="center" prop="field_8_6" width="130%" label="八五折理论产量（kg/亩）" />
                  </el-table-column>
                  <el-table-column align="center" label="在9月上旬抽穗扬花的中稻">
                    <el-table-column align="center" prop="field_9_1" width="105%" label="面积(万亩）" />
                    <el-table-column align="center" prop="field_9_2" width="110%" label="亩有效穗（万）" />
                    <el-table-column align="center" prop="field_9_3" width="110%" label="穗总粒数（个）" />
                    <el-table-column align="center" prop="field_9_4" width="105%" label="结实率（％）" />
                    <el-table-column align="center" prop="field_9_5" width="105%" label="千粒重（g）" />
                    <el-table-column align="center" prop="field_9_6" width="130%" label="八五折理论产量（kg/亩）" />
                  </el-table-column>
...
export default {
  ...
  data() {
    return {        
      ...
      //表名
      tableLabel:'',
      tableName:'crop_01_01_table_07_01',
      //县的option
      countys:[],
      county: '',
      //地区类型option
  ...
  methods: {
    ...
    this.currentyear = myDate.getFullYear();
      ...
      this.tableLabel= this.years+"年度监测县(市、区)水稻单季稻苗情监测预测产表";
      this.getTableData();

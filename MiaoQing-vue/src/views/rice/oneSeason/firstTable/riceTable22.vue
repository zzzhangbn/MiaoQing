              ...
              <el-table :data="tableData.slice((currentPage-1)*pagesize,currentPage*pagesize)" border :header-cell-style="headerStyle" :row-class-name="tableRowClassName" :row-style="{height:'30px'}" :cell-style="{padding:'0',fontSize:'4px'}" row-key="id" stripe>
                <!-- <el-table-column :label="tableLabel" align="center"> -->
                  ...
                  <el-table-column align="center" label="地址">
                    <el-table-column align="center" prop="field_2_1" width="80%" label="市" />
                    <el-table-column align="center" prop="field_2_2" width="100%" label="县（市、区）"/>
                    <el-table-column align="center" prop="field_2_3" width="80%" label="镇（乡）" />
                    <el-table-column align="center" prop="field_2_4" width="100%" label="村名"/>
                    <el-table-column align="center" prop="field_2_5" width="70%" label="户主" />
                  </el-table-column>
                  <el-table-column align="center" label="监测田块">
                    <el-table-column align="center" prop="field_3_1" width="110%" label="种植面积（亩）" />
                    <el-table-column align="center" prop="field_3_2" width="90%" label="地区类型"/>
                    <el-table-column align="center" prop="field_3_3" width="100%" label="土壤类型" />
                    <el-table-column align="center" prop="field_3_4" width="80%" label="前茬类型"/>
                    <el-table-column align="center" prop="field_3_5" width="100%" label="水管方式" />
                  ...
                  <el-table-column align="center" label="品种（品系）">
                    <el-table-column align="center" prop="field_4_1" width="200%" label="名称" />
                    <el-table-column align="center" prop="field_4_2" width="80%" label="稻作类型"/>
                    <el-table-column align="center" prop="field_4_3" width="90%" label="品系类型" />
                  </el-table-column>
                  <el-table-column align="center" label="田间信息">
                    <el-table-column align="center" prop="field_5_1" width="95%" label="栽植方式" />
                    <el-table-column align="center" prop="field_5_2" width="90%" label="播期"/>
                    <el-table-column align="center" prop="field_5_3" width="110%" label="移栽秧龄（天）" />
                    <el-table-column align="center" prop="field_5_4" width="110%" label="移栽叶龄（叶）"/>
                    <el-table-column align="center" prop="field_5_5" width="115%" label="基本苗（万/亩）" />
                    <el-table-column align="center" prop="field_5_6" width="90%" label="收获日期" />
                    <el-table-column align="center" prop="field_5_7" width="110%" label="亩有效穗(万)"/>
                    <el-table-column align="center" prop="field_5_8" width="110%" label="穗总粒数(个)" />
                    ...
                    <el-table-column align="center" prop="field_5_11" width="120%" label="理论产量(kg/亩)"/>
                    <el-table-column align="center" prop="field_5_12" width="120%" label="实收产量(kg/亩)" />
                  </el-table-column>  
...
export default {
  ...
  data() {
    return {         
      ...
      //表名
      tableLabel:'',
      tableName:'crop_01_01_table_02_02',
      //县的option
      countys:[],
      county: '',
      //市option

...
<!-- <div class="table_header" style="width:100%;algin:center;text-align:center;">
  <div class="tableLabel">2021年度水稻监测点施肥管理记录表</div>
</div> -->
              <el-row>
              ...
              <el-table :data="tableData.slice((currentPage-1)*pagesize,currentPage*pagesize)" border :header-cell-style="headerStyle" :row-class-name="tableRowClassName" :row-style="{height: '30px'}" :cell-style="{padding:'0',fontSize:'2px'}" row-key="id" stripe>                                          
                <!-- <el-table-column :label="tableLabel" align="center"> -->
                  <el-table-column align="center" type="index" width="50%" :index="countMethod" label="序号" fixed />
                  ...
                  <el-table-column align="center" label="基肥施肥（以折纯计kg/亩）1">
                    ...
                    <el-table-column align="center" prop="field_7_6" width="130%" label="生育进程" />
                  </el-table-column>
                  <el-table-column align="center" label="分蘖肥施肥（以折纯计kg/亩）2">
                    ...
                    <el-table-column align="center" prop="field_8_6" width="130%" label="生育进程" />
                  </el-table-column>
                  <el-table-column align="center" label="孕穗肥施肥（以折纯计kg/亩）3">
                    ...
                    <el-table-column align="center" prop="field_9_6" width="130%" label="生育进程" />
                  </el-table-column>
                  <el-table-column align="center" label="孕穗肥施肥（以折纯计kg/亩）4">
                    ...
                    <el-table-column align="center" prop="field_10_6" width="130%" label="生育进程" />
                  </el-table-column>
                  <el-table-column align="center" label="抽穗叶面肥施肥（以折纯计kg/亩）5">
                    ...
                    <el-table-column align="center" prop="field_11_5" width="100%" label="方法" />
                    <el-table-column align="center" prop="field_11_6" width="130%" label="生育进程" />
                  </el-table-column>

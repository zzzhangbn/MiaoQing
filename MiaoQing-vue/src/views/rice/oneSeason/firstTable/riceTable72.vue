            ...
            <div class="tableStyle">
              ...
              <el-table :data="tableData.slice((currentPage-1)*pagesize,currentPage*pagesize)" border :header-cell-style="headerStyle" :row-class-name="tableRowClassName" :row-style="{height: '30px'}" :cell-style="{padding:'0',fontSize:'4px'}" row-key="id" stripe>
                <!-- <el-table-column :label="tableLabel" align="center"> -->
                  ...
                  <el-table-column align="center" prop="field_3" width="110%" label="总面积(万亩)" fixed/>
                  ...
                  <el-table-column align="center" label="单季稻实测产">
                    <el-table-column align="center" prop="field_10_1" width="100%" label="面积(万亩）" />
                    ...
                    <el-table-column align="center" prop="field_10_4" width="105%" label="结实率（％）" />
                    <el-table-column align="center" prop="field_10_5" width="105%" label="千粒重（g）" />
...
export default {
  ...
  methods: {
    ...
    this.currentyear = myDate.getFullYear();
      ...
      this.tableLabel= this.years+"年度监测县(市、区)水稻单季稻收获进度调查表";
      this.getTableData();

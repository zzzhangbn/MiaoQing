<template>
      ...
      <el-button  type="info" plain @click="getAllExcel">数据分析</el-button>
</template>
  ...
  methods: {
    ...
    getTableData31(){
       ...
       axios({
          ...
          if(totalTableData.length != 0){
            ...
            var totalNum=[];
            var totalPer=[];
            totalNum[0] = Number(total1[1])+Number(total1[2]);
            totalNum[1] = Number(total1[3])+Number(total1[4]);
            totalNum[2]= Number(total1[5])+Number(total1[6]);
            totalNum[3]= Number(total1[7])+Number(total1[8]);
            for(var i=0; i<4; i++){
              if(num1 === 0){
                totalNum[i] = '--';
                totalPer[i] = '--';
              }else if(totalNum[i] === 0){
                totalNum[i] = '--';
                totalPer[i] = '--';
              }else{
         ...
         // _this.tableData=res.data;
          ...
          if(totalTableData.length != 0){
            ...
            for(var i=0; i<totalTableData.length; i++){
              ...
              num20 = _this.add(num20*1+totalTableData[i].field__7_1*1);
              ...
              num29 = _this.add(num29*1+totalTableData[i].field_2*1);

              if(totalTableData[i].field_8_5 === ''){
                totalTableData[i].field_8_5 = 0;
              }
              num30 = _this.add(num30*1+totalTableData[i].field_8_4*1);
    ...
    getTableData91(){ 
       ...
       axios({
          ...
          _this.tableData91 = totalTableData;
    ...
    getTableData92(){ 
       ...
       axios({
         ...
         if(tempData.length != 0){
           ...
           for(var i=0; i<12; i++){
             mean3[i] = _this.add(mean1[i]*1-mean2[i]*1);
           }
         ...
         //数据计算处理
         if(tempData.length != 0){
           //console.log(_this.countys.length);
            var secondTemp=[];
            for(var i=0; i<_this.countys.length; i++){           //获取各个县市独立地数据
              var temp=[];
              for(var j=0; j<tempData.length; j++){
                if(_this.countys[i].value === tempData[j].field_1_1){
                  temp.push(tempData[j]);
                };
              };
              secondTemp.push(temp);
    ...
    handleDownload11() {
      ...
      //console.log("2222")
      const th1 = [['2021年度监测县(市、区)水稻生产栽插概况调查表', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', ''],
                    ['县（市、区）', '全县总面积（万亩）', '地区类型', '稻作类型', '栽植方式（万亩）', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '前茬口类型（万亩）', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '']] //对应表格一级输出的title
      const header = []//三级
      ...
      //console.log(data);
      export_json_to_excel(th1, th2, header, data, '2021年度监测县(市、区)水稻生产栽插概况调查表', merges);
    ...
    handleDownload22() {
        ...
        const data = this.formatJson(filterVal, list);
        //console.log(data);
        export_json_to_excel(th1, th2, header, data, '2021年度年度水稻监测点汇总表', merges);
        // this.downloadLoading = false // 加载遮罩层结束
    },
    handleDownload31() {
      // this.downloadLoading = true // 加载遮罩层开启
      ...
      const {export_json_to_excel} = require('../../excel/Export2Excel2'); //引入文件
      //console.log("2222")
      const th1 = [['2021年度监测县(市、区)水稻播栽进度调查表', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', ''],
                    ['县（市、区）', '地区类型', '全县总面积（万亩）', '播种日期', '', '秧田面积（万亩）', '', '', '折合大田面积（万亩）', '', '', '', '播栽期进度1', '', '', '', '', '', '', '播栽期进度2', '', '', '', '', '', '', '播栽期进度3', '', '', '', '', '', '', '播栽期进度4', '', '', '', '']] //对应表格一级输出的title
      const header = []//三级
      ...
      const data = this.formatJson(filterVal, list);
      //console.log(data);
      export_json_to_excel(th1, th2, header, data, '2021年度监测县(市、区)水稻播栽进度调查表', merges);
      // this.downloadLoading = false // 加载遮罩层结束
    },
    handleDownload32() {
      // this.downloadLoading = true // 加载遮罩层开启
      ...
      const {export_json_to_excel} = require('../../excel/Export2Excel2'); //引入文件
      //console.log("2222")
      const th1 = [['2021年度监测县(市、区)水稻苗情评价动态列表（移栽稻）', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '','', '', '', '', '', '', '', '', '', '','', '', '', '', '', '', '', '', '', '',''],
      ...
      const data = this.formatJson(filterVal, list);
      //console.log(data);
      export_json_to_excel(th1, th2, header, data, '2021年度监测县(市、区)水稻苗情评价动态列表（移栽稻）', merges);
      // this.downloadLoading = false // 加载遮罩层结束
    },
    handleDownload33() {
      // this.downloadLoading = true // 加载遮罩层开启
      ...
      const {export_json_to_excel} = require('../../excel/Export2Excel2'); //引入文件
      //console.log("2222")
      const th1 = [['2021年度监测县(市、区)水稻苗情评价动态列表（直播稻）', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '','', '', '', '', '', '', '', '', '', '','', '', '', '', '', '', '', '', '', '','', '', '', '', '', '', '',''],
      ...
      const data = this.formatJson(filterVal, list);
      //console.log(data);
      export_json_to_excel(th1, th2, header, data, '2021年度监测县(市、区)水稻苗情评价动态列表（直播稻）', merges);
      // this.downloadLoading = false // 加载遮罩层结束
    },
    handleDownload41() {
      // this.downloadLoading = true // 加载遮罩层开启
      ...
      const {export_json_to_excel} = require('../../excel/Export2Excel2'); //引入文件
      //console.log("2222")
      const th1 = [['2021年度监测县(市、区)中稻生育进度调查表（移栽稻）', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '',''],
      ...
      const data = this.formatJson(filterVal, list);
      //console.log(data);
      export_json_to_excel(th1, th2, header, data, '2021年度监测县(市、区)中稻生育进度调查表（移栽稻）', merges);
      // this.downloadLoading = false // 加载遮罩层结束
    },
    handleDownload42() {
      // this.downloadLoading = true // 加载遮罩层开启
      ...
      const {export_json_to_excel} = require('../../excel/Export2Excel2'); //引入文件
      //console.log("2222")
      const th1 = [['2021年度监测县(市、区)中稻生育进度调查表（直播稻）', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', ''],
      ...
      const data = this.formatJson(filterVal, list);
      //console.log(data);
      export_json_to_excel(th1, th2, header, data, '2021年度监测县(市、区)中稻生育进度调查表（直播稻）', merges);
      // this.downloadLoading = false // 加载遮罩层结束
    },
    handleDownload43() {
      // this.downloadLoading = true // 加载遮罩层开启
      ...
      const {export_json_to_excel} = require('../../excel/Export2Excel2'); //引入文件
      //console.log("2222")
      const th1 = [['2021年度水稻监测点茎蘖数叶面积构成表', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', ''],
      ...
      const data = this.formatJson(filterVal, list);
      //console.log(data);
      export_json_to_excel(th1, th2, header, data, '2021年度水稻监测点茎蘖数叶面积构成表', merges);
      // this.downloadLoading = false // 加载遮罩层结束
    },
    handleDownload44() {
      // this.downloadLoading = true // 加载遮罩层开启
      ...
      const {export_json_to_excel} = require('../../excel/Export2Excel2'); //引入文件
      //console.log("2222")
      const th1 = [['2021年度水稻监测点苗情生育期统计表', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', ''],
                    ] //对应表格一级输出的title
      const header = []//三级
      const th2 =  [['县（市、区）', '监测田块', '地区类型', '稻作类型', '品系类型', '品种名称',
                      '栽培方式', '播种期（月/日）', '出苗期（月/日）', '移栽期（月/日）', 
      ...
      const data = this.formatJson(filterVal, list);
      //console.log(data);
      export_json_to_excel(th1, th2, header, data, '2021年度水稻监测点苗情生育期统计表', merges);
      // this.downloadLoading = false // 加载遮罩层结束
    },
    handleDownload51() {
      // this.downloadLoading = true // 加载遮罩层开启
      ...
      const data = this.formatJson(filterVal, list);
      //console.log(data);
      export_json_to_excel(th1, th2, header, data, '2021年度叶片含氮测定仪导出数据', merges);
      // this.downloadLoading = false // 加载遮罩层结束
    },
    handleDownload61() {
      // this.downloadLoading = true // 加载遮罩层开启
      ...
      const data = this.formatJson(filterVal, list);
      //console.log(data);
      export_json_to_excel(th1, th2, header, data, '2021年度水稻监测点水分管理记录表', merges);
      // this.downloadLoading = false // 加载遮罩层结束
    },
    handleDownload62() {
      // this.downloadLoading = true // 加载遮罩层开启
      ...
      const data = this.formatJson(filterVal, list);
      //console.log(data);
      export_json_to_excel(th1, th2, header, data, '2021年度水稻监测点化除管理记录表', merges);
      // this.downloadLoading = false // 加载遮罩层结束
    },
    handleDownload63() {
      // this.downloadLoading = true // 加载遮罩层开启
      ...
      const data = this.formatJson(filterVal, list);
      //console.log(data);
      export_json_to_excel(th1, th2, header, data, '2021年度水稻监测点病虫害防治记录表', merges);
      // this.downloadLoading = false // 加载遮罩层结束
    },
    handleDownload64() {
      // this.downloadLoading = true // 加载遮罩层开启
      ...
      const data = this.formatJson(filterVal, list);
      //console.log(data);
      export_json_to_excel(th1, th2, header, data, '2021年度水稻监测点施肥管理记录表', merges);
      // this.downloadLoading = false // 加载遮罩层结束
    },
    handleDownload65() {
      // this.downloadLoading = true // 加载遮罩层开启
      ...
      const {export_json_to_excel} = require('../../excel/Export2Excel2'); //引入文件
      //console.log("2222")
      const th1 = [['2021年度水稻监测点化学调节剂使用记录表', '', '', '', '', '',  '', '', '', '', '', '', '','', '', '', '', '', '', '', ''],
                    ['县（市、区）', '监测点代码', '地区类型', '稻作类型', '品种名称', '栽植方式', 
                    '化调剂1', '', '', '', '', 
                    '化调剂2', '', '', '', '', 
                    '化调剂3', '', '', '', '',]] //对应表格一级输出的title
      ...
      const data = this.formatJson(filterVal, list);
      //console.log(data);
      export_json_to_excel(th1, th2, header, data, '2021年度水稻监测点化学调节剂使用记录表', merges);
      // this.downloadLoading = false // 加载遮罩层结束
    },
    handleDownload71() {
      // this.downloadLoading = true // 加载遮罩层开启
      ...
      const {export_json_to_excel} = require('../../excel/Export2Excel2'); //引入文件
      //console.log("2222")
      const th1 = [['2021年度监测县(市、区)水稻单季稻苗情监测预测产表','', '', 
                    '', '', '', '', '', '','', '', '', '', '', '','', '', '', '', '', '',
                    '', '', '', '', '', '','', '', '', '', '', '','', '', '', '', '', '',],
                    ['县（市、区）', '地区类型', '总面积（万亩）', 
                    '7月31日前抽穗扬花的中稻', '', '', '', '', '',
      ...
      const header = []//三级
      const th2 =  [['', '', '', 
                    '面积(万亩)', '亩有效穗(万)', '穗总粒数(个)', '结实率(％)', '千粒重(g)', '理论产量(kg/亩)',
                    '面积(万亩)', '亩有效穗(万)', '穗总粒数(个)', '结实率(％)', '千粒重(g)', '理论产量(kg/亩)',
                    '面积(万亩)', '亩有效穗(万)', '穗总粒数(个)', '结实率(％)', '千粒重(g)', '理论产量(kg/亩)',
                    '面积(万亩)', '亩有效穗(万)', '穗总粒数(个)', '结实率(％)', '千粒重(g)', '理论产量(kg/亩)',
                    '面积(万亩)', '亩有效穗(万)', '穗总粒数(个)', '结实率(％)', '千粒重(g)', '理论产量(kg/亩)',
                    '面积(万亩)', '亩有效穗(万)', '穗总粒数(个)', '结实率(％)', '千粒重(g)', '理论产量(kg/亩)',]] //对应表格三级输出的title
      ...
      const data = this.formatJson(filterVal, list);
      //console.log(data);
      export_json_to_excel(th1, th2, header, data, '2021年度监测县(市、区)水稻单季稻苗情监测预测产表', merges);
      // this.downloadLoading = false // 加载遮罩层结束
    },
    handleDownload72() {
      // this.downloadLoading = true // 加载遮罩层开启
      ...
      const {export_json_to_excel} = require('../../excel/Export2Excel2'); //引入文件
      //console.log("2222")
      const th1 = [['2021年度监测县(市、区)水稻单季稻收获进度调查表', '', '', '', '', '', '', '', '', '', '', '', '', '', '','', '', '', '', '', '', '', '', '', '', '', ''],
                    ['县（市、区）', '地区类型', '总面积（万亩）', 
                    '收获进度1', '', '', '收获进度2', '', '',
                    '收获进度3', '', '', '收获进度4', '', '',
                    '收获进度5', '', '', '收获进度6', '', '',
      ...
      const th2 =  [['', '', '', '日期', '收获面积（万亩）', '', '日期', '收获面积（万亩）', '', 
                    ...
                    '面积(万亩)', '亩有效穗(万)', '穗总粒数(个)', '结实率(％)', '千粒重(g)', '产量(kg/亩)' ]] //对应表格三级输出的title
      const filterVal = ['field_1', 'field_2', 'field_3', 
      ...
      const data = this.formatJson(filterVal, list);
      //console.log(data);
      export_json_to_excel(th1, th2, header, data, '2021年度监测县(市、区)水稻单季稻收获进度调查表', merges);
      // this.downloadLoading = false // 加载遮罩层结束
    },
    handleDownload73() {
      // this.downloadLoading = true // 加载遮罩层开启
      ...
      const {export_json_to_excel} = require('../../excel/Export2Excel2'); //引入文件
      //console.log("2222")
      const th1 = [['2021年度监测县(市、区)水稻单季稻测产表', '','', '', '', '', '', '','', '', '', '', '', '','', '', '', '', '', '', '', '', '', '', '', '','', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '',],
                    ['县（市、区）', '地区类型',
                     '全县面上平均水平', '', '', '', '', '',
                     '人工移栽', '', '', '', '', '',
                     '机械插秧', '', '', '', '', '',
      ...
      const header = []//三级
      const th2 =  [['', '',
                     '总面积（万亩）', '亩有效穗（万）', '每穗粒数（粒）', '结实率（%）', '千粒重（克）', '亩理论产量（公斤）',
                     '总面积（万亩）', '亩有效穗（万）', '每穗粒数（粒）', '结实率（%）', '千粒重（克）', '亩理论产量（公斤）',
                     '总面积（万亩）', '亩有效穗（万）', '每穗粒数（粒）', '结实率（%）', '千粒重（克）', '亩理论产量（公斤）',
                     '总面积（万亩）', '亩有效穗（万）', '每穗粒数（粒）', '结实率（%）', '千粒重（克）', '亩理论产量（公斤）',
                     '总面积（万亩）', '亩有效穗（万）', '每穗粒数（粒）', '结实率（%）', '千粒重（克）', '亩理论产量（公斤）',
                     '总面积（万亩）', '亩有效穗（万）', '每穗粒数（粒）', '结实率（%）', '千粒重（克）', '亩理论产量（公斤）',
                     '总面积（万亩）', '亩有效穗（万）', '每穗粒数（粒）', '结实率（%）', '千粒重（克）', '亩理论产量（公斤）',]] //对应表格三级输出的title
      ...
      const data = this.formatJson(filterVal, list);
      //console.log(data);
      export_json_to_excel(th1, th2, header, data, '2021年度监测县(市、区)水稻单季稻测产表', merges);
      // this.downloadLoading = false // 加载遮罩层结束
    },
    handleDownload81() {
      // this.downloadLoading = true // 加载遮罩层开启
      ...
      const {export_json_to_excel} = require('../../excel/Export2Excel2'); //引入文件
      //console.log("2222")
      const th1 = [['2021年度监测县(市、区)水稻生产成本效益统计表','', '', '','','', '', '', '', '','', '', '', '', '', '', '', '', '', '', '', '','', '', '', '', '', '', '', '', '', '', '', '', '','', '', '', ''],
      ...
      const data = this.formatJson(filterVal, list);
      //console.log(data);
      export_json_to_excel(th1, th2, header, data, '2021年度监测县(市、区)水稻生产成本效益统计表', merges);
      // this.downloadLoading = false // 加载遮罩层结束
    },
    handleDownload91() {
      // this.downloadLoading = true // 加载遮罩层开启
    ...
    handleDownload93() {
      ...
      const {export_json_to_excel} = require('../../excel/Export2Excel2'); //引入文件
      //console.log("2222")
      const th1 = [['2021年度监测县(市、区)水稻倒伏灾害表', '', '','', '', '', '', '', '','', '', '', ''],
                    ] //对应表格一级输出的title
      const header = []//三级
      ...
      const data = this.formatJson(filterVal, list);
      //console.log(data);
      export_json_to_excel(th1, th2, header, data, '2021年度监测县(市、区)水稻倒伏灾害表', merges);
      // this.downloadLoading = false // 加载遮罩层结束
    },
    handleDownload94() {
      // this.downloadLoading = true // 加载遮罩层开启
      ...
      const {export_json_to_excel} = require('../../excel/Export2Excel2'); //引入文件
      //console.log("2222")
      const th1 = [['2021年度监测县(市、区)水稻低温冷害表', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', ''],
      ...
      const data = this.formatJson(filterVal, list);
      //console.log(data);
      export_json_to_excel(th1, th2, header, data, '2021年度监测县(市、区)水稻低温冷害表', merges);
      // this.downloadLoading = false // 加载遮罩层结束
    },
    handleDownload95() {
      // this.downloadLoading = true // 加载遮罩层开启
      ...
      const {export_json_to_excel} = require('../../excel/Export2Excel2'); //引入文件
      //console.log("2222")
      const th1 = [['2021年度监测县(市、区)水稻高温热害表', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', ''],
      ...
      const data = this.formatJson(filterVal, list);
      //console.log(data);
      export_json_to_excel(th1, th2, header, data, '2021年度监测县(市、区)水稻高温热害表', merges);
      // this.downloadLoading = false // 加载遮罩层结束
    },
    handleDownload96() {
      // this.downloadLoading = true // 加载遮罩层开启
      ...
      const {export_json_to_excel} = require('../../excel/Export2Excel2'); //引入文件
      //console.log("2222")
      const th1 = [['2021年度监测县(市、区)水稻涝害调查表', '', '','', '', '', '', '', '', '', '', '', '', '', '', '', '', '','', '', '', '', '', '', '',],
      ...
      const data = this.formatJson(filterVal, list);
      //console.log(data);
      export_json_to_excel(th1, th2, header, data, '2021年度监测县(市、区)水稻涝害调查表', merges);
      // this.downloadLoading = false // 加载遮罩层结束
    },
    handleDownload97() {
      // this.downloadLoading = true // 加载遮罩层开启
      ...
      const data = this.formatJson(filterVal, list);
      //console.log(data);
      export_json_to_excel(th1, th2, header, data, '2021年度水稻监测点洪涝灾害表', merges);
      // this.downloadLoading = false // 加载遮罩层结束
    },
    handleDownload101() {
      // this.downloadLoading = true // 加载遮罩层开启
      ...
      const data = this.formatJson(filterVal, list);
      //console.log(data);
      export_json_to_excel(th1, th2, header, data, '2021年度水稻监测点灌浆速率调查表', merges);
      // this.downloadLoading = false // 加载遮罩层结束
    },
    // 将JSON转换成map

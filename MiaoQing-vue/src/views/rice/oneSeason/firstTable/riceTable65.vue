            ...
            <div class="tableStyle">
              ...
              <el-table :data="tableData.slice((currentPage-1)*pagesize,currentPage*pagesize)" border :header-cell-style="headerStyle" :row-class-name="tableRowClassName" :row-style="{height: '30px'}" :cell-style="{padding:'0',fontSize:'4px'}" row-key="id" stripe>
                <!-- <el-table-column width="100%" :label="tableLabel" align="center"> -->
                  ...
                  <el-table-column align="center" prop="field_2" width="105%" label="监测点代码" fixed/>
                  ...
                  <el-table-column align="center" prop="field_6" width="120%" label="栽植方式" />
                  <el-table-column align="center" label="化调剂1">
                    ...
                    <el-table-column align="center" prop="field_7_5" width="130%" label="生育进程" />
                  </el-table-column>
                  <el-table-column align="center" label="化调剂2">
                    ...
                    <el-table-column align="center" prop="field_8_5" width="130%" label="生育进程" />
                  </el-table-column>
                  <el-table-column align="center" label="化调剂3">
                    ...
                    <el-table-column align="center" prop="field_9_5" width="130%" label="生育进程" />
                  </el-table-column>

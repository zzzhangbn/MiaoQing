      ...
      <el-tabs v-model="activeName" @tab-click="handleClick">
        <el-tab-pane label="单季稻" name="1">
          <div class="tableRange">
            <el-table :data="tableData1" @cell-click="handleCell" :header-cell-style="{background:'#5e616d',color:'#FFFFFF',fontSize:'14px'}" :row-style="{height: '30px'}" :cell-style="{padding:'0',fontSize:'12px',color:'#000000',cursor:'pointer'}" row-key="id" stripe>
    ...
    return { 
      ...
      tableData2: [{table_01: '监测县(市、区)水稻栽插概况调查表', table_02: '水稻监测点汇总表',table_03: '监测县(市、区)水稻播栽进度调查表（早稻）', table_04: '监测县(市、区)中稻生育进度调查表（移栽稻）',
                  ...
                  { table_01: '监测县(市、区)水稻生产主推品种调查表', table_03: '监测县(市、区)水稻播栽进度调查表（晚稻）',table_04: '监测县(市、区)直播稻生育进度调查表（直播稻）',
                    ...
                    table_09: '监测县(市、区)抽穗期前、后各15天气象资料',table_10: '水稻监测点灌浆速率调查表（晚稻）'},
      ...
      tableData1: [{table_01: '监测县(市、区)水稻栽插概况调查表', table_02: '水稻监测点汇总表',table_03: '监测县(市、区)水稻播栽进度调查表', table_04: '监测县(市、区)中稻生育进度调查表（移栽稻）',
                    table_05: '叶片含氮测定仪导出数据',table_06: '水稻监测点水分管理记录表',table_07: '监测县(市、区)水稻单季稻苗情监测预测产表',table_08: '监测县(市、区)水稻生产成本效益统计表',
                    table_09: '监测县(市、区)气象资料列表',table_10: '水稻监测点灌浆速率调查表',}, 
                  { table_01: '监测县(市、区)水稻生产主推品种调查表', table_03: '监测县(市、区)水稻苗情评价动态列表（育秧）',table_04: '监测县(市、区)直播稻生育进度调查表（直播稻）',
                    table_06: '水稻监测点化除管理记录表',table_07: '监测县(市、区)水稻单季稻收获进度调查',table_09: '监测县(市、区)抽穗期前、后各15天气象资料'},
                  { table_03: '监测县(市、区)水稻苗情评价动态列表（直播）',table_04: '水稻监测点茎蘖数叶面积构成表', table_06: '水稻监测点病虫害防治记录表',
                    table_07: '监测县(市、区)水稻单季稻测产表',table_09: '监测县(市、区)水稻倒伏灾害表'},
                  { table_04: '水稻监测点苗情生育期统计表',table_06: '水稻监测点施肥管理记录表',table_09: '监测县(市、区)水稻低温冷害表'},
                  { table_06: '水稻监测点化学调节剂使用记录表', table_09: '监测县(市、区)水稻高温热害表'},
                  { table_09: '监测县(市、区)水稻涝害调查表'},
                  { table_09: '水稻监测点洪涝灾害表'},
                  ], 
      //暂存参数
      diqu:'',
  ...
  methods: {
    ...
    handleCell(row,column,event,cell){
      ...
      if(column.label == "生产概况"){
        if(row.table_01 === '监测县(市、区)水稻栽插概况调查表'){
          this.$router.push({path:'/riceTable11',query:{area:areas,city:citys,year:years}});
          ////console.log('1111');
        };
        if(row.table_01 === '监测县(市、区)水稻生产主推品种调查表'){
          this.$router.push({path:'/riceTable12',query:{area:areas,city:citys,year:years}});
          
        };
      };
      if(column.label === "监测点建档卡"){
          if(row.table_02 === '水稻监测点汇总表'){
            this.$router.push({path:'/riceTable22',query:{area:areas,city:citys,year:years}});
          };
      };
      if(column.label === "面上生产调度"){
        if(row.table_03 === '监测县(市、区)水稻播栽进度调查表'){
          this.$router.push({path:'/riceTable31',query:{area:areas,city:citys,year:years}});
        };
        if(row.table_03 === '监测县(市、区)水稻苗情评价动态列表（育秧）'){
          this.$router.push({path:'/riceTable32',query:{area:areas,city:citys,year:years}});
        };
        if(row.table_03 === '监测县(市、区)水稻苗情评价动态列表（直播）'){
          this.$router.push({path:'/riceTable33',query:{area:areas,city:citys,year:years}});
        };
      };
      if(column.label === "监测点生产进度调查"){
          if(row.table_04 === '监测县(市、区)中稻生育进度调查表（移栽稻）'){
            this.$router.push({path:'/riceTable41',query:{area:areas,city:citys,year:years}});
          };
          if(row.table_04 === '监测县(市、区)直播稻生育进度调查表（直播稻）'){
            this.$router.push({path:'/riceTable42',query:{area:areas,city:citys,year:years}});
          };
          if(row.table_04 === '水稻监测点茎蘖数叶面积构成表'){
            this.$router.push({path:'/riceTable43',query:{area:areas,city:citys,year:years}});
          };
          if(row.table_04 === '水稻监测点苗情生育期统计表'){
            this.$router.push({path:'/riceTable44',query:{area:areas,city:citys,year:years}});
          };
      };
      if(column.label === "叶片参数自动测定"){
        if(row.table_05 === '叶片含氮测定仪导出数据'){
             this.$router.push({path:'/riceTable51',query:{area:areas,city:citys,year:years}});
        };
      };
      if(column.label === "监测点田管记录"){
        if(row.table_06 === '水稻监测点水分管理记录表'){
          this.$router.push({path:'/riceTable61',query:{area:areas,city:citys,year:years}});
        };
        if(row.table_06 === '水稻监测点化除管理记录表'){
          this.$router.push({path:'/riceTable62',query:{area:areas,city:citys,year:years}});
        };
        if(row.table_06 === '水稻监测点病虫害防治记录表'){
          this.$router.push({path:'/riceTable63',query:{area:areas,city:citys,year:years}});
        };
        if(row.table_06 === '水稻监测点施肥管理记录表'){
          this.$router.push({path:'/riceTable64',query:{area:areas,city:citys,year:years}});
        };
        if(row.table_06 === '水稻监测点化学调节剂使用记录表'){
          this.$router.push({path:'/riceTable65',query:{area:areas,city:citys,year:years}});
        };
      };
      if(column.label === "测产相关进度监测"){
        if(row.table_07 === '监测县(市、区)水稻单季稻苗情监测预测产表'){
          this.$router.push({path:'/riceTable71',query:{area:areas,city:citys,year:years}});
        };
        if(row.table_07 === '监测县(市、区)水稻单季稻收获进度调查'){
          this.$router.push({path:'/riceTable72',query:{area:areas,city:citys,year:years}});
        };
        if(row.table_07 === '监测县(市、区)水稻单季稻测产表'){
          this.$router.push({path:'/riceTable73',query:{area:areas,city:citys,year:years}});
        };
      };
      if(column.label === "生产效益调查"){
          if(row.table_08 === '监测县(市、区)水稻生产成本效益统计表'){
            this.$router.push({path:'/riceTable81',query:{area:areas,city:citys,year:years}});
          };
      };
      if(column.label === "气象及自然灾害调查"){
        if(row.table_09 === '监测县(市、区)气象资料列表'){
          this.$router.push({path:'/riceTable91',query:{area:areas,city:citys,year:years}});
        };
        if(row.table_09 === '监测县(市、区)抽穗期前、后各15天气象资料'){
          this.$router.push({path:'/riceTable92',query:{area:areas,city:citys,year:years}});
        };
        if(row.table_09 === '监测县(市、区)水稻倒伏灾害表'){
          this.$router.push({path:'/riceTable93',query:{area:areas,city:citys,year:years}});
        };
        if(row.table_09 === '监测县(市、区)水稻低温冷害表'){
          this.$router.push({path:'/riceTable94',query:{area:areas,city:citys,year:years}});
        };
        if(row.table_09 === '监测县(市、区)水稻高温热害表'){
          this.$router.push({path:'/riceTable95',query:{area:areas,city:citys,year:years}});
        };
        if(row.table_09 === '监测县(市、区)水稻涝害调查表'){
          this.$router.push({path:'/riceTable96',query:{area:areas,city:citys,year:years}});
        };
        if(row.table_09 === '水稻监测点洪涝灾害表'){
          this.$router.push({path:'/riceTable97',query:{area:areas,city:citys,year:years}});
        };
      };
      if(column.label === "监测点灌浆速率调查表"){
        if(row.table_10 === '水稻监测点灌浆速率调查表'){
        this.$router.push({path:'/riceTable101',query:{area:areas,city:citys,year:years}});
      };
      };
    },
    ...
    getTableData11(){
       ...
       axios({
          ...
          if(totalTableData.length != 0){
            ...
            _this.tableData11 = totalTableData;
            ////console.log(_this.tableData11);
       }).catch(err=>{
         //console.log("此处有问题");
         ////return this.$message.error("查询数据失败！");
       });
    ...
    getTableData22(){
       ...
       axios({
          ...
          params:{
           ...
           _this.tableData22=res.data;
            ////console.log(_this.tableData22);
    ...
    getTableData31(){
       ...
       axios({
          ...
          if(totalTableData.length != 0){
            ...
            //辅助数组
            totalTableData.push({"field_1":'合计',"field_2":'--',"field_3":num1,"field_4_1":'--',"field_4_2":'--',"field_5":total1[0],
                      "field_6_1":total2[0],"field_6_2":sums[0],"field_7_1":total2[1],"field_7_2":sums[1],"field_8_1":total2[2],"field_8_2":sums[2],
                      "field_9_1":'--',"field_9_2_1":total2[3],"field_9_2_2":sums[3],"field_9_3":total1[1],"field_9_4":total1[2],"field_9_5":totalNum[0],"field_9_6":totalPer[0],
                      "field_10_1":'--',"field_10_2_1":total2[4],"field_10_2_2":sums[4],"field_10_3":total1[3],"field_10_4":total1[4],"field_10_5":totalNum[1],"field_10_6":totalPer[1],
                      "field_11_1":'--',"field_11_2_1":total2[5],"field_11_2_2":sums[5],"field_11_3":total1[5],"field_11_4":total1[6],"field_11_5":totalNum[2],"field_11_6":totalPer[2],
                      "field_12_1":'--',"field_12_2":total1[7],"field_12_3":total1[8],"field_12_4":totalNum[3],"field_12_5":totalPer[3],
                      "in_use":'--'})
          }else{
          };
          _this.tableData31 = totalTableData;
    ...
    getTableData32(){
       ...
       axios({
          ...
          if(totalTableData.length != 0){
            ...
            var num21=0;var num22=0;var num23=0;var num24=0;var num25=0;
            //合计行计算
            for(var i=0; i<totalTableData.length; i++){
              if(totalTableData[i].field_3 === ''){
                totalTableData[i].field_3 = 0;
              ...
              num23 = _this.add(num23*1+totalTableData[i].field_11_2_1*1);

              if(totalTableData[i].field_11_3_1 === ''){
                totalTableData[i].field_11_3_1 = 0;
              }
              num24 = _this.add(num24*1+totalTableData[i].field_11_3_1*1);
              
              if(totalTableData[i].field_11_4_1 === ''){
                totalTableData[i].field_11_4_1 = 0;
              }
              num25 = _this.add(num25*1+totalTableData[i].field_11_4_1*1);
            };
            //各品种面积总和
            total[0]=num2;total[1]=num3;total[2]=num4;total[3]=num5;total[4]=num6;total[5]=num7;total[6]=num8;total[7]=num9;total[8]=num10;total[9]=num11;
            ...
            total[19]=num21;total[20]=num22;total[21]=num23;total[22]=num24;total[23]=num25;
            //求占比
            ...
            totalTableData.push({"field_1":'合计',"field_2":'--',"field_3":num1,
                      ...
                      "field_11_1":'--',"field_11_2_1":total[21],"field_11_2_2":sums[21], "field_11_3_1":total[22],"field_11_3_2":sums[22],"field_11_4_1":total[23],"field_11_4_2":sums[23],
                      "in_use":'--'})
          }else{
          } 
           _this.tableData32 = totalTableData;
       ...
       axios({
          ...
          if(totalTableData.length != 0){
            ...
            for(var i=0; i<totalTableData.length; i++){
              ...
              num26 = _this.add(num26*1+totalTableData[i].field_12_2_1*1);

              if(totalTableData[i].field_12_3_1 === ''){
                totalTableData[i].field_12_3_1 = 0;
              }
              num27 = _this.add(num27*1+totalTableData[i].field_12_3_1*1);
              
              if(totalTableData[i].field_12_4_1 === ''){
                totalTableData[i].field_12_4_1 = 0;
              }
              num28 = _this.add(num28*1+totalTableData[i].field_12_4_1*1);
            };
            //各品种面积总和
            total[0]=num2;total[1]=num3;total[2]=num4;total[3]=num5;total[4]=num6;total[5]=num7;total[6]=num8;total[7]=num9;total[8]=num10;total[9]=num11;
            total[10]=num12;total[11]=num13;total[12]=num14;total[13]=num15;total[14]=num16;total[15]=num17;total[16]=num18;total[17]=num19;total[18]=num20;
            ...
            totalTableData.push({"field_1":'合计',"field_2":'--',"field_3":num1,
                      ...
                      "field_10_1":'--',"field_10_2_1":total[18],"field_10_2_2":sums[18], "field_10_3_1":total[19],"field_10_3_2":sums[19],"field_10_4_1":total[20],"field_10_4_2":sums[20],
                      "field_11_1":'--',"field_11_2_1":total[21],"field_11_2_2":sums[21], "field_11_3_1":total[22],"field_11_3_2":sums[22],"field_11_4_1":total[23],"field_11_4_2":sums[23],
                      "field_12_1":'--',"field_12_2_1":total[24],"field_12_2_2":sums[24], "field_12_3_1":total[25],"field_12_3_2":sums[25],"field_12_4_1":total[26],"field_12_4_2":sums[26],
                      "in_use":'--'})
          }else{
          }; 
          _this.tableData33 = totalTableData;
         ...
         // _this.tableData=res.data;
          ...
          if(totalTableData.length != 0){
            ...
            for(var i=0; i<totalTableData.length; i++){
              ...
              if(totalTableData[i].field_16_3 === ''){
                totalTableData[i].field_16_3 = 0;
              }
              num18 = _this.add(num18*1+totalTableData[i].field_16_3*1);

              if(totalTableData[i].field_16_4 === ''){
                totalTableData[i].field_16_4 = 0;
              }
              num19 = _this.add(num19*1+totalTableData[i].field_16_4*1);

              if(totalTableData[i].field_17_3 === ''){
                totalTableData[i].field_17_3 = 0;
              }
              num20 = _this.add(num20*1+totalTableData[i].field_17_3*1);
              
              if(totalTableData[i].field_17_4 === ''){
                totalTableData[i].field_17_4 = 0;
              }
              num21 = _this.add(num21*1+totalTableData[i].field_17_4*1);
            };
            //各品种面积总和
            ////console.log('1111');
            ...
            totalTableData.push({"field_1":'合计',"field_2":'--',"field_3":'--',"field_4":'--',"field_5":'--',"field_6":'--',"field_7":'--',
                                ...
                                "field_16_1":'--',"field_16_2":'--',"field_16_3":sums[17],"field_16_4":sums[18],
                                "field_17_1":'--',"field_17_2":'--',"field_17_3":sums[19],"field_17_4":sums[20],
                                "in_use":'--'})
          }else{
          };
          _this.tableData41 = totalTableData;
          ////console.log(_this.tableData41);
       }).catch(err=>{
         //console.log("此处有问题");
         ////return this.$message.error("查询数据失败！");
       });
         ...
         // _this.tableData=res.data;
          ...
          if(totalTableData.length != 0){
            ...
            for(var i=0; i<totalTableData.length; i++){
              ...
              num15 = _this.add(num15*1+totalTableData[i].field_15_3*1);

              if(totalTableData[i].field_15_4 === ''){
                totalTableData[i].field_15_4 = 0;
              }
              num16 = _this.add(num16*1+totalTableData[i].field_15_4*1);

              if(totalTableData[i].field_16_3 === ''){
                totalTableData[i].field_16_3 = 0;
              }
              num17 = _this.add(num17*1+totalTableData[i].field_16_3*1);

              if(totalTableData[i].field_16_4 === ''){
                totalTableData[i].field_16_4 = 0;
              }
              num18 = _this.add(num18*1+totalTableData[i].field_16_4*1);
            };
            //各品种面积总和
            ////console.log('1111');
            total[0]=num1;total[1]=num2;total[2]=num3;total[3]=num4;total[4]=num5;total[5]=num6;total[6]=num7;total[7]=num8;total[8]=num9;total[9]=num10;
            ...
            totalTableData.push({"field_1":'合计',"field_2":'--',"field_3":'--',"field_4":'--',"field_5":'--',"field_6":'--',"field_7":'--',
                                ...
                                "field_15_1":'--',"field_15_2":'--',"field_15_3":sums[14],"field_15_4":sums[15],
                                "field_16_1":'--',"field_16_2":'--',"field_16_3":sums[16],"field_16_4":sums[17],
                                "in_use":'--'})
          }else{
          };
          _this.tableData42 = totalTableData;
          ////console.log(_this.tableData42);
       }).catch(err=>{
         //console.log("此处有问题");
         ////return this.$message.error("查询数据失败！");
       });
    ...
    getTableData43(){
       ...
       axios({
         ...
         // _this.tableData=res.data;
          ...
          _this.tableData43 = totalTableData;
          ////console.log(_this.tableData43);
       }).catch(err=>{
         //console.log("此处有问题");
         ////return this.$message.error("查询数据失败！");
       });
    ...
    getTableData44(){
       ...
       axios({
         ...
         ////console.log(res.data);
          ...
          _this.tableData44 = totalTableData;
          ////console.log(_this.tableData44);
       }).catch(err=>{
         //console.log("此处有问题");
         ////return this.$message.error("查询数据失败！");
       });
    ...
    getTableData51(){
       ...
       axios({
         ...
         // _this.tableData=res.data;
          ...
          _this.tableData51 = totalTableData;
          ////console.log(_this.tableData51);
       }).catch(err=>{
         //console.log("此处有问题");
         ////return this.$message.error("查询数据失败！");
       });
       ...
       axios({
          ...
          if(totalTableData.length != 0){
            ...
            for(var i=0; i<totalTableData.length; i++){
              ...
              if(totalTableData[i].field_14_2 === ''){
                totalTableData[i].field_14_2 = 0;
              }
              num8 = _this.add(num8*1+totalTableData[i].field_14_2*1);
             
            };
            //各品种面积总和
            ////console.log('1111');
            total[0]=num1;total[1]=num2;total[2]=num3;total[3]=num4;total[4]=num5;total[5]=num6;total[6]=num7;total[7]=num8;
            ////console.log(total);
            var dataLength = totalTableData.length;
            for(var i=0; i<total.length; i++){
              if(total[i] === 0){
            ...
            totalTableData.push({"field_1":'合计',"field_2":'--',"field_3":'--',"field_4":'--',"field_5":'--',"field_6":'--',
                                ...
                                "field_13_1":'--',"field_13_2":sums[6],"field_14_1":'--',"field_14_2":sums[7],
                                "in_use":'--'})
          }else{
          };
          _this.tableData61 = totalTableData;
          ////console.log(_this.tableData61);
       }).catch(err=>{
         //console.log("此处有问题");
         ////return this.$message.error("查询数据失败！");
       });
    ...
    getTableData62(){ 
       ...
       axios({
          ...
          _this.tableData62 = totalTableData;
          ////console.log(_this.tableData62);
       }).catch(err=>{
         //console.log("此处有问题");
         ////return this.$message.error("查询数据失败！");
       });
    ...
    getTableData63(){ 
       ...
       axios({
          ...
          _this.tableData63 = totalTableData;
          ////console.log(_this.tableData63);
       }).catch(err=>{
         //console.log("此处有问题");
         ////return this.$message.error("查询数据失败！");
       });
    ...
    getTableData64(){ 
       ...
       axios({
         ...
         method:'post',
          ...
          _this.tableData64 = totalTableData;
          ////console.log(_this.tableData64);
       }).catch(err=>{
         //console.log("此处有问题");
         ////return this.$message.error("查询数据失败！");
       });
    ...
    getTableData65(){ 
       ...
       axios({
          ...
          _this.tableData65 = totalTableData;
          ////console.log(_this.tableData65);
       }).catch(err=>{
         //console.log("此处有问题");
         ////return this.$message.error("查询数据失败！");
       });
       ...
       axios({
         ...
         // _this.tableData=res.data;
          ...
          if(totalTableData.length != 0){
            ...
            var num11=0;var num12=0;var num13=0;var num14=0;var num15=0;var num16=0;var num17=0;var num18=0;var num19=0;var num20=0;
            var num21=0;var num22=0;var num23=0;var num24=0;var num25=0;var num26=0;var num27=0;var num28=0;var num29=0;var num30=0;
            var num31=0;var num32=0;var num33=0;var num34=0;var num35=0;var num36=0;var num37=0;
            //合计行计算
            for(var i=0; i<totalTableData.length; i++){
              if(totalTableData[i].field_3 === ''){
                totalTableData[i].field_3 = 0;
              ...
              num2 = _this.add(num2*1+totalTableData[i].field_4_1*1);

              if(totalTableData[i].field_4_2 === ''){
                totalTableData[i].field_4_2 = 0;
              }
              num3 = _this.add(num3*1+totalTableData[i].field_4_2*1);

              if(totalTableData[i].field_4_3 === ''){
                totalTableData[i].field_4_3 = 0;
              }
              num4 = _this.add(num4*1+totalTableData[i].field_4_3*1);

              if(totalTableData[i].field_4_4 === ''){
                totalTableData[i].field_4_4 = 0;
              }
              num5 = _this.add(num5*1+totalTableData[i].field_4_4*1);

              if(totalTableData[i].field_4_5 === ''){
                totalTableData[i].field_4_5 = 0;
              }
              num6 = _this.add(num6*1+totalTableData[i].field_4_5*1);

              if(totalTableData[i].field_4_6 === ''){
                totalTableData[i].field_4_6 = 0;
              }
              num7 = _this.add(num7*1+totalTableData[i].field_4_6*1);

              if(totalTableData[i].field_5_1 === ''){
                totalTableData[i].field_5_1 = 0;
              }
              num8 = _this.add(num8*1+totalTableData[i].field_5_1*1);

              if(totalTableData[i].field_5_2 === ''){
                totalTableData[i].field_5_2 = 0;
              }
              num9 = _this.add(num9*1+totalTableData[i].field_5_2*1);

              if(totalTableData[i].field_5_3 === ''){
                totalTableData[i].field_5_3 = 0;
              }
              num10 = _this.add(num10*1+totalTableData[i].field_5_3*1);

              if(totalTableData[i].field_5_4 === ''){
                totalTableData[i].field_5_4 = 0;
              }
              num11 = _this.add(num11*1+totalTableData[i].field_5_4*1);

              if(totalTableData[i].field_5_5 === ''){
                totalTableData[i].field_5_5 = 0;
              }
              num12 = _this.add(num12*1+totalTableData[i].field_5_5*1);

              if(totalTableData[i].field_5_6 === ''){
                totalTableData[i].field_5_6 = 0;
              }
              num13 = _this.add(num13*1+totalTableData[i].field_5_6*1);

              if(totalTableData[i].field_6_1 === ''){
                totalTableData[i].field_6_1 = 0;
              }
              num14 = _this.add(num14*1+totalTableData[i].field_6_1*1);

              if(totalTableData[i].field_6_2 === ''){
                totalTableData[i].field_6_2 = 0;
              }
              num15 = _this.add(num15*1+totalTableData[i].field_6_2*1);

              if(totalTableData[i].field_6_3 === ''){
                totalTableData[i].field_6_3 = 0;
              }
              num16 = _this.add(num16*1+totalTableData[i].field_6_3*1);

              if(totalTableData[i].field_6_4 === ''){
                totalTableData[i].field_6_4 = 0;
              }
              num17 = _this.add(num17*1+totalTableData[i].field_6_4*1);

              if(totalTableData[i].field_6_5 === ''){
                totalTableData[i].field_6_5 = 0;
              }
              num18 = _this.add(num18*1+totalTableData[i].field_6_5*1);

              if(totalTableData[i].field_6_6 === ''){
                totalTableData[i].field_6_6 = 0;
              }
              num19 = _this.add(num19*1+totalTableData[i].field_6_6*1);

              if(totalTableData[i].field_7_1 === ''){
                totalTableData[i].field_7_1 = 0;
              }
              num20 = _this.add(num20*1+totalTableData[i].field_7_1*1);
              
              if(totalTableData[i].field_7_2 === ''){
                totalTableData[i].field_7_2 = 0;
              }
              num21 = _this.add(num21*1+totalTableData[i].field_7_2*1);

              if(totalTableData[i].field_7_3 === ''){
                totalTableData[i].field_7_3 = 0;
              }
              num22 = _this.add(num22*1+totalTableData[i].field_7_3*1);

              if(totalTableData[i].field_7_4 === ''){
                totalTableData[i].field_7_4 = 0;
              }
              num23 = _this.add(num23*1+totalTableData[i].field_7_4*1);

              if(totalTableData[i].field_7_5 === ''){
                totalTableData[i].field_7_5 = 0;
              }
              num24 = _this.add(num24*1+totalTableData[i].field_7_5*1);

              if(totalTableData[i].field_7_6 === ''){
                totalTableData[i].field_7_6 = 0;
              }
              num25 = _this.add(num25*1+totalTableData[i].field_7_6*1);

              if(totalTableData[i].field_8_1 === ''){
                totalTableData[i].field_8_1 = 0;
              }
              num26 = _this.add(num26*1+totalTableData[i].field_8_1*1);

              if(totalTableData[i].field_8_2 === ''){
                totalTableData[i].field_8_2 = 0;
              }
              num27 = _this.add(num27*1+totalTableData[i].field_8_2*1);

              if(totalTableData[i].field_8_3 === ''){
                totalTableData[i].field_8_3 = 0;
              }
              num28 = _this.add(num28*1+totalTableData[i].field_8_3*1);

              if(totalTableData[i].field_8_4 === ''){
                totalTableData[i].field_8_4 = 0;
              }
              num29 = _this.add(num29*1+totalTableData[i].field_8_4*1);

              if(totalTableData[i].field_8_5 === ''){
                totalTableData[i].field_8_5 = 0;
              }
              num30 = _this.add(num30*1+totalTableData[i].field_8_5*1);

              if(totalTableData[i].field_8_6 === ''){
                totalTableData[i].field_8_6 = 0;
              }
              num31 = _this.add(num31*1+totalTableData[i].field_8_6*1);

              if(totalTableData[i].field_9_1 === ''){
                totalTableData[i].field_9_1 = 0;
              }
              num32 = _this.add(num32*1+totalTableData[i].field_9_1*1);

              if(totalTableData[i].field_9_2 === ''){
                totalTableData[i].field_9_2 = 0;
              }
              num33 = _this.add(num33*1+totalTableData[i].field_9_2*1);

              if(totalTableData[i].field_9_3 === ''){
                totalTableData[i].field_9_3 = 0;
              }
              num34 = _this.add(num34*1+totalTableData[i].field_9_3*1);

              if(totalTableData[i].field_9_4 === ''){
                totalTableData[i].field_9_4 = 0;
              }
              num35 = _this.add(num35*1+totalTableData[i].field_9_4*1);

              if(totalTableData[i].field_9_5 === ''){
                totalTableData[i].field_9_5 = 0;
              }
              num36 = _this.add(num36*1+totalTableData[i].field_9_5*1);

              if(totalTableData[i].field_9_6 === ''){
                totalTableData[i].field_9_6 = 0;
              }
              num37 = _this.add(num37*1+totalTableData[i].field_9_6*1);
            };
            //各品种面积总和
            ////console.log('1111');
            sums2[0]=num2;sums2[1]=num8;sums2[2]=num14;sums2[3]=num20;sums2[4]=num26;sums2[5]=num32;
            ...
            total[10]=num15;total[11]=num16;total[12]=num17;total[13]=num18;total[14]=num19;   total[15]=num21;total[16]=num22;total[17]=num23;total[18]=num24;total[19]=num25;
            total[20]=num27;total[21]=num28;total[22]=num29;total[23]=num30;total[24]=num31;   total[25]=num33;total[26]=num34;total[27]=num35;total[28]=num36;total[29]=num37;
            ////console.log(total);
            var dataLength = totalTableData.length;
            for(var i=0; i<total.length; i++){
              if(num1===0){
          ...
          _this.tableData71 = totalTableData;
          ////console.log(_this.tableData71);
       }).catch(err=>{
         //console.log("此处有问题");
         ////return this.$message.error("查询数据失败！");
       });
         ...
         // _this.tableData=res.data;
          ...
          if(totalTableData.length != 0){
            ...
            for(var i=0; i<totalTableData.length; i++){
              ...
              num6 = _this.add(num6*1+totalTableData[i].field_8_2_1*1);

              if(totalTableData[i].field_9_2_1 === ''){
                totalTableData[i].field_9_2_1 = 0;
              }
              num7 = _this.add(num7*1+totalTableData[i].field_9_2_1*1);

              if(totalTableData[i].field_10_1 === ''){
                totalTableData[i].field_10_1 = 0;
              }
              num8 = _this.add(num8*1+totalTableData[i].field_10_1*1);

              if(totalTableData[i].field_10_2 === ''){
                totalTableData[i].field_10_2 = 0;
              }
              num9 = _this.add(num9*1+totalTableData[i].field_10_2*1);
              ...
              num12 = _this.add(num12*1+totalTableData[i].field_10_5*1);

              if(totalTableData[i].field_10_6 === ''){
                totalTableData[i].field_10_6 = 0;
              }
              num13 = _this.add(num13*1+totalTableData[i].field_10_6*1);

            };
            //各品种面积总和
            ////console.log('1111');
            sums2[0]=num8;sums2[1]=num9;sums2[2]=num10;sums2[3]=num11;sums2[4]=num12;sums2[5]=num13;
            total[0]=num2;total[1]=num3;total[2]=num4;total[3]=num5;total[4]=num6; total[5]=num7;
            ////console.log(total);
            var dataLength = totalTableData.length;
            for(var i=0; i<6; i++){
              if(num1===0){
            ...
            totalTableData.push({"field_1":'合计',"field_2":'--',"field_3":num1,
                                ...
                                "field_8_1":'--',"field_8_2_1":total[4],"field_8_2_2":sums1[4],"field_9_1":'--',"field_9_2_1":total[5],"field_9_2_2":sums1[5],
                                "field_10_1":sums2[0],"field_10_2":mean[1],"field_10_3":mean[2],"field_10_4":mean[3],"field_10_5":mean[4],"field_10_6":mean[5],
                                "in_use":'--'})
          }else{
          }; 
          _this.tableData72 = totalTableData;
          ////console.log(_this.tableData72);
       }).catch(err=>{
         //console.log("此处有问题");
         ////return this.$message.error("查询数据失败！");
       });
    ...
    getTableData73(){ 
       ...
       axios({
         ...
         // _this.tableData=res.data;
          ...
          _this.tableData73 = totalTableData;
          ////console.log(_this.tableData73);
       }).catch(err=>{
         //console.log("此处有问题");
         ////return this.$message.error("查询数据失败！");
       });
    ...
    getTableData81(){ 
       ...
       axios({
         ...
         if(tempData.length != 0){
          ...
          _this.tableData81 = tempData;
          ////console.log("表8-1："+ _this.tableData81);
       }).catch(err=>{
         //console.log("此处有问题");
         ////return this.$message.error("查询数据失败！");
       });
    ...
    getTableData91(){ 
       ...
       axios({
          ...
          _this.tableData91 = res.data;
          ////console.log(_this.tableData91);
       }).catch(err=>{
         //console.log("此处有问题");
         //return this.$message.error("查询数据失败！");
       });
    ...
    getTableData92(){ 
       const _this = this;
       ////console.log("时间："+this.currentYear,this.previousYear,this.nian);
       axios({
          url: '/getRiceTable92',
          method:'post',
    ...
    getTableData93(){ 
       ...
       axios({
          ...
          _this.tableData93 = totalTableData;
          ////console.log(_this.tableData93);
       }).catch(err=>{
         //console.log("此处有问题");
         ////return this.$message.error("查询数据失败！");
       });
    ...
    getTableData94(){ 
       ...
       axios({
          ...
          _this.tableData94 = totalTableData;
          ////console.log(_this.tableData94);
       }).catch(err=>{
         //console.log("此处有问题");
         ////return this.$message.error("查询数据失败！");
       });
       ...
       axios({
          ...
          if(totalTableData.length != 0){
            ...
            for(var i=0; i<totalTableData.length; i++){
              ...
              num1 = (Number(totalTableData[i].field_7) + Number(num1));

              if(totalTableData[i].field_8 === ''){
                totalTableData[i].field_8 = 0;
              }
              num2 = Number(totalTableData[i].field_8) + Number(num2);

              if(totalTableData[i].field_9_1 === ''){
                totalTableData[i].field_9_1 = 0;
              }
              num3 = Number(totalTableData[i].field_9_1) + Number(num3);

              if(totalTableData[i].field_9_2 === ''){
                totalTableData[i].field_9_2 = 0;
              }
              num4 = Number(totalTableData[i].field_9_2) + Number(num4);

              if(totalTableData[i].field_9_3 === ''){
                totalTableData[i].field_9_3 = 0;
              }
              num5 = Number(totalTableData[i].field_9_3) + Number(num5);

              if(totalTableData[i].field_9_4 === ''){
                totalTableData[i].field_9_4 = 0;
              }
              num6 = Number(totalTableData[i].field_9_4) + Number(num6);

              if(totalTableData[i].field_9_5 === ''){
                totalTableData[i].field_9_5 = 0;
              }
              num7 = Number(totalTableData[i].field_9_5) + Number(num7);

              if(totalTableData[i].field_12 === ''){
                totalTableData[i].field_12 = 0;
              }
              num8 = Number(totalTableData[i].field_12) + Number(num8);

              if(totalTableData[i].field_13 === ''){
                totalTableData[i].field_13 = 0;
              }
              num9 = Number(totalTableData[i].field_13) + Number(num9);
          ...
          _this.tableData95 = totalTableData;
          ////console.log(_this.tableData95);
       }).catch(err=>{
         //console.log("此处有问题");
         ////return this.$message.error("查询数据失败！");
       });
    ...
    getTableData96(){ 
       ...
       axios({
         ...
         // _this.tableData=res.data;
          ...
          _this.tableData96 = totalTableData;
          ////console.log(_this.tableData96);
       }).catch(err=>{
         //console.log("此处有问题");
         ////return this.$message.error("查询数据失败！");
       });
    ...
    getTableData97(){ 
       ...
       axios({
          ...
          _this.tableData97 = totalTableData;
          ////console.log(_this.tableData97);
       }).catch(err=>{
         //console.log("此处有问题");
         ////return this.$message.error("查询数据失败！");
       });
       ...
       axios({
          ...
          if(totalTableData.length != 0){
            ...
            for(var i=0; i<totalTableData.length; i++){
              ...
              num1 = _this.add(num1*1+totalTableData[i].field_6_2*1);

              if(totalTableData[i].field_7_2 === ''){
                totalTableData[i].field_7_2 = 0;
              }
              num2 = _this.add(num2*1+totalTableData[i].field_7_2*1);

              if(totalTableData[i].field_7_3 === ''){
                totalTableData[i].field_7_3 = 0;
              }
              num3 = _this.add(num3*1+totalTableData[i].field_7_3*1);
              ...
              num6 = _this.add(num6*1+totalTableData[i].field_9_2*1);
              ...
              num8 = _this.add(num8*1+totalTableData[i].field_10_2*1);

              if(totalTableData[i].field_10_3 === ''){
                totalTableData[i].field_10_3 = 0;
              }
              num9 = _this.add(num9*1+totalTableData[i].field_10_3*1);

              if(totalTableData[i].field_11_2 === ''){
                totalTableData[i].field_11_2 = 0;
              }
              num10 = _this.add(num10*1+totalTableData[i].field_11_2*1);

              if(totalTableData[i].field_11_3 === ''){
                totalTableData[i].field_11_3 = 0;
              }
              num11 = _this.add(num11*1+totalTableData[i].field_11_3*1);
            ...
            //辅助数组
            totalTableData.push({"field_1":'合计',"field_2":'--',"field_3":'--',"field_4":'--',"field_5":'--',
                                "field_6_1":'--',"field_6_2":sums[0],"field_7_1":'--',"field_7_2":sums[1],"field_7_3":sums[2],
                                "field_8_1":'--',"field_8_2":sums[3],"field_8_3":sums[4],"field_9_1":'--',"field_9_2":sums[5],"field_9_3":sums[6],
                                "field_10_1":'--',"field_10_2":sums[7],"field_10_3":sums[8],"field_11_1":'--',"field_11_2":sums[9],"field_11_3":sums[10],
                                
                                "in_use":'--'})
          }else{
          }; 
          _this.tableData101 = totalTableData;
          ////console.log(_this.tableData101);
       }).catch(err=>{
         //console.log("此处有问题");
         ////return this.$message.error("查询数据失败！");
       });
    ...
    handleDownload31() {
      // this.downloadLoading = true // 加载遮罩层开启
      ////console.log("11111");
      var tableName=this.nian + "年度监测县(市、区)水稻播栽进度调查表"
      const {export_json_to_excel} = require('../excel/Export2Excel2'); //引入文件
      ////console.log("2222")
      const th1 = [[tableName, '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', ''],
                    ['县（市、区）', '地区类型', '全县总面积（万亩）', '开始播种日期', '', '秧田面积（万亩）', '', '', '折合大田面积（万亩）', '', '', '', '播栽期进度1', '', '', '', '', '', '', '播栽期进度2', '', '', '', '', '', '', '播栽期进度3', '', '', '', '', '', '', '播栽期进度4', '', '', '', '']] //对应表格一级输出的title
      const header = []//三级
      ...
      const filterVal = ['field_1', 'field_2', 'field_3', 'field_4_1', 'field_4_2', 'field_5', 'field_6_1', 'field_6_2', 'field_7_1', 'field_7_2', 'field_8_1', 'field_8_2', 'field_9_1', 'field_9_2_1', 'field_9_2_2', 'field_9_3', 'field_9_4', 'field_9_5', 'field_9_6', 'field_10_1','field_10_2_1', 'field_10_2_2', 'field_10_3', 'field_10_4', 'field_10_5', 'field_10_6', 'field_11_1', 'field_11_2_1', 'field_11_2_2', 'field_11_3', 'field_11_4', 'field_11_5', 'field_11_6', 'field_12_1', 'field_12_2', 'field_12_3', 'field_12_4', 'field_12_5'] // 对应表格tableData输出的数据
      ////console.log("th1:"+th1,"th2:"+th2,"filterVal:"+filterVal);
      //进行所有表头的单元格合并，建议一行一行来，不然容易整乱
      const merges = [
        "A1:AL1",
    ...
    handleDownload32() {
      // this.downloadLoading = true // 加载遮罩层开启
      ////console.log("11111");
      var tableName=this.nian + "年度监测县(市、区)水稻苗情评价动态列表（移栽稻）"
      const {export_json_to_excel} = require('../excel/Export2Excel2'); //引入文件
      ////console.log("2222")
      const th1 = [[tableName, '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '','', '', '', '', '', '', '', '', '', '','', '', '', '', '', '', '', '', '', '',''],
                    ['县（市、区）', '地区类型', '全县总面积（万亩）', '进程1', '', '', '', '', '', '', '进程2', '', '', '', '', '', '', '进程3', '', '', '', '', '', '', '进程4', '', '', '', '', '', '', '进程5', '', '', '', '', '', '','进程6', '', '', '', '', '', '', '进程7', '', '','', '', '', '', '进程8', '', '', '', '', '','']] //对应表格一级输出的title
      const header = []//三级
      const th2 =  [['', '', '', '日期', '一类苗（万亩）', '', '二类苗（万亩）', '', '三类苗（万亩）', '','日期', '一类苗（万亩）', '', '二类苗（万亩）', '', '三类苗（万亩）', '','日期', '一类苗（万亩）', '', '二类苗（万亩）', '', '三类苗（万亩）', '','日期', '一类苗（万亩）', '', '二类苗（万亩）', '', '三类苗（万亩）', '','日期', '一类苗（万亩）', '', '二类苗（万亩）', '', '三类苗（万亩）', '','日期', '一类苗（万亩）', '', '二类苗（万亩）', '', '三类苗（万亩）', '','日期', '一类苗（万亩）', '', '二类苗（万亩）', '', '三类苗（万亩）', '','日期', '一类苗（万亩）', '', '二类苗（万亩）', '', '三类苗（万亩）', '',]] //对应表格三级输出的title
      const filterVal = ['field_1', 'field_2', 'field_3', 'field_4_1', 'field_4_2_1', 'field_4_2_2', 'field_4_3_1', 'field_4_3_2', 'field_4_4_1', 'field_4_4_2', 'field_5_1', 'field_5_2_1', 'field_5_2_2', 'field_5_3_1', 'field_5_3_2', 'field_5_4_1', 'field_5_4_2', 'field_6_1', 'field_6_2_1', 'field_6_2_2', 'field_6_3_1', 'field_6_3_2', 'field_6_4_1', 'field_6_4_2', 'field_7_1', 'field_7_2_1', 'field_7_2_2', 'field_7_3_1', 'field_7_3_2', 'field_7_4_1', 'field_7_4_2', 'field_8_1', 'field_8_2_1', 'field_8_2_2', 'field_8_3_1', 'field_8_3_2', 'field_8_4_1', 'field_8_4_2','field_9_1', 'field_9_2_1', 'field_9_2_2', 'field_9_3_1', 'field_9_3_2', 'field_9_4_1', 'field_9_4_2', 'field_10_1', 'field_10_2_1', 'field_10_2_2','field_10_3_1', 'field_10_3_2', 'field_10_4_1', 'field_10_4_2', 'field_11_1', 'field_11_2_1', 'field_11_2_2', 'field_11_3_1', 'field_11_3_2', 'field_11_4_1','field_11_4_2'] // 对应表格tableData输出的数据
      ////console.log("th1:"+th1,"th2:"+th2,"filterVal:"+filterVal);
      //进行所有表头的单元格合并，建议一行一行来，不然容易整乱
      const merges = [
        "A1:BG1",
    ...
    handleDownload33() {
      // this.downloadLoading = true // 加载遮罩层开启
      ////console.log("11111");
      var tableName=this.nian + "年度监测县(市、区)水稻苗情评价动态列表（直播稻）"
      const {export_json_to_excel} = require('../excel/Export2Excel2'); //引入文件
      ////console.log("2222")
      const th1 = [[tableName, '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '','', '', '', '', '', '', '', '', '', '','', '', '', '', '', '', '', '', '', '','', '', '', '', '', '', '',''],
                    ['县（市、区）', '地区类型', '全县总面积（万亩）', '进程1', '', '', '', '', '', '', '进程2', '', '', '', '', '', '', '进程3', '', '', '', '', '', '', '进程4', '', '', '', '', '', '', '进程5', '', '', '', '', '', '','进程6', '', '', '', '', '', '', '进程7', '', '','', '', '', '', '进程8', '', '', '', '', '', '', '进程9', '', '', '', '', '','']] //对应表格一级输出的title
      const header = []//三级
      const th2 =  [['', '', '', '日期', '一类苗（万亩）', '', '二类苗（万亩）', '', '三类苗（万亩）', '','日期', '一类苗（万亩）', '', '二类苗（万亩）', '', '三类苗（万亩）', '','日期', '一类苗（万亩）', '', '二类苗（万亩）', '', '三类苗（万亩）', '','日期', '一类苗（万亩）', '', '二类苗（万亩）', '', '三类苗（万亩）', '','日期', '一类苗（万亩）', '', '二类苗（万亩）', '', '三类苗（万亩）', '','日期', '一类苗（万亩）', '', '二类苗（万亩）', '', '三类苗（万亩）', '','日期', '一类苗（万亩）', '', '二类苗（万亩）', '', '三类苗（万亩）', '','日期', '一类苗（万亩）', '', '二类苗（万亩）', '', '三类苗（万亩）', '','日期', '一类苗（万亩）', '', '二类苗（万亩）', '', '三类苗（万亩）', '',]] //对应表格三级输出的title
      const filterVal = ['field_1', 'field_2', 'field_3', 'field_4_1', 'field_4_2_1', 'field_4_2_2', 'field_4_3_1', 'field_4_3_2', 'field_4_4_1', 'field_4_4_2', 'field_5_1', 'field_5_2_1', 'field_5_2_2', 'field_5_3_1', 'field_5_3_2', 'field_5_4_1', 'field_5_4_2', 
                         'field_6_1', 'field_6_2_1', 'field_6_2_2', 'field_6_3_1', 'field_6_3_2', 'field_6_4_1', 'field_6_4_2', 'field_7_1', 'field_7_2_1', 'field_7_2_2', 'field_7_3_1', 'field_7_3_2', 'field_7_4_1', 'field_7_4_2',
                         'field_8_1', 'field_8_2_1', 'field_8_2_2', 'field_8_3_1', 'field_8_3_2', 'field_8_4_1', 'field_8_4_2','field_9_1', 'field_9_2_1', 'field_9_2_2', 'field_9_3_1', 'field_9_3_2', 'field_9_4_1', 'field_9_4_2', 
                         'field_10_1', 'field_10_2_1', 'field_10_2_2','field_10_3_1', 'field_10_3_2', 'field_10_4_1', 'field_10_4_2', 'field_11_1', 'field_11_2_1', 'field_11_2_2', 'field_11_3_1', 'field_11_3_2', 'field_11_4_1','field_11_4_2',
                          'field_12_1', 'field_12_2_1', 'field_12_2_2', 'field_12_3_1', 'field_12_3_2', 'field_12_4_1','field_12_4_2'] // 对应表格tableData输出的数据
      ////console.log("th1:"+th1,"th2:"+th2,"filterVal:"+filterVal);
      //进行所有表头的单元格合并，建议一行一行来，不然容易整乱
      const merges = [
        "A1:BN1",
    ...
    handleDownload41() {
      ...
      const th1 = [[tableName, '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '',''],
                    ...
                    '进程6', '', '', '','进程7', '', '', '','进程8', '', '', '','孕穗中期进程9', '', '', '', ]] //对应表格一级输出的title
      const header = []//三级
      const th2 =  [['', '', '', '', '', '', '', '日期', '叶龄(叶)', '基本苗（万/亩）', '亩穴数（万）',
                     ...
                     '日期', '叶龄(叶)', '基本苗（万/亩）', '亩穴数（万）', 
                     '日期', '叶龄(叶)', '基本苗（万/亩）', '亩穴数（万）',  
                     '日期', '叶龄(叶)', '基本苗（万/亩）', '亩穴数（万）', ]] //对应表格三级输出的title
      const filterVal = ['field_1', 'field_2', 'field_3', 'field_4', 'field_5', 'field_6', 'field_7',
                        ...
                        'field_14_1', 'field_14_2', 'field_14_3', 'field_14_4', 'field_15_1','field_15_2', 'field_15_3','field_15_4',
                        'field_16_1', 'field_16_2', 'field_16_3', 'field_16_4','field_17_1', 'field_17_2', 'field_17_3', 'field_17_4'] // 对应表格tableData输出的数据
      ////console.log("th1:"+th1,"th2:"+th2,"filterVal:"+filterVal);
      //进行所有表头的单元格合并，建议一行一行来，不然容易整乱
      const merges = [
        "A1:AU1",
    ...
    handleDownload42() {
      // this.downloadLoading = true // 加载遮罩层开启
      ////console.log("11111");
      var tableName=this.nian + "年度监测县(市、区)中稻生育进度调查表（直播稻）"
      const {export_json_to_excel} = require('../excel/Export2Excel2'); //引入文件
      ////console.log("2222")
      const th1 = [[tableName, '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', ''],
                    ['县（市、区）', '监测田块', '地区类型', '稻作类型', '品系类型', '品种名称', '栽培方式', '进程1', '', '', '','进程2', '', '', '','进程3', '', '', '','进程4', '', '', '','进程5', '', '', '',
                    '进程6', '', '', '','进程7', '', '', '','进程8', '', '', '','进程9', '', '', '', ]] //对应表格一级输出的title
      const header = []//三级
      const th2 =  [['', '', '', '', '', '', '',  
                     '日期', '叶龄(叶)', '基本苗（万/亩）', '亩穴数（万）', 
                     '日期', '叶龄(叶)', '基本苗（万/亩）', '亩穴数（万）', 
      ...
      const filterVal = ['field_1', 'field_2', 'field_3', 'field_4', 'field_5', 'field_6', 'field_7',
                        ...
                        'field_12_1', 'field_12_2', 'field_12_3', 'field_12_4', 'field_13_1','field_13_2', 'field_13_3','field_13_4',
                        'field_14_1', 'field_14_2', 'field_14_3', 'field_14_4', 'field_15_1','field_15_2', 'field_15_3','field_15_4',
                        'field_16_1', 'field_16_2', 'field_16_3', 'field_16_4'] // 对应表格tableData输出的数据
      ////console.log("th1:"+th1,"th2:"+th2,"filterVal:"+filterVal);
      //进行所有表头的单元格合并，建议一行一行来，不然容易整乱
      const merges = [
        "A1:AQ1",
    ...
    handleDownload43() {
      ...
      ////console.log("2222")
      const th1 = [[tableName, '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', ''],
                    ['县（市、区）', '监测田块', '地区类型', '稻作类型', '品系类型', '品种名称', '栽培方式', '目标产量(kg/亩)', '基本苗（万/亩）', '拔节期', '', '', '', '', '', '', '', '孕穗期（幼穗分化1-2期）', '', '', '', '', '孕穗期（幼穗分化3-4期）', '', '', '', '']] //对应表格一级输出的title
      const header = []//三级
      const th2 =  [['', '', '', '', '', '', '', '', '', '测定日期', '株高(cm)', '总茎蘖数(万/亩)', '平均单茎绿叶数', '倒4与倒3叶色比', '1叶分蘖个数', '2叶分蘖个数', '3叶及以上分蘖个数', '测定日期', '株高(cm)', '总茎蘖数(万/亩)', '平均单茎绿叶数', '倒4与倒3叶色比', '测定日期', '株高(cm)', '总茎蘖数(万/亩)', '平均单茎绿叶数', '倒4与倒3叶色比']] //对应表格三级输出的title
      const filterVal = ['field_1', 'field_2', 'field_3', 'field_4', 'field_5', 'field_6', 'field_7', 
    ...
    handleDownload61() {
      ...
      const th1 = [[tableName, '', '', '', '', '', '', '', '', '', '', '', '', '','', '', '', '', '', '', '', ''],
                    ['县（市、区）', '监测点代码', '地区类型', '稻作类型', '品种名称', '栽植方式', 
                    '时期1', '', '时期2', '', '时期3', '', '时期4', '',
                    '时期5', '', '时期6', '', '时期7', '', '时期8', '']] //对应表格一级输出的title
      const header = []//三级
      const th2 =  [['', '', '', '', '', '', 
                    '日期', '深度（cm）', '日期', '深度（cm）', '日期', '深度（cm）', 
                    '日期', '深度（cm）', '日期', '深度（cm）', '日期', '深度（cm）', 
                    '日期', '深度（cm）', '日期', '深度（cm）',]] //对应表格三级输出的title
      const filterVal = ['field_1', 'field_2', 'field_3', 'field_4', 'field_5', 'field_6', 
                    ...
                    'field_13_1', 'field_13_2','field_14_1', 'field_14_2',] // 对应表格tableData输出的数据
      ////console.log("th1:"+th1,"th2:"+th2,"filterVal:"+filterVal);
      //进行所有表头的单元格合并，建议一行一行来，不然容易整乱
      const merges = [
        "A1:V1",
    ...
    handleDownload71() {
      // this.downloadLoading = true // 加载遮罩层开启
      ////console.log("11111");
      var tableName=this.nian + "年度监测县(市、区)水稻单季稻苗情监测预测产表";
      const {export_json_to_excel} = require('../excel/Export2Excel2'); //引入文件
      ////console.log("2222")
      const th1 = [[tableName,'', '', 
                    '', '', '', '', '', '','', '', '', '', '', '','', '', '', '', '', '',
    ...
    handleDownload72() {
      // this.downloadLoading = true // 加载遮罩层开启
      ////console.log("11111");
      var tableName=this.nian + "年度监测县(市、区)水稻单季稻收获进度调查表";
      const {export_json_to_excel} = require('../excel/Export2Excel2'); //引入文件
      ////console.log("2222")
      const th1 = [[tableName, '', '', '', '', '', '', '', '', '', '', '', '', '', '','', '', '', '', '', '', '', '', '', '', '', ''],
                    ['县（市、区）', '地区类型', '总面积（万亩）', 
      ...
      const th2 =  [['', '', '', '日期', '收获面积（万亩）', '', '日期', '收获面积（万亩）', '', 
                    '日期', '收获面积（万亩）', '','日期', '收获面积（万亩）', '', '日期', '收获面积（万亩）', '','日期', '收获面积（万亩）', '',
                    '面积(万亩)', '亩有效穗(万)', '穗总粒数(个)', '结实率(％)', '千粒重(g)', '八五折理论产量(kg/亩)' ]] //对应表格三级输出的title
      const filterVal = ['field_1', 'field_2', 'field_3', 
                    ...
                    'field_8_1', 'field_8_2_1', 'field_8_2_2', 'field_9_1', 'field_9_2_1', 'field_9_2_2',
    ...
    handleDownload73() {
      // this.downloadLoading = true // 加载遮罩层开启
      ////console.log("11111");
      var tableName=this.nian + "年度监测县(市、区)水稻单季稻测产表";
      const {export_json_to_excel} = require('../excel/Export2Excel2'); //引入文件
      ////console.log("2222")
      const th1 = [[tableName, '','', '', '', '', '', '','', '', '', '', '', '','', '', '', '', '', '', '', '', '', '', '', '','', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '',],
                    ['县（市、区）', '地区类型',
    ...
    handleDownload81() {
      // this.downloadLoading = true // 加载遮罩层开启
      ////console.log("11111");
      var tableName=this.nian + "年度监测县(市、区)水稻生产成本效益统计表";
      const {export_json_to_excel} = require('../excel/Export2Excel2'); //引入文件
      ////console.log("2222")
      const th1 = [[tableName,'', '', '','','', '', '', '', '','', '', '', '', '', '', '', '', '', '', '', '','', '', '', '', '', '', '', '', '', '', '', '', '','', '', '', ''],
    ...
    handleDownload91() {
      // this.downloadLoading = true // 加载遮罩层开启
      ////console.log(this.tableData91);
      var tableName=this.nian + "年度监测县(市、区)气象资料表";
      const {export_json_to_excel} = require('../excel/Export2Excel2'); //引入文件
      ////console.log("2222")
      const th1 = [[tableName, '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '',  '', '', '', '', '', '', '', '',  '', '', '', '', '', '', '', '',  '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', ''],
                    ['县（市、区）', '1月份', '', '', '', '2月份', '', '', '', 
    ...
    handleDownload101() {
      // this.downloadLoading = true // 加载遮罩层开启
      ////console.log("11111");
      var tableName=this.nian + "年度水稻监测点灌浆速率调查表";
      const {export_json_to_excel} = require('../excel/Export2Excel2'); //引入文件
      ////console.log("2222")
      const th1 = [[tableName, '', '', '', '',
                    '', '', '', '', '', '', '', '','', '', '','', '', '','', '', '',],
                    ['县（市、区）', '监测点代码', '地区类型', '品种名称','栽植方式', 
                    '灌浆速率测定1（扬花）', '', 
                    '灌浆速率测定2（扬花+7天）', '', '', 
                    '灌浆速率测定3（扬花+14天）', '', '',
                    '灌浆速率测定4（扬花+21天）', '', '',
      ...
      const filterVal = ['field_1', 'field_2', 'field_3', 'field_4', 'field_5',
                    ...
                    'field_11_1', 'field_11_2', 'field_11_3', ] // 对应表格tableData输出的数据
      ////console.log("th1:"+th1,"th2:"+th2,"filterVal:"+filterVal);
      //进行所有表头的单元格合并，建议一行一行来，不然容易整乱
      const merges = [
        "A1:V1",
    ...
    handleDownloadTwo11() {
      ...
      const header = []//三级
      const th2 =  [['', '', '', '人工移栽', '', '机械插秧', '', '盘育抛栽', '', '无盘旱育抛栽', '', '撒直播(旱)', '', '撒直播(水)', '', '机条播(旱)', '', '机条播(水)', '', '小计', '', '水稻', '', '小麦', '', '油菜', '', '空闲田', '', '绿肥', '', '蔬菜等经作', '', '其它', '', '小计', '']] //对应表格三级输出的title
      const filterVal = ['field_1', 'field_2', 'field_3', 'field_4', 'field_5_1_1', 'field_5_1_2', 'field_5_2_1', 'field_5_2_2', 'field_5_3_1', 'field_5_3_2', 'field_5_4_1', 'field_5_4_2', 'field_5_5_1', 'field_5_5_2', 'field_5_6_1', 'field_5_6_2', 'field_5_7_1', 'field_5_7_2', 'field_5_8_1', 'field_5_8_2', 'field_5_9_1', 'field_5_9_2', 'field_6_1_1', 'field_6_1_2', 'field_6_2_1', 'field_6_2_2', 'field_6_3_1', 'field_6_3_2', 'field_6_4_1', 'field_6_4_2', 'field_6_5_1', 'field_6_5_2', 'field_6_6_1', 'field_6_6_2', 'field_6_7_1', 'field_6_7_2', 'field_6_8_1', 'field_6_8_2'] // 对应表格tableData输出的数据
      ////console.log("th1:"+th1,"th2:"+th2,"filterVal:"+filterVal);
      //进行所有表头的单元格合并，建议一行一行来，不然容易整乱
      const merges = [
        "A1:AK1",

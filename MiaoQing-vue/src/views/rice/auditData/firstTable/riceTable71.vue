              ...
              <div style="height:100px;margin-bottom:10px">
                <el-table :data="tableData" border :header-cell-style="headerStyle" :row-style="{height: '30px'}" :cell-style="{padding:'0',fontSize:'8px'}" row-key="id" stripe >
                    <el-table-column align="center" label="8月1-10日抽穗扬花的中稻">
                      ...
                      <el-table-column align="center" prop="field_5_6"  label="理论产量（kg/亩）" />
                    </el-table-column>
              ...
              <div style="height:100px;margin-bottom:10px">
                <el-table :data="tableData" border :header-cell-style="headerStyle" :row-style="{height: '30px'}" :cell-style="{padding:'0',fontSize:'8px'}" row-key="id" stripe >
                    ...
                    <el-table-column align="center" label="在8月21-31日抽穗扬花的中稻">
                      ...
                      <el-table-column align="center" prop="field_8_3"  label="穗总粒数（个）" />
                      <el-table-column align="center" prop="field_8_4" label="结实率（％）" />
                      <el-table-column align="center" prop="field_8_5" label="千粒重（g）" />
                      <el-table-column align="center" prop="field_8_6"  label="理论产量（kg/亩）" />
                    </el-table-column>
                </el-table>
              </div>
            </el-row>
              ...
              <div style="height:100px;margin-bottom:10px">
                <el-table :data="tableData" border :header-cell-style="headerStyle" :row-style="{height: '30px'}" :cell-style="{padding:'0',fontSize:'8px'}" row-key="id" stripe >
                    <el-table-column align="center" label="在9月上旬抽穗扬花的中稻">
                      ...
                      <el-table-column align="center" prop="field_9_6"  label="理论产量（kg/亩）" />
                    </el-table-column>
                </el-table>
              </div>
            </el-row>
...
export default {
  ...
  data() {
    return {        
      ...
      tableData: [],
      //表名
      tableLabel:'2021年度监测县(市、区)水稻单季稻苗情监测预测产表',

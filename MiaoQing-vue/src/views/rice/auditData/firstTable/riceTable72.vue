            ...
            <el-row>
              <div style="height:100px;margin-bottom:10px">
                <el-table :data="tableData" border :header-cell-style="headerStyle" :row-style="{height: '30px'}" :cell-style="{padding:'0',fontSize:'8px'}" row-key="id" stripe >
                    ...
                    <el-table-column align="center" prop="field_3" width="120%" label="总面积(万亩)" />
              ...
              <div style="height:100px;margin-bottom:10px">
                <el-table :data="tableData" border :header-cell-style="headerStyle" :row-style="{height: '30px'}" :cell-style="{padding:'0',fontSize:'8px'}" row-key="id" stripe >
                    ...
                    <el-table-column align="center" label="单季稻实测产">
                      ...
                      <el-table-column align="center" prop="field_10_3" width="130%" label="穗总粒数（个）" />
                      ...
                      <el-table-column align="center" prop="field_10_6" width="130%" label="产量（kg/亩）" />
                    </el-table-column>
                </el-table>
              </div>
            </el-row>
...
export default {
  ...
  data() {
    return {           
      ...
      tableData: [],
      //表名
      tableLabel:'2021年度监测县(市、区)水稻单季稻收获进度调查表',

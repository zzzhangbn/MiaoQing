          ...
          <el-card class="box-card">
            ...
            <div class="textAudit1">
              ...
              <div class="auditButtom1">
                <el-button type="info" size="medium"  icon="el-icon-search" @click="reportNotice"> 上 报 查 看</el-button>
              </div>
            </div>
            <div class="textAudit2">
              <div v-if="this.applyPoint!= 0 || this.applyPoint2!= 0">
                <div class="text2">
                  <span>当前监测点信息审核：</span>
                  <span v-if="this.applyPoint != 0">
                    <span>单季稻共</span>
                  ...
                  <span v-if="this.applyPoint == 0 && this.applyPoint2 ==0">暂无监测点信息审核</span>
                </div>
                <div class="auditButtom2">
                  <el-button type="info" size="medium" icon="el-icon-search" @click="auditPoint"> 信 息 审 核</el-button>
                </div>
              </div>
            </div>
            <!-- <div class="textAudit2">
          ...
          <div class="right_top" >
            <div class="top_right">
              <el-card shadow="hover" class="box-card">
                <div class="card1">
                  <el-select v-model="areaType"  clearable  placeholder="地区类型" class="select1" style="width:110px;height:50px">
                    <el-option
                  ...
                  <el-select v-model="county" clearable  style="width:125px; margin-left: 20px;height:50px" placeholder="县（市、区）" class="select2">
                    <el-option
                  ...
                  <el-select v-model="year" clearable  style="width:140px; margin-left: 20px;height:50px" placeholder="请选择查看年度" class="select3">
                    <el-option
                      v-for="item in years"
                      :key="item.value"
                      :label="item.label"
          ...
          <div class="right_bottom">
            ...
            <div class="process">
              <el-tabs v-model="activeName" @tab-click="handleClick">
                  <el-tab-pane label="单季稻生育期" name="1">
...
export default {
  ...
  methods: {
    ...
    getTableData2(){
       const _this = this;
       axios({
          url: '/getAllCountyNoAuditNumber2',
          method:'get',
       }).then(res=>{
           var temp=res.data;
           _this.twoData=temp;
    ...
    getNoAuditData(){
       ...
       for(var i=0;i<30;i++){
         ...
         for(var j=0; j<this.oneData.length;j++){
           if(this.oneCounty[i] === this.oneData[j]){
             num = parseInt(num)+1;
           }
         }
         oneTemp[i]=num;
       ...
       for(var i=0;i<6;i++){
         ...
         for(var j=0; j<this.twoData.length;j++){
           if(this.twoCounty[i] == this.twoData[j]){
             num++;
           }
         }
         twoTemp[i]=num;
    ...
    getReportData2(){
      ...
      axios({
        ...
        menthod:'get',
          ...
          ////console.log(res.data);
          var temp=res.data;
          _this.submitData2=res.data.length;
       }).catch(err=>{
         return this.$message.error("查询数据失败！");
       });
    },
              ...
              xAxis: [
                      {
                          ...
                          data: ['播种期', '出苗期', '移栽期', '分蘖期','够苗期', '有效分蘗临界叶龄期', '拔节期', '孕穗期', '抽穗期', '齐穗期', '成熟期']
                      }
                  ],
              yAxis: [
                  {

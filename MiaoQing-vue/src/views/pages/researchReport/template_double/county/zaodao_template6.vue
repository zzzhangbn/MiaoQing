      ...
      <div class="content" ref="content">
        ...
        <div>
          ...
          <p>
            ...
            产量结构三要素<input v-model="inputValues[0]" type="text" class="input" placeholder="输入增减态势" style="width:100px;background:none;border: none;border-bottom: 1px solid #000;font-size: 16px;outline: none;"> 。
...
export default {
  ...
  methods:{
    getData(){
      ...
      axios({
        url:'/templateTwo',
        params:{templateTwoName:'双季稻早稻测产结果',country:area},
        method:'get'
      }).then(res=>{
    ...
    saveReport(){
      ...
      this.$confirm('确定上传？').then(_=>{
        this.$refs.title.setAttribute('value',this.thisYear+'双季早稻测产结果');

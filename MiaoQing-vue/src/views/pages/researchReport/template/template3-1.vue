      ...
      <div class="content" ref="content">
        ...
        <div>
          ...
          <p style="font-size: 20px;line-height: 30px;">
            &nbsp;&nbsp;据农情调度，全省一季稻面积<input v-model="inputValues[0]" type="text" ref="input1" style="width:40px;background:none;border: none;border-bottom: 1px solid #000;font-size: 20px;outline: none;">万亩，
            与去年相比<input type="text" v-model="inputValues[1]" ref="input2" style="width:100px;border: none;background:none;border-bottom: 1px solid #000;font-size: 20px;outline: none;">万亩。
          ...
          <p style="font-size: 20px;line-height: 30px;">
            &nbsp;&nbsp;其中，8月上旬抽穗扬花的中籼稻，约 <u>{{reportData.data_4.area}}</u> 万亩左右，占 <u>{{reportData.data_4.percent}}</u>%，
            <input type="text" style="width:98%;" ref="input4" placeholder="请输入分布地区、前茬类型及当前天气对抽穗扬花的评价" v-model="inputValues[3]">
            &nbsp;&nbsp;据调查，平均亩有效穗<u>{{reportData.data_4.yxh}}</u> 万，每穗总粒数 <u>{{reportData.data_4.qls}}</u>粒，结实率 <u>{{reportData.data_4.jsl}}</u>%，

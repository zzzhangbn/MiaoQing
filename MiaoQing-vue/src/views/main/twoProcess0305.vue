<template>
    <div style="margin-left: 1%;">
        ...
        <div style="width: 89%;border: #C4C4C4 1.3px solid;margin-top: 30px;">
         ...
         <div style="width: 170px;height: 1.3px;background-color: #C1FFC1;margin-top: -0px;margin-left: 4%;"></div>
          ...
          <div style="margin-left: 1%;margin-top: 15px;margin-bottom: 1%;"><i class="el-icon-s-flag" style="color: #8B2323;"></i><span style="color:#5C5C5C;margin-left: 10px;font-size: 17px;">年度监测县(市、区)水稻苗情评价动态列表(晚稻-移栽)</span></div>
                ...
                <el-form :inline="true" ref="form"  label-width="180px">
                    <template v-if="currentStep == 0">
                        <el-form-item label="全县总面积(万亩)">
                            <template v-if="currentStep < tab2CurrentStep">
                                <el-input style="width: 220px;" v-model="tab2DataList[0].field_3" readonly></el-input>
                            </template>
                            <template v-else="currentStep >= tab2CurrentStep">
                                <el-input style="width: 220px;" v-model="tab2DataList[0].field_3"></el-input>
                            </template>
  ...
  export default{
      ...
      return {
        currentStep:0,//当前进程数
        maxStep:0,//最大进程数
        tab2CurrentStep:0,//表2   3-5当前进程，最大是7
    ...
    methods: {
        ...
        getFormList(e){
            this.$confirm('是否上报？').then(_ => {
                ...
                if(sum != this.tab2DataList[0].field_3){
        ...
        getPercent(field1,field2){
            this.tab2DataList[0][field2] = (Math.round((this.tab2DataList[0][field1]/this.tab2DataList[0].field_3) * 100*100)/100).toFixed(2)+'%';
        },
        // 获取当前时间
        getNowTime: function () {
              let dateTime
      ...
      getTab2CurrentStep(people){
        axios({
            ...
            res=>{
                ...
                // //console.log(this.tab2_1+":"+this.tab2_2_1+":"+this.tab2_2_2);

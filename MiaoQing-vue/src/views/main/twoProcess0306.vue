<template>
    <div style="margin-left: 1%;">
        ...
        <div style="width: 89%;border: #C4C4C4 1.3px solid;margin-top: 30px;">
         ...
         <div style="width: 170px;height: 1.3px;background-color: #C1FFC1;margin-top: -0px;margin-left: 4%;"></div>
          ...
          <div style="margin-left: 1%;margin-top: 15px;margin-bottom: 1%;"><i class="el-icon-s-flag" style="color: #8B2323;"></i><span style="color:#5C5C5C;margin-left: 10px;font-size: 17px;">年度监测县(市、区)水稻苗情评价动态列表(晚稻-直播)</span></div>
                ...
                <el-form :inline="true" ref="form"  label-width="180px">
                    <template v-if="currentStep == 0">
                        <el-form-item label="全县总面积（万亩）">
                            <template v-if="currentStep < tab3CurrentStep">
                                <el-input style="width: 220px;" v-model="tab3DataList[0].field_4" readonly></el-input>
                            </template>
                            <template v-else="currentStep >= tab3CurrentStep">
                                <el-input style="width: 220px;" v-model="tab3DataList[0].field_4"></el-input>
                            </template>
                    ...
                    <el-form-item label="一类苗（万亩）">
                        <template v-if="currentStep < tab3CurrentStep">
                            <el-input style="width: 220px;" v-model="tab3DataList[0][tab3_2_1]" readonly></el-input>
                        </template>
                        <template v-else="currentStep >= tab3CurrentStep">
                            <el-input style="width: 220px;" v-model="tab3DataList[0][tab3_2_1]"  @blur="getPercent(tab3_2_1,tab3_2_2)"></el-input>
                        </template>
                    </el-form-item>
                    <el-form-item label="一类苗/全县总面积">
                        <el-input style="width: 220px;" v-model="tab3DataList[0][tab3_2_2]" readonly></el-input>
                    </el-form-item>
                    <el-form-item label="二类苗（万亩）">
                        <template v-if="currentStep < tab3CurrentStep">
                            <el-input style="width: 220px;" v-model="tab3DataList[0][tab3_3_1]" readonly></el-input>
                        </template>
                        <template v-else="currentStep >= tab3CurrentStep">
                            <el-input style="width: 220px;" v-model="tab3DataList[0][tab3_3_1]" @blur="getPercent(tab3_3_1,tab3_3_2)"></el-input>
                        </template>
                    </el-form-item>
                    <el-form-item label="二类苗/全县总面积">
                        <el-input style="width: 220px;" v-model="tab3DataList[0][tab3_3_2]" readonly></el-input>
                    </el-form-item>
                    <el-form-item label="三类苗（万亩）">
                        <template v-if="currentStep < tab3CurrentStep">
                            <el-input style="width: 220px;" v-model="tab3DataList[0][tab3_4_1]" readonly></el-input>
                        </template>
                        <template v-else="currentStep >= tab3CurrentStep">
                            <el-input style="width: 220px;" v-model="tab3DataList[0][tab3_4_1]" @blur="getPercent(tab3_4_1,tab3_4_2)"></el-input>
                        </template>
                    </el-form-item>
                    <el-form-item label="三类苗/全县总面积">
                        <el-input style="width: 220px;" v-model="tab3DataList[0][tab3_4_2]" readonly></el-input>
                    </el-form-item>
                    </el-form>
                </template>
            </template>
  ...
  export default{
      ...
      return {
        currentStep:0,//当前进程数
        maxStep:0,//最大进程数
        tab3CurrentStep:0,//表3   3-6当前进程，最大是9
        tab3DataList:[],//保存表3 - 年度监测县(市、区)水稻苗情评价动态列表(早稻-直播) 的数据
        tab3_1:'',//表3的字段绑定
        tab3_2_1:'',
        tab3_2_2:'',
        tab3_3_1:'',
        ...
        tab3_4_2:'',
        // 步骤标题
      stepTitle: ['进程1','进程2', '进程3', '进程4', '进程5','进程6','进程7','进程8','进程9'],
        form: {
            name: '',
            region: '',
            date1: '',
    ...
    methods: {
        ...
        getFormList(e){
            this.$confirm("是否上报？").then(_=>{
                ...
                //判断所填的占比是否为100%
                var sum = Number(this.tab3DataList[0][this.tab3_2_1]) + Number(this.tab3DataList[0][this.tab3_3_1]) + Number(this.tab3DataList[0][this.tab3_4_1]);
                if(sum != this.tab3DataList[0].field_4){
        ...
        getPercent(field1,field2){
            this.tab3DataList[0][field2] = (Math.round((this.tab3DataList[0][field1]/this.tab3DataList[0].field_4) * 100*100)/100).toFixed(2)+'%';
        },
        // 获取当前时间
        getNowTime: function () {
              let dateTime
        ...
        handleStep(index){
            ...
            if(index <= this.maxStep){
                ...
                if(this.currentStep <= this.tab3CurrentStep){
                    var gap3 = 5 + index;//表3-6 的进程绑定 OK
                    ...
                    // //console.log(this.tab3_1+":"+this.tab3_2_1+":"+this.tab3_2_2+":"+this.tab3_3_1+":"+this.tab3_3_2+":"+this.tab3_4_1+":"+this.tab3_4_2);
        ...
        axios({
            ...
            res=>{
                ...
                if(this.tab3DataList.length > 0){
                    ...
                    if(this.tab3CurrentStep == 9){
                        this.tab3CurrentStep = this.tab3CurrentStep -1;
                    }
                    var gap = 5 + this.tab3CurrentStep;
                    this.tab3_1 = "field_"+gap+"_1";

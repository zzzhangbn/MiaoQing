<template>
    <div style="margin-left: 1%;">
        <div style="width: 98%;height: 50px;">
            <span style="font-size: 20px;color: rgb(0, 102, 102);margin-right: 48%;">年度监测县(市、区)水稻苗情评价动态列表（直播稻）</span>
                ...
                <el-collapse-item  :name="tableList.length-index-1" :title=stepTitle[tableList.length-index-1]>
                        <el-form :inline="true"  label-width="180px">
                            <template v-if="tableList.length-index-1 == 0">
                                ...
                                <el-input  v-model="tab3DataList.field_3" align="right"
                            ...
                            <el-form-item label="一类苗（万亩）">
                                    ...
                                    :disabled="copyData[item.field2] != null && copyData[item.field2] != ''"></el-input>
                            ...
                            <el-form-item label="三类苗（万亩）">
                                    ...
                                    :disabled="copyData[item.field6] != null && copyData[item.field6] != ''"></el-input>
  ...
  export default{
    ...
    methods: {
        clearInput(){//改变全县总面积，清空所有输入框
            var start = 4+this.tab3CurrentStep;
        ...
        getFormList(e){
                ...
                && this.tab3DataList[str1]!=''&& this.tab3DataList[str3]!=null && this.tab3DataList[str3]!=''&& this.tab3DataList[str5]!=null&& this.tab3DataList[str5]!=''){
                    ...
                    if(sum != this.tab3DataList.field_3){
        ...
        getPercent(field1,field2){
            this.tab3DataList[field2] = (Math.round((this.tab3DataList[field1]/this.tab3DataList.field_3) * 100*100)/100).toFixed(2)+'%';
        },
        // 获取当前时间
        getNowTime: function () {
              let dateTime
      ...
      getTab3CurrentStep(people){
        axios({
            ...
            res=>{
                ...
                if(this.tab3DataList.field_12_4_1 != null && this.tab3DataList.field_12_4_1 != ""){

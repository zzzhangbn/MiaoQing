    ...
    <div class="demo-image__placeholder">
        ...
        <div id="containner_div" style="width: 100%;height: 70%;">
            <table style="width: 100%;border: 1px solid lightgray;text-align: center;line-height: 40px;" border="1" cellspacing="0">
                <tr >
                    <td colspan="60" style="background-color: #6E8B3D;color: #FFFFFF;">2021年度监测县(市、区)水稻苗情评价动态列表(早稻-直播)</td>
                </tr>
...
<script>
    ...
    export default{
        ...
        methods:{
            ...
            //查询该用户下数据
            getUserAllData0304(people,column_id){
                axios({
            ...
            //将建档卡2-1中已知内容插入到表3-4中
            getMonitorCardContentInto0303(people){
                axios({
                    url:'/getMonitorCardContentInto0304',
                    method:'post',
                    params:{
                        people:people
                    }
            ...
            checkFirstFieldInput431(){
                ...
                if(this.tableFlag == '进程8（大田直播后86天）'){
        ...
        created(){
            ...
            this.getUserAllData0304(people,this.column_id);
        },
    }
</script>
    ...
    <div style="margin-left: 1%;">
                    ...
                    <el-form :inline="true"  label-width="180px">
                        <el-form-item label="使用时间" >
                            <el-date-picker
                                align="right"
                                type="date"
                                v-model="tab0605DataList[item.date]"
                                :picker-options="pickerOptions"
                                value-format=“yyyy-MM-dd”
                                :disabled="totalData.length-index-1 < tab0605CurrentStep "
                                placeholder="选择日期">
                            </el-date-picker>
                        </el-form-item>
                        <el-form-item label="化调剂名称" >
                            <el-autocomplete
                                ...
                                v-model="tab0605DataList[item.name]"
                                :disabled="totalData.length-index-1 < tab0605CurrentStep "
                                placeholder="请输入内容"
                            ></el-autocomplete>
                        </el-form-item>
                        <el-form-item label="亩用量/kg" >
                            <el-input
                                ...
                                v-model="tab0605DataList[item.quantity]"
                                :disabled="totalData.length-index-1 < tab0605CurrentStep ">
                            </el-input>
                        </el-form-item>
                        <el-form-item label="使用方法" >
                            <el-autocomplete
                                ...
                                v-model="tab0605DataList[item.way]"
                                :disabled="totalData.length-index-1 < tab0605CurrentStep "
                                placeholder="请输入内容"
                            ></el-autocomplete>
                        </el-form-item>
                        <el-form-item label="生育进程" >
                            <el-autocomplete
                                ...
                                v-model="tab0605DataList[item.process]"
                                :disabled="totalData.length-index-1 < tab0605CurrentStep "
                                placeholder="请输入内容"
                            ></el-autocomplete>
                        </el-form-item>
        ...
        <div style="width: 100%;height: 100px;margin-top: 25px;">
            <div style="margin-top: 2.3%;float: right;margin-right: 10%;">
                <template v-if="currentStep >= tab0605CurrentStep && this.tab0605CurrentStep != 3">
        ...
        methods: {
            ...
            getFormList(e){
                this.$confirm("是否上报？").then(_=>{
                    ...
                    this.tab0605DataList.modification_time = date;
                    this.tab0605DataList.in_use = 1;

                    if (this.tab0605DataList.field_7_1 != null){
                        this.tab0605DataList.field_7_1 =this.tab0605DataList.field_7_1.toString().replace('“','').replace('”','');
                    }
                    if (this.tab0605DataList.field_8_1 != null){
                        this.tab0605DataList.field_8_1 =this.tab0605DataList.field_8_1.toString().replace('“','').replace('”','');
                    }
                    if (this.tab0605DataList.field_9_1 != null){
                        this.tab0605DataList.field_9_1 =this.tab0605DataList.field_9_1.toString().replace('“','').replace('”','');
                    }

                    var list = this.tab0605DataList;
                    var str = '';
            ...
            saveInputData(list){
                axios({
                    ...
                    this.gettab0605CurrentStep(this.people,this.point)
            ...
            gettab0605CurrentStep(people,point){
                axios({
                    url:'/getAllData0605',
                    method:'get',
                    params:{
                ...
                res=>{
					if(res.data.length > 0){
						this.tab0605DataList = [];
						this.totalData =[];
						this.tab0605DataList = res.data[0];
						               
						this.tab0605CurrentStep=0;
						for(var j = 0 ; j < 3 ; ++j){
						    var start = 7+j;
						    var str = "field_"+start+"_1";
						    var str1 = "field_"+start+"_2";
						    if(this.tab0605DataList[str] !=null && this.tab0605DataList[str] !=''){
						        this.tab0605CurrentStep += 1;
						        this.latestData = this.tab0605DataList[str];
						        var currenrData = {};
						...
						if(this.tab0605CurrentStep > this.currentStep){
						    this.currentStep = this.tab0605CurrentStep;
						}
						
						this.maxStep = this.currentStep;
						for(var i = 1 ; i <= this.tab0605CurrentStep ; ++i){
						    var item = ""+i+"";

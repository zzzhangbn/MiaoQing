      ...
      <template v-if="column_id != ''&& column_id != null">
        ...
        <div class ="table-s" id="containner_div" style="width: 100%;height: 70%;">
            ...
            <table  id="sum_tab"  style="width: 100%;overflow-x: auto;border: 1px solid lightgray;text-align: center;line-height: 40px;" border="1" cellspacing="0">
                <tr >
                    <td colspan="14">监测县(市、区)水稻单季稻苗情监测预测产表</td>
                </tr>
                <tr >
                    <td style="width: 5%;" >县（市、区）</td>
                    <td style="width: 5%;">地区类型</td>
                    <td style="width: 5%;">总面积（万亩）</td>
                    <td style="width: 10%;">7月31日前抽穗扬花的中稻</td>
                    <td style="width: 10%;">8月1-10日抽穗扬花的中稻</td>
                    <td style="width: 10%;">8月11-15日抽穗扬花的中稻</td>
                    <td style="width: 10%;">在8月16日-20日抽穗扬花的中稻</td>
                    <td style="width: 10%;">在8月21-31日抽穗扬花的中稻</td>
                    <td style="width: 10%;">在9月上旬抽穗扬花的中稻</td>
                </tr>
        ...
        <el-dialog :title="tableFlag" :visible.sync="detialDialogVisible" width="50%" :before-close="handleClose">
            <table style="width: 90%;border: 1px solid lightgray;line-height: 40px;" border="1" cellspacing="0">
                <template v-if="tableFlag == '7月31日前抽穗扬花的中稻'">
                ...
                <template v-if="tableFlag == '8月1-10日抽穗扬花的中稻'">
                    <tr style="text-align: center;font-size: 20px;line-height: 40px;color: gray;background-color: #DDDDDD;">
                        <td >面积（万亩）</td>
                        <td >亩有效穗（万）</td>
                        <td >每穗粒数（粒）</td>
                        ...
                        <td style="width: 15%">
                            <template v-if=" data.field_5_2!='' && data.field_5_3!='' && data.field_5_4!='' && data.field_5_5!=''
                             && data.field_5_2!=null && data.field_5_3!=null && data.field_5_4!=null && data.field_5_5!=null">
                                <span class="span">{{Number(data.field_5_2) * Number(data.field_5_3) * Number(data.field_5_4) * Number(data.field_5_5) * 0.0001}}</span>
                            </template>
                            <template v-if=" data.field_5_2=='' || data.field_5_3=='' || data.field_5_4=='' || data.field_5_5==''
                             || data.field_5_2==null || data.field_5_3==null || data.field_5_4==null || data.field_5_5==null">
                                <span style="text-align: center;display:block;">暂无</span>
                ...
                <template v-if="tableFlag == '8月11-15日抽穗扬花的中稻'">
                    <tr style="text-align: center;font-size: 20px;line-height: 40px;color: gray;background-color: #DDDDDD;">
                        <td >面积（万亩）</td>
                        <td >亩有效穗（万）</td>
                        <td >每穗粒数（粒）</td>
                ...
                <template v-if="tableFlag == '在8月16日-20日抽穗扬花的中稻'">
                    <tr style="text-align: center;font-size: 20px;line-height: 40px;color: gray;background-color: #DDDDDD;">
                        <td >面积（万亩）</td>
                        <td >亩有效穗（万）</td>
                        <td >每穗粒数（粒）</td>
                ...
                <template v-if="tableFlag == '在8月21-31日抽穗扬花的中稻'">
                    <tr style="text-align: center;font-size: 20px;line-height: 40px;color: gray;background-color: #DDDDDD;">
                        <td >面积（万亩）</td>
                        <td >亩有效穗（万）</td>
                        <td >每穗粒数（粒）</td>
                        ...
                        <td style="width: 15%">
                            <template v-if=" data.field_8_2!='' && data.field_8_3!='' && data.field_8_4!='' && data.field_8_5!=''
                             && data.field_8_2!=null && data.field_8_3!=null && data.field_8_4!=null && data.field_8_5!=null">
                                <span class="span">{{Number(data.field_8_2) * Number(data.field_8_3) * Number(data.field_8_4) * Number(data.field_8_5) * 0.0001}}</span>
                            </template>
                            <template v-if=" data.field_8_2=='' || data.field_8_3=='' || data.field_8_4=='' || data.field_8_5==''
                             || data.field_8_2==null || data.field_8_3==null || data.field_8_4==null || data.field_8_5==null">
                                <span style="text-align: center;display:block;">暂无</span>
                ...
                <template v-if="tableFlag == '在9月上旬抽穗扬花的中稻'">
                    <tr style="text-align: center;font-size: 20px;line-height: 40px;color: gray;background-color: #DDDDDD;">
                        <td >面积（万亩）</td>
                        <td >亩有效穗（万）</td>
                        <td >每穗粒数（粒）</td>
                        ...
                        <td style="width: 15%">
                            <template v-if=" data.field_9_2!='' && data.field_9_3!='' && data.field_9_4!='' && data.field_9_5!=''
                             && data.field_9_2!=null && data.field_9_3!=null && data.field_9_4!=null && data.field_9_5!=null">
                                <span class="span">{{Number(data.field_9_2) * Number(data.field_9_3) * Number(data.field_9_4) * Number(data.field_9_5) * 0.0001}}</span>
                            </template>
                            <template v-if=" data.field_9_2=='' || data.field_9_3=='' || data.field_9_4=='' || data.field_9_5==''
                             || data.field_9_2==null || data.field_9_3==null || data.field_9_4==null || data.field_9_5==null">
                                <span style="text-align: center;display:block;">暂无</span>

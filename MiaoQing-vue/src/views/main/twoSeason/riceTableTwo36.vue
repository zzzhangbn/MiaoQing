<template>
    <div class="totalRange">
      <!-- <el-tabs v-model="activeName"> -->
        <!-- <el-tab-pane label="直播稻进程1-2" name="1"> -->
            ...
            <div class="tableStyle">
              ...
              <el-table :data="tableData.slice((currentPage-1)*pagesize,currentPage*pagesize)" border :header-cell-style="headerStyle" :row-class-name="tableRowClassName" :row-style="{height: '30px'}" :cell-style="{padding:'0',fontSize:'4px'}" row-key="id" stripe>
                <!-- <el-table-column :label="tableLabel" align="center"> -->
                  ...
                  <el-table-column align="center" prop="field_3"  label="稻作类型" fixed/>
                  <el-table-column align="center" prop="field_4"  label="全县总面积（万亩）" />
                  <el-table-column align="center" label="进程1（大田直播后20天）">
                    <el-table-column align="center" prop="field_5_1"  label="日期" :formatter="dateFormat"/>
                  ...
                  <el-table-column align="center" label="进程2（大田直播后28天）">
                    <el-table-column align="center" prop="field_6_1"  label="日期" :formatter="dateFormat"/>
                    <el-table-column align="center" label="一类苗（万亩）">
                  ...
                  <el-table-column align="center" label="进程3（直播后35天）">
                    <el-table-column align="center" prop="field_7_1"  label="日期" :formatter="dateFormat"/>
                    <el-table-column align="center" label="一类苗（万亩）">
                  ...
                  <el-table-column align="center" label="进程4（大田直播后42天）">
                    <el-table-column align="center" prop="field_8_1"  label="日期" :formatter="dateFormat"/>
                    <el-table-column align="center" label="一类苗（万亩）">
                  ...
                  <el-table-column align="center" label="进程5（大田直播后49天）">
                    <el-table-column align="center" prop="field_9_1"  label="日期" :formatter="dateFormat"/>
                    <el-table-column align="center" label="一类苗（万亩）">
                  ...
                  <el-table-column align="center" label="进程6（大田直播后56天）">
                    <el-table-column align="center" prop="field_10_1"  label="日期" :formatter="dateFormat"/>
                    <el-table-column align="center" label="一类苗（万亩）">
                  ...
                  <el-table-column align="center" label="进程8（大田直播后76天）">
                    <el-table-column align="center" prop="field_11_1"  label="日期" :formatter="dateFormat"/>
                    <el-table-column align="center" label="一类苗（万亩）">
                  ...
                  <el-table-column align="center" label="进程9（大田直播后86天）">
                    <el-table-column align="center" prop="field_12_1"  label="日期" :formatter="dateFormat"/>
                    <el-table-column align="center" label="一类苗（万亩）">
...
export default {
  ...
  data() {
    return {       
      ...
      tableData: [],
      //表名
      tableLabel:'监测县(市、区)水稻苗情评价动态列表（晚稻）-（直播）',
      tableName:'crop_01_02_table_03_06',
      //分页
      pagesize:15,  //每页的数据条数
      ...
      axios({
        ...
        option = {
            ...
            xAxis: [
                {
                    type: 'category',
                    data: ['进程1','进程2','进程3','进程4','进程5','进程6','进程7','进程8','进程9']
                }
            ],
            yAxis: [
                {

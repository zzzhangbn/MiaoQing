    ...
    <div class="demo-image__placeholder">
        ...
        <div class ="table-s" id="containner_div" style="width: 100%;height: 70%;">
            ...
            <table  id="sum_tab"  style="width: 100%;overflow-x: auto;border: 1px solid lightgray;text-align: center;line-height: 40px;" border="1" cellspacing="0">
                <tr >
                    <td colspan="14">2021年度监测县(市、区)水稻双季稻收获进度调查（晚稻）</td>
                </tr>
                <tr >
                    <td style="width: 10%;" >县（市、区）</td>
                    <td style="width: 10%;">地区类型</td>
                    <td style="width: 10%;">总面积（万亩）</td>
                    <td style="width: 10%;">收获进度1（11月5日）</td>
                    <td style="width: 10%;">收获进度2（11月15日）</td>
                    <td style="width: 10%;">收获进度3（11月25日）</td>
                    <td style="width: 10%;">收获进度4（11月30）</td>
                    <td style="width: 10%;">晚稻实测产</td>
                </tr>
        ...
        <el-dialog :title="tableFlag" :visible.sync="detialDialogVisible" width="50%" :before-close="handleClose">
            <table style="width: 90%;border: 1px solid lightgray;line-height: 40px;" border="1" cellspacing="0">
                <template v-if="tableFlag == '收获进度1（11月5日）'">
                    ...
                    <tr>
                        ...
                        <td style="width: 25%;">
                            <template v-if="data[fieldRowIndex].field_4_2_1!=null && data[fieldRowIndex].field_4_2_1!=''">
                                <span class="span">{{Number((data[fieldRowIndex].field_4_2_1/data[fieldRowIndex].field_3)*100).toFixed(2)}}%</span>
                            </template>
                            <template v-if="data[fieldRowIndex].field_4_2_1==null || data[fieldRowIndex].field_4_2_1==''">
                ...
                <template v-if="tableFlag == '收获进度2（11月15日）'">
                    <tr style="text-align: center;font-size: 20px;line-height: 40px;color: gray;background-color: #DDDDDD;">
                        <td >日期</td>
                        <td colspan="2">收获面积（万亩）</td>
                    </tr>
                    <tr>
                        ...
                        <td style="width: 25%;">
                            <template v-if="data[fieldRowIndex].field_5_2_1!=null && data[fieldRowIndex].field_5_2_1!=''">
                                <span class="span">{{Number((data[fieldRowIndex].field_5_2_1/data[fieldRowIndex].field_3)*100).toFixed(2)}}%</span>
                            </template>
                            <template v-if="data[fieldRowIndex].field_5_2_1==null || data[fieldRowIndex].field_5_2_1==''">
                                <span style="text-align: center;display:block;">暂无</span>
                            </template>
                ...
                <template v-if="tableFlag == '收获进度3（11月25日）'">
                    <tr style="text-align: center;font-size: 20px;line-height: 40px;color: gray;background-color: #DDDDDD;">
                        <td >日期</td>
                        <td colspan="2">收获面积（万亩）</td>
                    </tr>
                    <tr>
                        ...
                        <td style="width: 25%;">
                            <template v-if="data[fieldRowIndex].field_6_2_1!=null && data[fieldRowIndex].field_6_2_1!=''">
                                <span class="span">{{Number((data[fieldRowIndex].field_6_2_1/data[fieldRowIndex].field_3)*100).toFixed(2)}}%</span>
                            </template>
                            <template v-if="data[fieldRowIndex].field_6_2_1==null || data[fieldRowIndex].field_6_2_1==''">
                                <span style="text-align: center;display:block;">暂无</span>
                            </template>
                ...
                <template v-if="tableFlag == '收获进度4（11月30）'">
                    <tr style="text-align: center;font-size: 20px;line-height: 40px;color: gray;background-color: #DDDDDD;">
                        <td >日期</td>
                        <td colspan="2">收获面积（万亩）</td>
                    </tr>
                    <tr>
                        <td style="width: 50%;"><el-date-picker value-format=“yyyy-MM-dd” v-model="data[fieldRowIndex].field_7_1" type="date" placeholder="选择日期" style="width: 100%"></el-date-picker></td>
                        <td style="width: 25%;">
                            <input style="background-color: #fff;border-radius: 4px;border: 1px solid #dcdfe6;width: 100%;box-sizing: border-box;color: #606266;outline: 0;padding: 0 15px;font-size: inherit;height: 40px;line-height: 40px;" class="secondFieldDetail" v-model="data[fieldRowIndex].field_7_2_1" @blur.prevent="checkFirstFieldInput($event)" />
                        </td>
                        <td style="width: 25%;">
                            <template v-if="data[fieldRowIndex].field_7_2_1!=null && data[fieldRowIndex].field_7_2_1!=''">
                                <span class="span">{{Number((data[fieldRowIndex].field_7_2_1/data[fieldRowIndex].field_3)*100).toFixed(2)}}%</span>
                            </template>
                            <template v-if="data[fieldRowIndex].field_7_2_1==null || data[fieldRowIndex].field_7_2_1==''">
                                <span style="text-align: center;display:block;">暂无</span>
                            </template>
                    ...
                    <tr>
                        ...
                        <td style="width: 20%">
                            <template v-if=" data[fieldRowIndex].field_8_2!='' && data[fieldRowIndex].field_8_3!='' && data[fieldRowIndex].field_8_4!='' && data[fieldRowIndex].field_8_5!='' ">
                                <span class="span">{{Number(data[fieldRowIndex].field_8_2) * Number(data[fieldRowIndex].field_8_3) * Number(data[fieldRowIndex].field_8_4) * Number(data[fieldRowIndex].field_8_5) * 0.000001}}</span>
                            </template>
                            <template v-if=" data[fieldRowIndex].field_8_2=='' || data[fieldRowIndex].field_8_3=='' || data[fieldRowIndex].field_8_4=='' || data[fieldRowIndex].field_8_5=='' ">
                                <span style="text-align: center;display:block;">暂无</span>
                            </template>

              ...
              <el-table :data="tableData.slice((currentPage-1)*pagesize,currentPage*pagesize)" border :header-cell-style="headerStyle" :row-class-name="tableRowClassName" :row-style="{height: '30px'}" :cell-style="{padding:'0',fontSize:'4px'}" row-key="id" stripe>
                <!-- <el-table-column :label="tableLabel" align="center"> -->
                  ...
                  <el-table-column align="center" label="开始播种日期">
                      <el-table-column align="center" prop="field_5_1"  label="育秧" :formatter="dateFormat"/>
                      <el-table-column align="center" prop="field_5_2"  label="直播" :formatter="dateFormat"/>
                  </el-table-column>
...
export default {
  ...
  data() {
    return {          
      ...
      tableName:'crop_01_02_table_03_01',
      //分页
      pagesize:15,  //每页的数据条数

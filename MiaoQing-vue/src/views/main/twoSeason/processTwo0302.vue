<template>
    <div style="margin-left: 1%;">
        <div style="width: 98%;height: 50px;">
            <span style="font-size: 20px;color: rgb(0, 102, 102);margin-right: 48%;">年度监测县(市、区)水稻播栽进度调查表（晚稻）</span>
        </div>
                        ...
                        <el-form :inline="true"  label-width="180px">
                            <template v-if="tableList.length-index-1 == 0">
                                <el-form-item label="全县总面积(万亩)">
                                    ...
                                    :disabled="copyData.field_4 != null && copyData.field_4 !=''" style="width: 207px;" @blur="changeAllArea"></el-input>  
                                </el-form-item>
                                ...
                                <el-form-item label="秧田面积（万亩）">
                                    ...
                                    :disabled="copyData.field_6 != null && copyData.field_6 !=''"></el-input>
                                </el-form-item>
                                <el-form-item width="260" label="其中（秧田面积）集中育秧">
                                    ...
                                    @blur.prevent="checkFirstFieldInput($event,'field_7_1','field_7_2','1')"></el-input>
                                </el-form-item>
                                ...
                                <el-form-item label="其中（折合大田面积）集中育秧">
                                    ...
                                    @blur.prevent="checkFirstFieldInput($event,'field_9_1','field_9_2','0')"></el-input>
                                </el-form-item>
  ...
  export default{
    inject: ['reload'],
      ...
      return {
        ...
        maxStep:0,//最大进程数
        activeNames:[],
        tab1CurrentStep:0,//表1-  3-1当前进程,最大是3
        ...
        pickerOptions: {
          ...
          daoZuoTypeData:[],//稻作类型
        // 步骤标题
      stepTitle: ['进度准备','播栽期进度1（7月15日）', '播栽期进度2（7月25日）', '播栽期进度3（8月5日）'],
      };
    },
    methods: {
        //改变全县总面积

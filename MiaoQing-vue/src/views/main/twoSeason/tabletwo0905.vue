    ...
    <div class="demo-image__placeholder">
        ...
        <div class ="table-s" id="containner_div" style="width: 100%;height: 70%;">
            ...
            <table  id="sum_tab"  style="width: 100%;overflow-x: auto;border: 1px solid lightgray;text-align: center;line-height: 40px;" border="1" cellspacing="0">
                <tr style="background-color: #6E8B3D;color:white;">
                    <td colspan="14" style="background-color: #6E8B3D;color: #FFFFFF;">监测县(市、区)水稻高温热害表</td>
                </tr>
                <tr style="background-color: #CDBE70;color: green;">
                    ...
                    <td style="width: 7%;">高温热害</td>
                    <td style="width: 7%;">高温热害发生时间</td>
                    <td style="width: 7%;">全县种植面积（万亩）</td>
                    <td style="width: 7%;">热害总面积（万亩）</td>
                    <td style="width: 7%;">热害级别（万亩）</td>
                    <td style="width: 7%;">主要品种名称</td>
                ...
                <template v-for="(item,index) in data">
                    <tr>
                        ...
                        <td><el-input v-model="data[index].field_8" ></el-input></td>
                        <td>
                        ...
                        <td>
                            <template v-if="data[index].field_7!=null && data[index].field_8!=null">
                                <span class="span">{{Number((data[index].field_8/data[index].field_7)*100).toFixed(2)}}%</span>
                            </template>
                            <template v-if="data[index].field_7==null || data[index].field_8==null">
                                <span>暂无</span>
                            </template>
                        ...
                        <td>
                            <template v-if="data[index].field_12!=null && data[index].field_13!=null">
                                <span class="span">{{Number(((data[index].field_12*0.3+data[index].field_13*0.8)*100)/data[index].field_7).toFixed(2)}}%</span>
                            </template>
                            <template v-if="data[index].field_12==null || data[index].field_13==null">
                                <span>暂无</span>
                            </template>
        ...
        <el-dialog :title="tableFlag" :visible.sync="detialDialogVisible" width="50%" :before-close="handleClose">
            <table style="width: 90%;border: 1px solid lightgray;line-height: 40px;" border="1" cellspacing="0">
                <template v-if="tableFlag == '热害级别（万亩）'">
                    <tr style="background-color: #CDBE70;color: green;">
                        <td style="width: 10%">1级</td>
                        <td style="width: 10%">2级</td>
                        <td style="width: 10%">3级</td>
                        <td style="width: 10%">4级</td>
                        <td style="width: 10%">5级</td>
                    </tr>
                    <tr>

                ...
                <template v-for="(item,index) in data">
                    ...
                    <tr>
                        ...
                        || data[index].field_9_4_2 == null || data[index].field_9_4_1 == ''">
                            <td style="color: red;">进程6（移栽后42天）<i class='el-icon-caret-top' @click="foldOrNot($event,'进程6')"></i></td>
                        </template>
                        <template v-if="data[index].field_9_1 != null && data[index].field_9_1 != '' && data[index].field_9_2_1 != '' && data[index].field_9_2_1 != null && data[index].field_9_2_2 != null && data[index].field_9_2_2 != ''
                        && data[index].field_9_3_1 != null && data[index].field_9_3_1 != '' && data[index].field_9_3_2 != '' && data[index].field_9_3_2 != null && data[index].field_9_4_1 != null && data[index].field_9_4_1 != ''
                        && data[index].field_9_4_2 != null && data[index].field_9_4_1 != ''">
                            <td style="color: green;">进程6（移栽后42天）<i class='el-icon-caret-top' @click="foldOrNot($event,'进程6')"></i></td>
                        </template>
                        ...
                        || data[index].field_10_4_2 == null || data[index].field_10_4_1 == ''">
                            <td style="color: red;">进程7（移栽后52天）<i class='el-icon-caret-top' @click="foldOrNot($event,'进程7')"></i></td>
                        </template>
                        <template v-if="data[index].field_10_1 != null && data[index].field_10_1 != '' && data[index].field_10_2_1 != '' && data[index].field_10_2_1 != null && data[index].field_10_2_2 != null && data[index].field_10_2_2 != ''
                        && data[index].field_10_3_1 != null && data[index].field_10_3_1 != '' && data[index].field_10_3_2 != '' && data[index].field_10_3_2 != null && data[index].field_10_4_1 != null && data[index].field_10_4_1 != ''
                        && data[index].field_10_4_2 != null && data[index].field_10_4_1 != ''">
                            <td style="color: green;">进程7（移栽后52天）<i class='el-icon-caret-top' @click="foldOrNot($event,'进程7')"></i></td>
                        </template>
                    ...
                    <template v-if="fold1 == true||fold2 == true||fold3 == true||fold4 == true||fold5 == true||fold6 == true||fold7 == true||fold8 == true">
...
<script>
    ...
    export default{
        ...
        methods:{
            ...
            saveInputData(list){
              axios({
                url:'/getSituationInputDataTable0302',
                method:'post',
                params:{
                  data:list
                }
            ...
            getMonitorCardContentInto0302(people){
                axios({
                    url:'/getMonitorCardContentInto0302',
                    method:'post',
                    params:{
                        people:people
                    }

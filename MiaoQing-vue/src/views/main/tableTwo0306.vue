    ...
    <div class="demo-image__placeholder">
        ...
        <div id="containner_div" style="width: 100%;height: 70%;">
            <table style="width: 100%;border: 1px solid lightgray;text-align: center;line-height: 40px;" border="1" cellspacing="0">
                <tr >
                    <td colspan="60" style="background-color: #6E8B3D;color: #FFFFFF;">2021年度监测县(市、区)水稻苗情评价动态列表(晚稻-直播)</td>
                </tr>
            ...
            <el-dialog :title="tableFlag" :visible.sync="detialDialogVisible" width="90%">
                <table style="width: 100%;border: 1px solid lightgray;text-align: center;line-height: 40px;" border="1" cellspacing="0">
                    ...
                    <template v-if="tableFlag == '进程1（大田直播后20天）'">
                        <tr> 
                            <td>
                                <el-date-picker
                    ...
                    <template v-if="tableFlag == '进程2（大田直播后28天）'">
                        <tr> 
                            <td>
                                <el-date-picker
                    ...
                    <template v-if="tableFlag == '进程3（大田直播后35天）'">
                        <tr> 
                            <td>
                                <el-date-picker
                    ...
                    <template v-if="tableFlag == '进程4（大田直播后42天）'">
                        <tr> 
                            <td>
                                <el-date-picker
                    ...
                    <template v-if="tableFlag == '进程5（大田直播后49天）'">
                        <tr> 
                            <td>
                                <el-date-picker
                    ...
                    <template v-if="tableFlag == '进程6（大田直播后56天）'">
                        <tr> 
                            <td>
                                <el-date-picker
                    ...
                    <template v-if="tableFlag == '进程7（大田直播后66天）'">
                        <tr> 
                            <td>
                                <el-date-picker
                    ...
                    <template v-if="tableFlag == '进程8（大田直播后76天）'">
                        <tr> 
                            <td>
                                <el-date-picker
                            ...
                            <td>
                                <el-input v-model="data[fieldRowIndex].field_12_2_1"  @blur.prevent="checkFirstFieldInput421($event)"></el-input>
                            </td>
                            <td>
                                <el-input disabled v-model="data[fieldRowIndex].field_12_2_2" ></el-input>
                            </td>
                            <td>
                                <el-input v-model="data[fieldRowIndex].field_12_3_1" @blur.prevent="checkFirstFieldInput431($event)"></el-input>
                            </td>
                            <td>
                                <el-input disabled v-model="data[fieldRowIndex].field_12_3_2"></el-input>
                            </td>
                            <td>
                                <el-input v-model="data[fieldRowIndex].field_12_4_1" @blur.prevent="checkFirstFieldInput441($event)"></el-input>
                            </td>
                            <td>
                                <el-input disabled v-model="data[fieldRowIndex].field_12_4_2"></el-input>
                            </td>
                        </tr>
                    </template>
                    <template v-if="tableFlag == '进程9（大田直播后86天）'">
                        <tr> 
                            <td>
                                <el-date-picker
                            ...
                            <td>
                                <el-input v-model="data[fieldRowIndex].field_13_2_1"  @blur.prevent="checkFirstFieldInput421($event)"></el-input>
                            </td>
                            <td>
                                <el-input disabled v-model="data[fieldRowIndex].field_13_2_2" ></el-input>
                            </td>
                            <td>
                                <el-input v-model="data[fieldRowIndex].field_13_3_1" @blur.prevent="checkFirstFieldInput431($event)"></el-input>
                            </td>
                            <td>
                                <el-input disabled v-model="data[fieldRowIndex].field_13_3_2"></el-input>
                            </td>
                            <td>
                                <el-input v-model="data[fieldRowIndex].field_13_4_1" @blur.prevent="checkFirstFieldInput441($event)"></el-input>
                            </td>
                            <td>
                                <el-input disabled v-model="data[fieldRowIndex].field_13_4_2"></el-input>
                            </td>
                        </tr>
                    </template>
                </table>
...
<script>
    ...
    export default{
        ...
        methods:{
            ...
            //查询该用户下数据
            getUserAllData0306(people,column_id){
                axios({
            ...
            //将建档卡2-1中已知内容插入到表3-6中
            getMonitorCardContentInto0303(people){
                axios({
                    url:'/getMonitorCardContentInto0306',
                    method:'post',
                    params:{
                        people:people
                    }
            ...
            checkFirstFieldInput421(e){
                //console.log(e);
                if(this.tableFlag == '进程1（大田直播后20天）'){
                ...
                if(this.tableFlag == '进程2（大田直播后28天）'){
                ...
                if(this.tableFlag == '进程3（大田直播后35天）'){
                ...
                if(this.tableFlag == '进程4（大田直播后42天）'){
                ...
                if(this.tableFlag == '进程5（大田直播后49天）'){
                ...
                if(this.tableFlag == '进程6（大田直播后56天）'){
                ...
                if(this.tableFlag == '进程7（大田直播后66天）'){
                ...
                if(this.tableFlag == '进程8（大田直播后76天）'){
                    this.data[this.fieldRowIndex].field_12_2_2 = (Math.round((this.data[this.fieldRowIndex].field_12_2_1 /this.data[this.fieldRowIndex].field_4) * 100*100)/100).toFixed(2) + '%';
                }
                if(this.tableFlag == '进程9（大田直播后86天）'){
                    this.data[this.fieldRowIndex].field_13_2_2 = (Math.round((this.data[this.fieldRowIndex].field_13_2_1 /this.data[this.fieldRowIndex].field_4) * 100*100)/100).toFixed(2) + '%';
                }
            },
            checkFirstFieldInput431(){
                ...
                if(this.tableFlag == '进程8（大田直播后76天）'){
                    this.data[this.fieldRowIndex].field_12_3_2 = (Math.round((this.data[this.fieldRowIndex].field_12_3_1 /this.data[this.fieldRowIndex].field_4) * 100*100)/100).toFixed(2) + '%';
                }
                if(this.tableFlag == '进程9（大田直播后86天）'){
                    this.data[this.fieldRowIndex].field_13_3_2 = (Math.round((this.data[this.fieldRowIndex].field_13_3_1 /this.data[this.fieldRowIndex].field_4) * 100*100)/100).toFixed(2) + '%';
                }
            },
            checkFirstFieldInput441(){
                ...
                if(this.tableFlag == '进程8（大田直播后76天）'){
                    this.data[this.fieldRowIndex].field_12_4_2 = (Math.round((this.data[this.fieldRowIndex].field_12_4_1 /this.data[this.fieldRowIndex].field_4) * 100*100)/100).toFixed(2) + '%';
                }
                if(this.tableFlag == '进程9（大田直播后86天）'){
                    this.data[this.fieldRowIndex].field_13_4_2 = (Math.round((this.data[this.fieldRowIndex].field_13_4_1 /this.data[this.fieldRowIndex].field_4) * 100*100)/100).toFixed(2) + '%';
                }
            },
            close(){
                //console.log(this.data);
        ...
        created(){
            ...
            this.getUserAllData0306(people,this.column_id);
        },
    }
</script>
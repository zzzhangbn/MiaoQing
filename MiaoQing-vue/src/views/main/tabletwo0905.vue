<template>
    <div class="demo-image__placeholder">
        ...
        <el-table :data="data" :header-cell-style="headerStyle">
            ...
            <el-table-column align="center"  width="105%" label="地区类型" fixed>
            ...
            <el-table-column align="center"  width="105%" label="产量损失（%）">
                <template slot-scope="scope">
                    ...
                    <template v-if="data[fieldRowIndex=scope.$index].field_12==null || data[index=scope.$index].field_13==null">
                        <span class="span">暂无</span>
                    </template>
                </template>
            </el-table-column>
      ...
      this.$confirm("是否暂存？")
        .then((_) => {
          ...
          if (this.data[fieldRowIndex].field_6 != null) {
            this.data[fieldRowIndex].field_6 = this.data[fieldRowIndex].field_6
              .toString()
              .replace("“", "")
              .replace("”", "");
          }
    ...
    getFormList(fieldRowIndex) {
      this.$confirm("是否上报？")
        ...
        //   console.log(spans);
          ...
          console.log(this.data[fieldRowIndex]);

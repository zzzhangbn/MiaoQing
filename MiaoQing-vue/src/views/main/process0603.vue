    ...
    <div style="margin-left: 1%;">
                    ...
                    <el-form :inline="true"  label-width="180px">
                        <el-form-item label="病虫害种类" >
                            <el-autocomplete
                                    ...
                                    v-model="tab0603DataList[item.pest]"
                                    :disabled="totalData.length-index-1 < tab0603CurrentStep ">
                            </el-autocomplete>
                        </el-form-item>
                        <el-form-item label="使用时间" >
                            <el-date-picker
                                    v-model="tab0603DataList[item.date]"
                                    align="right"
                                    type="date"
                        ...
                        <el-form-item label="用药种类" >
                            <el-autocomplete
                                    ...
                                    v-model="tab0603DataList[item.drug]"
                                    :disabled="totalData.length-index-1 < tab0603CurrentStep">
                            </el-autocomplete>
                        </el-form-item>
                        <el-form-item label="用药量(ml/亩)" >
                            <el-input style="width: 220px;"
                                      ...
                                      v-model="tab0603DataList[item.quantity]"
                                      :disabled="totalData.length-index-1 < tab0603CurrentStep">
                            </el-input>
                        </el-form-item>
                        <el-form-item label="用药方法" >
                            <el-autocomplete
                                    ...
                                    v-model="tab0603DataList[item.way]"
                                    :disabled="totalData.length-index-1 < tab0603CurrentStep">
                            </el-autocomplete>
                        </el-form-item>
                        <el-form-item label="生育进程" >
                            <el-autocomplete
                                    ...
                                    v-model="tab0603DataList[item.process]"
                                    :disabled="totalData.length-index-1 < tab0603CurrentStep">
                            </el-autocomplete>
                        </el-form-item>
                    </el-form>
        ...
        <div style="width: 100%;height: 100px;margin-top: 25px;">
            <div style="margin-top: 2.3%;float: right;margin-right: 10%;">
                <template v-if="currentStep >= tab0603CurrentStep && this.tab0603CurrentStep != 5">
        ...
        methods: {
            ...
            getFormList(e){
                this.$confirm("是否上报？").then(_=>{
                    ...
                    this.tab0603DataList.modification_time = date;
                    this.tab0603DataList.in_use = 1;

                    if (this.tab0603DataList.field_7_2 != null){
                        this.tab0603DataList.field_7_2 =this.tab0603DataList.field_7_2.toString().replace('“','').replace('”','');
                    }
                    if (this.tab0603DataList.field_8_2 != null){
                        this.tab0603DataList.field_8_2 =this.tab0603DataList.field_8_2.toString().replace('“','').replace('”','');
                    }
                    if (this.tab0603DataList.field_9_2 != null){
                        this.tab0603DataList.field_9_2 =this.tab0603DataList.field_9_2.toString().replace('“','').replace('”','');
                    }
                    if (this.tab0603DataList.field_10_2 != null){
                        this.tab0603DataList.field_10_2 =this.tab0603DataList.field_10_2.toString().replace('“','').replace('”','');
                    }
                    if (this.tab0603DataList.field_11_2 != null){
                        this.tab0603DataList.field_11_2 =this.tab0603DataList.field_11_2.toString().replace('“','').replace('”','');
                    }

                    var list = this.tab0603DataList;
                    var str = '';
            ...
            saveInputData(list){
                axios({
                    ...
                    this.gettab0603CurrentStep(this.people,this.point)
            ...
            gettab0603CurrentStep(people,point){
                axios({
                    url:'/getAllData0603',
                    method:'get',
                    params:{
                ...
                res=>{
					if(res.data.length > 0){
						this.tab0603DataList = [];
						this.totalData =[];
						this.tab0603DataList = res.data[0];
						               
						this.tab0603CurrentStep=0;
						for(var j = 0 ; j < 5 ; ++j){
						    var start = 7+j;
						    var str = "field_"+start+"_1";
						    var str1 = "field_"+start+"_2";
						    if(this.tab0603DataList[str] !=null && this.tab0603DataList[str] !=''){
						        this.tab0603CurrentStep += 1;
						        this.latestData = this.tab0603DataList[str];
						        var currenrData = {};
						...
						if(this.tab0603CurrentStep > this.currentStep){
						    this.currentStep = this.tab0603CurrentStep;
						}
						this.maxStep = this.currentStep;
						for(var i = 1 ; i <= this.tab0603CurrentStep ; ++i){
						    var item = ""+i+"";

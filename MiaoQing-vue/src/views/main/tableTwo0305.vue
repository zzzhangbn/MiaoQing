    ...
    <div class="demo-image__placeholder">
        ...
        <div id="containner_div" style="width: 100%;height: 70%;">
            <table style="width: 100%;border: 1px solid lightgray;text-align: center;line-height: 40px;" border="1" cellspacing="0">
                <tr >
                    <td colspan="59" style="background-color: #6E8B3D;color: #FFFFFF;">2021年度监测县(市、区)水稻苗情评价动态列表（晚稻-移栽）</td>
                </tr>
                ...
                <template v-for="(item,index) in data">
                    <tr>
                        ...
                        <td>
                            <el-input @blur.prevent="checkFirstFieldInput($event)" v-model="data[index].field_3"></el-input>
                        </td>
                        <td>
                ...
                <table style="width: 100%;border: 1px solid lightgray;text-align: center;line-height: 40px;" border="1" cellspacing="0">
                    ...
                    <template v-if="tableFlag == '进程1（移栽后7天）'">
                        <tr> 
                            <td>
                                <el-date-picker
                                    v-model="data[fieldRowIndex].field_4_1"
                                    type="date"
                                    placeholder="选择日期">
                                    </el-date-picker>
                            </td>
                            <td>
                                <el-input v-model="data[fieldRowIndex].field_4_2_1"  @blur.prevent="checkFirstFieldInput421($event)"></el-input>
                            </td>
                            <td>
                                <el-input disabled v-model="data[fieldRowIndex].field_4_2_2" ></el-input>
                            </td>
                            <td>
                                <el-input v-model="data[fieldRowIndex].field_4_3_1" @blur.prevent="checkFirstFieldInput431($event)"></el-input>
                            </td>
                            <td>
                                <el-input disabled v-model="data[fieldRowIndex].field_4_3_2"></el-input>
                            </td>
                            <td>
                                <el-input v-model="data[fieldRowIndex].field_4_4_1" @blur.prevent="checkFirstFieldInput441($event)"></el-input>
                            </td>
                            <td>
                                <el-input disabled v-model="data[fieldRowIndex].field_4_4_2"></el-input>
                            </td>
                        </tr>
                    </template>
...
<script>
    ...
    export default{
        ...
        methods:{
            ...
            //查询该用户下数据
            getUserAllData0305(people,column_id){
                axios({
            ...
            checkFirstFieldInput421(e){
                ...
                if(this.tableFlag == '进程1（移栽后7天）'){
                    this.data[this.fieldRowIndex].field_4_2_2 = (Math.round((this.data[this.fieldRowIndex].field_4_2_1 /this.data[this.fieldRowIndex].field_3) * 100*100)/100).toFixed(2) + '%';
                }
                
                if(this.tableFlag == '进程2（移栽后12天）'){
                    this.data[this.fieldRowIndex].field_5_2_2 = (Math.round((this.data[this.fieldRowIndex].field_5_2_1 /this.data[this.fieldRowIndex].field_3) * 100*100)/100).toFixed(2) + '%';
                }
                if(this.tableFlag == '进程3（移栽后17天）'){
                    this.data[this.fieldRowIndex].field_6_2_2 = (Math.round((this.data[this.fieldRowIndex].field_6_2_1 /this.data[this.fieldRowIndex].field_3) * 100*100)/100).toFixed(2) + '%';
                }
                if(this.tableFlag == '进程4（移栽后22天）'){
                    this.data[this.fieldRowIndex].field_7_2_2 = (Math.round((this.data[this.fieldRowIndex].field_7_2_1 /this.data[this.fieldRowIndex].field_3) * 100*100)/100).toFixed(2) + '%';
                }
                if(this.tableFlag == '进程5（移栽后27天）'){
                    this.data[this.fieldRowIndex].field_8_2_2 = (Math.round((this.data[this.fieldRowIndex].field_8_2_1 /this.data[this.fieldRowIndex].field_3) * 100*100)/100).toFixed(2) + '%';
                }
                if(this.tableFlag == '进程6（移栽后32天）'){
                    this.data[this.fieldRowIndex].field_9_2_2 = (Math.round((this.data[this.fieldRowIndex].field_9_2_1 /this.data[this.fieldRowIndex].field_3) * 100*100)/100).toFixed(2) + '%';
                }
                if(this.tableFlag == '进程7（移栽后42天）'){
                    this.data[this.fieldRowIndex].field_10_2_2 = (Math.round((this.data[this.fieldRowIndex].field_10_2_1 /this.data[this.fieldRowIndex].field_3) * 100*100)/100).toFixed(2) + '%';
                }
              
            },
            checkFirstFieldInput431(){
                if(this.tableFlag == '进程1（移栽后7天）'){
                    this.data[this.fieldRowIndex].field_4_3_2 = (Math.round((this.data[this.fieldRowIndex].field_4_3_1 /this.data[this.fieldRowIndex].field_3) * 100*100)/100).toFixed(2) + '%';
                }
                
                if(this.tableFlag == '进程2（移栽后12天）'){
                    this.data[this.fieldRowIndex].field_5_3_2 = (Math.round((this.data[this.fieldRowIndex].field_5_3_1 /this.data[this.fieldRowIndex].field_3) * 100*100)/100).toFixed(2) + '%';
                }
                if(this.tableFlag == '进程3（移栽后17天）'){
                    this.data[this.fieldRowIndex].field_6_3_2 = (Math.round((this.data[this.fieldRowIndex].field_6_3_1 /this.data[this.fieldRowIndex].field_3) * 100*100)/100).toFixed(2) + '%';
                }
                if(this.tableFlag == '进程4（移栽后22天）'){
                    this.data[this.fieldRowIndex].field_7_3_2 = (Math.round((this.data[this.fieldRowIndex].field_7_3_1 /this.data[this.fieldRowIndex].field_3) * 100*100)/100).toFixed(2) + '%';
                }
                if(this.tableFlag == '进程5（移栽后27天）'){
                    this.data[this.fieldRowIndex].field_8_3_2 = (Math.round((this.data[this.fieldRowIndex].field_8_3_1 /this.data[this.fieldRowIndex].field_3) * 100*100)/100).toFixed(2) + '%';
                }
                if(this.tableFlag == '进程6（移栽后32天）'){
                    this.data[this.fieldRowIndex].field_9_3_2 = (Math.round((this.data[this.fieldRowIndex].field_9_3_1 /this.data[this.fieldRowIndex].field_3) * 100*100)/100).toFixed(2) + '%';
                }
                if(this.tableFlag == '进程7（移栽后42天）'){
                    this.data[this.fieldRowIndex].field_10_3_2 = (Math.round((this.data[this.fieldRowIndex].field_10_3_1 /this.data[this.fieldRowIndex].field_3) * 100*100)/100).toFixed(2) + '%';
                }
               
            },
            checkFirstFieldInput441(){
                if(this.tableFlag == '进程1（移栽后7天）'){
                    this.data[this.fieldRowIndex].field_4_4_2 = (Math.round((this.data[this.fieldRowIndex].field_4_4_1 /this.data[this.fieldRowIndex].field_3) * 100*100)/100).toFixed(2) + '%';
                }
                
                if(this.tableFlag == '进程2（移栽后12天）'){
                    this.data[this.fieldRowIndex].field_5_4_2 = (Math.round((this.data[this.fieldRowIndex].field_5_4_1 /this.data[this.fieldRowIndex].field_3) * 100*100)/100).toFixed(2) + '%';
                }
                if(this.tableFlag == '进程3（移栽后17天）'){
                    this.data[this.fieldRowIndex].field_6_4_2 = (Math.round((this.data[this.fieldRowIndex].field_6_4_1 /this.data[this.fieldRowIndex].field_3) * 100*100)/100).toFixed(2) + '%';
                }
                if(this.tableFlag == '进程4（移栽后22天）'){
                    this.data[this.fieldRowIndex].field_7_4_2 = (Math.round((this.data[this.fieldRowIndex].field_7_4_1 /this.data[this.fieldRowIndex].field_3) * 100*100)/100).toFixed(2) + '%';
                }
                if(this.tableFlag == '进程5（移栽后27天）'){
                    this.data[this.fieldRowIndex].field_8_4_2 = (Math.round((this.data[this.fieldRowIndex].field_8_4_1 /this.data[this.fieldRowIndex].field_3) * 100*100)/100).toFixed(2) + '%';
                }
                if(this.tableFlag == '进程6（移栽后32天）'){
                    this.data[this.fieldRowIndex].field_9_4_2 = (Math.round((this.data[this.fieldRowIndex].field_9_4_1 /this.data[this.fieldRowIndex].field_3) * 100*100)/100).toFixed(2) + '%';
                }
                if(this.tableFlag == '进程7（移栽后42天）'){
                    this.data[this.fieldRowIndex].field_10_4_2 = (Math.round((this.data[this.fieldRowIndex].field_10_4_1 /this.data[this.fieldRowIndex].field_3) * 100*100)/100).toFixed(2) + '%';
                }
        ...
        created(){
            ...
            this.getUserAllData0305(people,this.column_id);
        },
    }
</script>
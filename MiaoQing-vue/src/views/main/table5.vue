<template>
    <div class="demo-image__placeholder">
        ...
        <div id="containner_div" style="width: 100%;height: 70%;">
            <table style="width: 100%;border: 1px solid lightgray;text-align: center;line-height: 40px;" border="1" cellspacing="0">
                <tr>
                    <td colspan="16" style="background-color: #6E8B3D;color: #FFFFFF;">年度监测县(市、区)水稻播栽进度调查表</td>
                </tr>
                ...
                <tr>
                    ...
                    <td >
                        <template v-if="copyData[index].field_4_1 != null && copyData[index].field_4_1 != '' && column_id == ''">
                            <el-date-picker
                            v-model="data[index].field_4_1" readonly
                            type="date"
                            placeholder="选择日期"></el-date-picker>
                        </template>
                        <template v-else="copyData[index].field_4_1 == null || copyData[index].field_4_1 == '' || column_id != ''">
                            <el-date-picker
                            v-model="data[index].field_4_1"
                            type="date"
                            placeholder="选择日期"></el-date-picker>
                        </template>
                    </td>
                    <td >
                        <template v-if="copyData[index].field_4_2 != null && copyData[index].field_4_2 != '' && column_id == ''">
                            <el-date-picker
                            v-model="data[index].field_4_2" readonly
                            type="date"
                            placeholder="选择日期"></el-date-picker>
                        </template>
                        <template v-else="copyData[index].field_4_2 == null || copyData[index].field_4_2 == '' || column_id != ''">
                            <el-date-picker
                            v-model="data[index].field_4_2"
                            type="date"
                            placeholder="选择日期">
                        </el-date-picker>
                        </template>
                    ...
                    <td style="width:5%">
                        <el-input v-model="data[index].field_5" :disabled="copyData[index].field_5 !=='' && copyData[index].field_5 !== null && column_id == ''"></el-input>
                    </td>

                        <td style="width:5%">
                            <el-input v-model="data[index].field_6_1" @blur.prevent="getField62($event,index)" 
                            :disabled="copyData[index].field_6_1 !=='' && copyData[index].field_6_1 !== null && column_id == ''"></el-input>
                        </td>
                        <td style="width:6%">
                            <input style="background-color: #fff;border-radius: 4px;border: 1px solid #dcdfe6;box-sizing: border-box;
                            color: #606266;display: inline-block;font-size: inherit;height: 40px;line-height: 40px;width: 100%;" v-model="data[index].field_6_2" disabled ></input>
                        </td>
                    
                    
                        <td style="width:4%">
                            <el-input v-model="data[index].field_7_1" @blur.prevent="getField72($event)" 
                            :disabled="copyData[index].field_7_1 !=='' && copyData[index].field_7_1 !== null && column_id == ''"></el-input>
                        </td>
                        <td style="width:6%">
                            <input v-model="data[index].field_7_2" disabled style="background-color: #fff;border-radius: 4px;border: 1px solid #dcdfe6;box-sizing: border-box;
                            color: #606266;display: inline-block;font-size: inherit;height: 40px;line-height: 40px;width: 100%;" ></input>
                        </td>
                 
                    <td style="width:5%">
                        <el-input v-model="data[index].field_8_1" @blur.prevent="getField82($event,index)" 
                        :disabled="copyData[index].field_8_1 !=='' && copyData[index].field_8_1 !== null && column_id == ''"></el-input>
                    </td>
                    <td style="width:6%">
                        <input style="background-color: #fff;border-radius: 4px;border: 1px solid #dcdfe6;box-sizing: border-box;
                        color: #606266;display: inline-block;font-size: inherit;height: 40px;line-height: 40px;width: 100%;" v-model="data[index].field_8_2" disabled></input>
                    </td>
                </tr>
            </template>
            </table>
    <div style="width: 100%;height: 10px;"></div>
            <table style="width: 100%;border: 1px solid lightgray;text-align: center;line-height: 40px;" border="1" cellspacing="0">
                ...
                <template v-for="(item,index) in data">
                    <tr>
                        <template v-if="data[index].field_9_1 == null || data[index].field_9_1 == '' || data[index].field_9_2_1 == null || data[index].field_9_2_1 == '' || data[index].field_9_2_2 == null 
                        || data[index].field_9_2_2 == '' || data[index].field_9_3 == null || data[index].field_9_3 == '' || data[index].field_9_4 == null || data[index].field_9_4 == '' || data[index].field_9_5 == null
                        || data[index].field_9_5 == '' || data[index].field_9_6 == '' || data[index].field_9_6 == null">
                            <td style="color: red;">播栽期进度1（5月20日）
                        ...
                        || data[index].field_10_5 == '' || data[index].field_10_6 == '' || data[index].field_10_6 == null">
                            <td style="color: red;">播栽期进度2（5月30日）
                        ...
                        && data[index].field_10_2_2 != '' && data[index].field_10_3 != null && data[index].field_10_3 != '' && data[index].field_10_4 != null && data[index].field_10_4 != '' && data[index].field_10_5 != null
                        && data[index].field_10_5 != '' && data[index].field_10_6 != '' && data[index].field_10_6 != null">
                            <td style="color: green;">播栽期进度2（5月30日）
                                <i class='el-icon-caret-top' @click="foldOrNot($event,'播栽期进度2')"></i>
                            </td>
                        </template>
                        ...
                        || data[index].field_11_5 == '' || data[index].field_11_6 == '' || data[index].field_11_6 == null">
                            <td style="color:red">播栽期进度3（6月10日）
                        ...
                        && data[index].field_11_2_2 != '' && data[index].field_11_3 != null && data[index].field_11_3 != '' && data[index].field_11_4 != null && data[index].field_11_4 != '' && data[index].field_11_5 != null
                        && data[index].field_11_5 != '' && data[index].field_11_6 != '' && data[index].field_11_6 != null">
                            <td style="color: green;">播栽期进度3（6月10日）
                                <i class='el-icon-caret-top' @click="foldOrNot($event,'播栽期进度2')"></i>
                            </td>
                        </template>

                        <template v-if="data[index].field_12_1 == null || data[index].field_12_1 == '' || data[index].field_12_2 == null || data[index].field_12_2 == ''  
                        || data[index].field_12_3 == null || data[index].field_12_3 == '' || data[index].field_12_4 == null || data[index].field_12_4 == '' || data[index].field_12_5 == null
                        || data[index].field_12_5 == '' ">
                            <td style="color:red">播栽期进度4（6月20日）
                        ...
                        && data[index].field_12_3 != null && data[index].field_12_3 != '' && data[index].field_12_4 != null && data[index].field_12_4 != '' && data[index].field_12_5 != null
                        && data[index].field_12_5 != '' ">
                        <td style="color:green">播栽期进度4（6月20日）
                            <i class='el-icon-caret-top' @click="foldOrNot($event,'播栽期进度4')"></i>
                        </td>
                        </template>
                ...
                <template v-if="fold1 == true">
                    <tr>
                        ...
                        <td><el-input v-model="data[index].field_9_2_1"  @blur.prevent="getField922($event,index)" 
                            :disabled="copyData[index].field_9_2_1 !=='' && copyData[index].field_9_2_1 !== null && column_id == ''"></el-input></td>
                        <td><el-input v-model="data[index].field_9_2_2" disabled></el-input></td>
                        <td><el-input v-model="data[index].field_9_3" @blur.prevent="getSumArea('field_9_4','field_9_3',index)" 
                            :disabled="copyData[index].field_9_3 !=='' && copyData[index].field_9_3 !== null && column_id == ''"></el-input></td>
                        <td><el-input v-model="data[index].field_9_4" @blur.prevent="getSumArea('field_9_4','field_9_3',index)" 
                            :disabled="copyData[index].field_9_4 !=='' && copyData[index].field_9_4 !== null && column_id == ''"></el-input></td>
                        <td><el-input v-model="data[index].field_9_5" disabled></el-input></td>
                        <td><el-input v-model="data[index].field_9_6" disabled></el-input></td>
                    </tr>
                </template>
                ...
                <template v-if="fold2 == true">
                    <tr>
                        ...
                        <td><el-input v-model="data[index].field_10_2_1"  @blur.prevent="getField1022($event,index)" 
                        ...
                        <td><el-input v-model="data[index].field_10_3" @blur.prevent="getSumArea('field_10_4','field_10_3',index)" 
                            :disabled="copyData[index].field_10_3 !=='' && copyData[index].field_10_3 !== null && column_id == ''"></el-input></td>
                        <td><el-input v-model="data[index].field_10_4" @blur.prevent="getSumArea('field_10_4','field_10_3',index)" 
                ...
                <template v-if="fold3 == true">
                    <tr>
                        ...
                        <td><el-input v-model="data[index].field_11_2_1"  @blur.prevent="getField1122($event,index)" 
                ...
                <template v-if="fold4 == true">
                    <tr>
                        ...
                        <td><el-input v-model="data[index].field_12_2"  @blur.prevent="getSumArea('field_12_3','field_12_2',index)" 
                            :disabled="copyData[index].field_12_2 !=='' && copyData[index].field_12_2 !== null && column_id == ''"></el-input></td>
                        <td><el-input v-model="data[index].field_12_3"  @blur.prevent="getSumArea('field_12_3','field_12_2',index)" 
                            :disabled="copyData[index].field_12_3 !=='' && copyData[index].field_12_3 !== null && column_id == ''"></el-input></td>
                        <td><el-input v-model="data[index].field_12_4" disabled></el-input></td>
    ...
    export default{
        ...
        fixDataBackState(tableName,id){
            ...
            getSumArea(x1,x2,fieldRowIndex){
                ...
                if(x1 == 'field_9_4'){
                    this.data[fieldRowIndex].field_9_5 = Number(this.data[fieldRowIndex].field_9_4)+Number(this.data[fieldRowIndex].field_9_3);
                    this.data[fieldRowIndex].field_9_6 = (Math.round((this.data[fieldRowIndex].field_9_5/this.data[fieldRowIndex].field_3)* 100*100)/100).toFixed(2)+"%";
                ...
                if(x1 == 'field_10_4'){
                    ...
                    this.data[fieldRowIndex].field_10_6 = (Math.round((this.data[fieldRowIndex].field_10_5/this.data[fieldRowIndex].field_3)* 100*100)/100).toFixed(2)+"%";
                }
                if(x1 == 'field_11_4'){
                    this.data[fieldRowIndex].field_11_5 = Number(this.data[fieldRowIndex].field_11_4)+Number(this.data[fieldRowIndex].field_11_3);
                    this.data[fieldRowIndex].field_11_6 = (Math.round((this.data[fieldRowIndex].field_11_5/this.data[fieldRowIndex].field_3)* 100*100)/100).toFixed(2)+"%";
                }
                if(x1 == 'field_12_3'){
                    this.data[fieldRowIndex].field_12_4 = Number(this.data[fieldRowIndex].field_12_3)+Number(this.data[fieldRowIndex].field_12_2);
                    this.data[fieldRowIndex].field_12_5 = (Math.round((this.data[fieldRowIndex].field_12_4/this.data[fieldRowIndex].field_3)* 100*100)/100).toFixed(2)+"%";
                }
            ...
            getMonitorCardContentInto0301(people){
                axios({
                    url:'/getMonitorCardContentInto0301',
                    method:'post',
                    params:{
                        people:people
                    }
                    ...
                    return this.$message.error("获取表3-1内容失败！");
                });
            },
            //查询该用户下数据
            ...
            getField62(e,fieldRowIndex){
                ...
                if(!isNaN(strValue)){ 
                    ...
                    this.data[fieldRowIndex].field_6_2 = (Math.round((this.data[fieldRowIndex].field_6_1 /this.data[fieldRowIndex].field_5) * 100*100)/100).toFixed(2) + '%';
                }else{
                // e.target.parentNode.nextSibling.innerHTML = "X";
                    e.target.value = "";
                    alert("请输入数字！");
            ...
            getField72(e,fieldRowIndex){
                ...
                if(!isNaN(strValue)){ 
                    ...
                    this.data[fieldRowIndex].field_7_2 = (Math.round((this.data[fieldRowIndex].field_7_1 /this.data[fieldRowIndex].field_3) * 100*100)/100).toFixed(2) + '%';
                }else{
                // e.target.parentNode.nextSibling.innerHTML = "X";
                    e.target.value = "";
                    alert("请输入数字！");
            ...
            getField82(e,fieldRowIndex){
                ...
                if(!isNaN(strValue)){ 
                    ...
                    this.data[fieldRowIndex].field_8_2 = (Math.round((this.data[fieldRowIndex].field_8_1 /this.data[fieldRowIndex].field_3) * 100*100)/100).toFixed(2) + '%';
                }else{
                // e.target.parentNode.nextSibling.innerHTML = "X";
                    e.target.value = "";
                    alert("请输入数字！");
            ...
            getField922(e,fieldRowIndex){
                ...
                if(!isNaN(strValue)){ 
                    ...
                    this.data[fieldRowIndex].field_9_2_2 = (Math.round((this.data[fieldRowIndex].field_9_2_1 /this.data[fieldRowIndex].field_5) * 100*100)/100).toFixed(2) + '%';
                }else{
                // e.target.parentNode.nextSibling.innerHTML = "X";
                    e.target.value = "";
                    alert("请输入数字！");
            ...
            getField1022(e,fieldRowIndex){
                ...
                if(!isNaN(strValue)){ 
                    // this.data[this.fieldRowIndex].field_9_2_2 = Number((this.data[this.fieldRowIndex].field_9_2_1/this.data[this.fieldRowIndex].field_5).toFixed(4))*100+"%";
                    this.data[fieldRowIndex].field_10_2_2 = (Math.round((this.data[fieldRowIndex].field_10_2_1 /this.data[fieldRowIndex].field_5) * 100*100)/100).toFixed(2) + '%';
                }else{
                // e.target.parentNode.nextSibling.innerHTML = "X";
                    e.target.value = "";
                    alert("请输入数字！");
            ...
            getField1122(e,fieldRowIndex){
                ...
                if(!isNaN(strValue)){ 
                    // this.data[this.fieldRowIndex].field_9_2_2 = Number((this.data[this.fieldRowIndex].field_9_2_1/this.data[this.fieldRowIndex].field_5).toFixed(4))*100+"%";
                    this.data[fieldRowIndex].field_11_2_2 = (Math.round((this.data[fieldRowIndex].field_11_2_1 /this.data[fieldRowIndex].field_5) * 100*100)/100).toFixed(2) + '%';
                }else{
                // e.target.parentNode.nextSibling.innerHTML = "X";
                    e.target.value = "";
                    alert("请输入数字！");

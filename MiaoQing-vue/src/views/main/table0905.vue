<template>
    <div class="demo-image__placeholder">
        ...
        <el-table :data="data" :header-cell-style="headerStyle">
            ...
            <el-table-column align="center"  width="105%" label="高温热害">
                <el-input v-model="data[fieldRowIndex].field_5" ></el-input>
            </el-table-column>
            <el-table-column align="center"  width="105%" label="高温热害发生时间" >
                <el-date-picker
                    value-format=“yyyy-MM-dd”
                    v-model="data[fieldRowIndex].field_6"
                    type="date"
                    placeholder="选择日期" style="width: 100%">
                </el-date-picker>
            </el-table-column>
            <el-table-column align="center"  width="105%" label="全县种植面积（万亩）">
                <el-input v-model="data[fieldRowIndex].field_7" ></el-input>                    
            </el-table-column>
            <el-table-column align="center"  width="105%" label="热害总面积（万亩）" >
                <el-input v-model="data[fieldRowIndex].field_8" ></el-input>
            </el-table-column>
            <el-table-column align="center"  width="105%" label="热害级别（万亩）">
            ...
            <el-table-column align="center"  width="105%" label="主要品种名称">
                <el-input v-model="data[fieldRowIndex].field_10" ></el-input>
            </el-table-column>
            <el-table-column align="center"  width="105%" label="占比（%）">
                <template v-if="data[fieldRowIndex].field_7!=null && data[fieldRowIndex].field_8!=null">
                    <span class="span">{{Number((data[fieldRowIndex].field_8/data[fieldRowIndex].field_7)*100).toFixed(2)}}%</span>
                </template>
                <template v-if="data[fieldRowIndex].field_7==null || data[fieldRowIndex].field_8==null">
            ...
            <el-table-column align="center"  width="105%" label="其中：成灾面积（万亩）">
                <el-input v-model="data[fieldRowIndex].field_12" ></el-input>
            </el-table-column>
            <el-table-column align="center"  width="105%" label="其中：绝收面积（万亩）">
                <el-input v-model="data[fieldRowIndex].field_13" ></el-input>
            </el-table-column>
            <el-table-column align="center"  width="105%" label="产量损失（%）">
                <template v-if="data[fieldRowIndex].field_12!=null && data[fieldRowIndex].field_13!=null">
                    <span class="span">{{Number(((data[fieldRowIndex].field_12*0.3+data[fieldRowIndex].field_13*0.8)*100)/data[fieldRowIndex].field_7).toFixed(2)}}%</span>
                </template>
                <template v-if="data[fieldRowIndex].field_12==null || data[index].field_13==null">
                    <span class="span">暂无</span>
                </template>
            </el-table-column>
...
<script>
    ...
    ,
        methods:{
            //初始化数据
            initData() {
                this.tableLabel= "监测县(市、区)水稻高温热害表";
                //this.getHeaderList();
                //this.getTableData();
            },
            //获取表数据
            ...
            getFormList(flag){
                ...
                console.log(spans)
                if(spans[0].innerHTML != null && spans[0].innerHTML != ''){
                    this.data[0].field_11 = spans[0].innerHTML;
                }
                if(spans[1].innerHTML != null && spans[1].innerHTML != ''){
                    this.data[0].field_14 = spans[1].innerHTML;
                }

                if (this.data[0].field_6 != null){
                    this.data[0].field_6 = this.data[0].field_6.toString().replace('“','').replace('”','');
                }

<template>
                        ...
                        <el-form :inline="true" ref="form" label-width="180px">
                            ...
                            <template v-if="currentStep > 0">
                                ...
                                <template v-if="currentStep == 4">
                                    <el-form-item label="已栽插面积（万亩）">
                                        <template v-if="currentStep < tab1CurrentStep">
                                            <el-input style="width: 207px;" v-model="tab1DataList[0][tab1_2]" @blur.prevent="getSumArea(tab1_2,tab1_3,tab1_4,tab1_5)" readonly></el-input>
                                        </template>
                                        <template v-else="currentStep >= tab1CurrentStep">
                                            <el-input style="width: 207px;" v-model="tab1DataList[0][tab1_2]" @blur.prevent="getSumArea(tab1_2,tab1_3,tab1_4,tab1_5)"></el-input>
                                        </template>
                                    </el-form-item>
                                    <el-form-item label="直播已播种面积（万亩）">
                                        <template v-if="currentStep < tab1CurrentStep">
                                            <el-input style="width: 207px;" v-model="tab1DataList[0][tab1_3]" @blur.prevent="getSumArea(tab1_2,tab1_3,tab1_4,tab1_5)" readonly></el-input>
                                        </template>
                                        <template v-else="currentStep >= tab1CurrentStep">
                                            <el-input style="width: 207px;" v-model="tab1DataList[0][tab1_3]" @blur.prevent="getSumArea(tab1_2,tab1_3,tab1_4,tab1_5)" ></el-input>
                                        </template>
                                    </el-form-item>
                                    <el-form-item label="移栽+直播">
                                        <el-input style="width: 207px;" v-model="tab1DataList[0][tab1_4]" readonly></el-input>
                                    </el-form-item>
                                    <el-form-item label="（移栽+直播）/总面积">
                                        <el-input style="width: 207px;" v-model="tab1DataList[0][tab1_5]" readonly></el-input>
                                    </el-form-item>
  ...
  export default{
      ...
      return {
        ...
        tab1_6:'',
        // 步骤标题
      stepTitle: ['进度准备','播载期进度1', '播载期进度2', '播载期进度3', '播载期进度4'],
        ...
        axios({
            ...
            res=>{
                ...
                if(this.tab1DataList.length > 0){
                    ...
                    //console.log(this.tab1CurrentStep+":3-1");

                    //判断进程准备的数据是否已经填报
                    if(this.tab1DataList[0].field_4.length == 0|| this.tab1DataList[0].field_5_1 != null || this.tab1DataList[0].field_5_1 != '' || this.tab1DataList[0].field_5_2.length == 0 || this.tab1DataList[0].field_8_1.length == 0||this.tab1DataList[0].field_6.length == 0){
                        //进程准备没填
                    ...
                    if(this.tab1CurrentStep < 4){
                        ...
                        if(this.tab1CurrentStep == 4){
                            var gap = 9 + this.tab1CurrentStep;//表3-1 的进程绑定 OK
                            this.tab1_1 = "field_"+gap+"_1";
                            this.tab1_2 = "field_"+gap+"_2";
                            this.tab1_3 = "field_"+gap+"_3";
                            this.tab1_4 = "field_"+gap+"_4";
                            this.tab1_5 = "field_"+gap+"_5";
                        }
